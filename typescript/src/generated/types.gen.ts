...
export type IntegrationsSyncableItem = {
     ...
     */
    syncable_type: 'compensations/compensation' | 'expenses/expense' | 'employee_updates/leave' | 'employee_updates/new_hire' | 'employee_updates/termination' | 'employee_updates/worked_time' | 'finance/vendor';
};
