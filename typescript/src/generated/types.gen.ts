...
export type IntegrationsSyncableItem = {
     ...
     */
    syncable_type: 'compensations/compensation' | 'expenses/expense' | 'employee_updates/leave' | 'employee_updates/new_hire' | 'employee_updates/worked_time' | 'finance/vendor';
};
...
export type PostApi20261001ResourcesIntegrationsSyncableSyncRunsBulkUpsertData = {
    body?: {
        ...
        items: Array<{
             ...
             */
            syncable_type: 'compensationscompensation' | 'expensesexpensable' | 'employeeupdatesleave' | 'employeeupdatesnewhire' | 'employeeupdatesworkedtime' | 'financecontact';
            /**
