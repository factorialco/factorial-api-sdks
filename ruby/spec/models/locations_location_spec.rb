...
# Unit tests for F::LocationsLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe F::LocationsLocation do
  # let(:instance) { F::LocationsLocation.new }

  describe 'test an instance of LocationsLocation' do
    it 'should create an instance of LocationsLocation' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(F::LocationsLocation)
    end
  end
