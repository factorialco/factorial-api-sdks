...
# Unit tests for F::Api::ProjectManagementExportableExpenseApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProjectManagementExportableExpenseApi' do
  before do
    # run before each test
    @api_instance = F::Api::ProjectManagementExportableExpenseApi.new
  end
  ...
  describe 'test an instance of ProjectManagementExportableExpenseApi' do
    it 'should create an instance of ProjectManagementExportableExpenseApi' do
      expect(@api_instance).to be_instance_of(F::Api::ProjectManagementExportableExpenseApi)
    end
  end
