...
module F::Api
  class AttendanceShiftsToggleClockPostRequest < ApiModelBase
    # Employee identifier
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `F::Api::AttendanceShiftsToggleClockPostRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `F::Api::AttendanceShiftsToggleClockPostRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'clock_time')
        self.clock_time = attributes[:'clock_time']
      else
        self.clock_time = nil
      end
    ...
    def list_invalid_properties
      ...
      if @clock_time.nil?
        invalid_properties.push('invalid value for "clock_time", clock_time cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @clock_time.nil?
    ...
    def hash
      [employee_id, clock_time, location_type, observations, time_settings_break_configuration_id, project_id].hash
    end
