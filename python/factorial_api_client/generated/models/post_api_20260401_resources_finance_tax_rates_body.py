...
T = TypeVar("T", bound="PostApi20260401ResourcesFinanceTaxRatesBody")


@_attrs_define
class PostApi20260401ResourcesFinanceTaxRatesBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_finance_tax_rates_body = cls(
        ...
        post_api_20260401_resources_finance_tax_rates_body.additional_properties = d
        return post_api_20260401_resources_finance_tax_rates_body
