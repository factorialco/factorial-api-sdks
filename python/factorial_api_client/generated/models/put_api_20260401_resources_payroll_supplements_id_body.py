...
T = TypeVar("T", bound="PutApi20260401ResourcesPayrollSupplementsIdBody")


@_attrs_define
class PutApi20260401ResourcesPayrollSupplementsIdBody:
    id: int
    """ The supplement id """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_payroll_supplements_id_body = cls(
            id=id,
        ...
        put_api_20260401_resources_payroll_supplements_id_body.additional_properties = d
        return put_api_20260401_resources_payroll_supplements_id_body
