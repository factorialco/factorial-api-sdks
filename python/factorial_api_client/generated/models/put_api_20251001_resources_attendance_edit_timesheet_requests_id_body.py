...
from ..models.put_api_20251001_resources_attendance_edit_timesheet_requests_id_body_location_type import (
    PutApi20251001ResourcesAttendanceEditTimesheetRequestsIdBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20251001ResourcesAttendanceEditTimesheetRequestsIdBody")


@_attrs_define
class PutApi20251001ResourcesAttendanceEditTimesheetRequestsIdBody:
    employee_id: int
    id: int
    ...
    location_type: (
        PutApi20251001ResourcesAttendanceEditTimesheetRequestsIdBodyLocationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_attendance_edit_timesheet_requests_id_body = cls(
            employee_id=employee_id,
            id=id,
        ...
        put_api_20251001_resources_attendance_edit_timesheet_requests_id_body.additional_properties = d
        return put_api_20251001_resources_attendance_edit_timesheet_requests_id_body
