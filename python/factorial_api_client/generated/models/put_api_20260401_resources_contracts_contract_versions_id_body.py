...
from ..models.put_api_20260401_resources_contracts_contract_versions_id_body_annual_working_time_distribution import (
    PutApi20260401ResourcesContractsContractVersionsIdBodyAnnualWorkingTimeDistribution,
)
from ..models.put_api_20260401_resources_contracts_contract_versions_id_body_bank_holiday_treatment import (
    PutApi20260401ResourcesContractsContractVersionsIdBodyBankHolidayTreatment,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesContractsContractVersionsIdBody")


@_attrs_define
class PutApi20260401ResourcesContractsContractVersionsIdBody:
    id: int
    ...
    bank_holiday_treatment: (
        PutApi20260401ResourcesContractsContractVersionsIdBodyBankHolidayTreatment | Unset
    ) = UNSET
    ...
    annual_working_time_distribution: (
        PutApi20260401ResourcesContractsContractVersionsIdBodyAnnualWorkingTimeDistribution | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_contracts_contract_versions_id_body = cls(
            id=id,
        ...
        put_api_20260401_resources_contracts_contract_versions_id_body.additional_properties = d
        return put_api_20260401_resources_contracts_contract_versions_id_body
