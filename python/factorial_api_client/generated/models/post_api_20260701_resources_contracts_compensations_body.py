...
from ..models.post_api_20260701_resources_contracts_compensations_body_time_condition import (
    PostApi20260701ResourcesContractsCompensationsBodyTimeCondition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesContractsCompensationsBody")


@_attrs_define
class PostApi20260701ResourcesContractsCompensationsBody:
    ...
    time_condition: PostApi20260701ResourcesContractsCompensationsBodyTimeCondition | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_condition: PostApi20260701ResourcesContractsCompensationsBodyTimeCondition | Unset
        if isinstance(_time_condition, Unset):
            time_condition = UNSET
        else:
            time_condition = PostApi20260701ResourcesContractsCompensationsBodyTimeCondition(
                _time_condition
        ...
        post_api_20260701_resources_contracts_compensations_body = cls(
            contract_version_id=contract_version_id,
            contracts_taxonomy_id=contracts_taxonomy_id,
        ...
        post_api_20260701_resources_contracts_compensations_body.additional_properties = d
        return post_api_20260701_resources_contracts_compensations_body
