...
if TYPE_CHECKING:
    from ..models.post_api_20261001_resources_ats_applications_apply_body_answers_item import (
        PostApi20261001ResourcesAtsApplicationsApplyBodyAnswersItem,
    )


T = TypeVar("T", bound="PostApi20261001ResourcesAtsApplicationsApplyBody")


@_attrs_define
class PostApi20261001ResourcesAtsApplicationsApplyBody:
    first_name: str
    ...
    answers: list[PostApi20261001ResourcesAtsApplicationsApplyBodyAnswersItem] | Unset = UNSET
    """ answers """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _answers is not UNSET:
            ...
            for answers_item_data in _answers:
                answers_item = (
                    PostApi20261001ResourcesAtsApplicationsApplyBodyAnswersItem.from_dict(
                        answers_item_data
                    )
                )
        ...
        post_api_20261001_resources_ats_applications_apply_body = cls(
            first_name=first_name,
            last_name=last_name,
            ats_job_posting_id=ats_job_posting_id,
            email=email,
        ...
        post_api_20261001_resources_ats_applications_apply_body.additional_properties = d
        return post_api_20261001_resources_ats_applications_apply_body
