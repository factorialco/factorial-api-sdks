...
if TYPE_CHECKING:
    from ..models.post_api_20261001_resources_finance_contacts_body_address import (
        PostApi20261001ResourcesFinanceContactsBodyAddress,
    )


T = TypeVar("T", bound="PostApi20261001ResourcesFinanceContactsBody")


@_attrs_define
class PostApi20261001ResourcesFinanceContactsBody:
    name: str
    """ The commercial name of the Contact. """
    address: PostApi20261001ResourcesFinanceContactsBodyAddress
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        address = PostApi20261001ResourcesFinanceContactsBodyAddress.from_dict(d.pop("address"))
        ...
        post_api_20261001_resources_finance_contacts_body = cls(
            name=name,
            address=address,
            tax_id=tax_id,
        ...
        post_api_20261001_resources_finance_contacts_body.additional_properties = d
        return post_api_20261001_resources_finance_contacts_body
