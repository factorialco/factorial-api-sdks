...
from ..models.post_api_20260401_resources_contracts_contract_versions_body_annual_working_time_distribution import (
    PostApi20260401ResourcesContractsContractVersionsBodyAnnualWorkingTimeDistribution,
)
from ..models.post_api_20260401_resources_contracts_contract_versions_body_bank_holiday_treatment import (
    PostApi20260401ResourcesContractsContractVersionsBodyBankHolidayTreatment,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesContractsContractVersionsBody")


@_attrs_define
class PostApi20260401ResourcesContractsContractVersionsBody:
    employee_id: int
    ...
    annual_working_time_distribution: (
        PostApi20260401ResourcesContractsContractVersionsBodyAnnualWorkingTimeDistribution | Unset
    ) = UNSET
    ...
    bank_holiday_treatment: (
        PostApi20260401ResourcesContractsContractVersionsBodyBankHolidayTreatment | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_contracts_contract_versions_body = cls(
            employee_id=employee_id,
            effective_on=effective_on,
            starts_on=starts_on,
            ends_on=ends_on,
        ...
        post_api_20260401_resources_contracts_contract_versions_body.additional_properties = d
        return post_api_20260401_resources_contracts_contract_versions_body
