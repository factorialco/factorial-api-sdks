...
T = TypeVar("T", bound="PostApi20251001ResourcesProjectManagementProjectTasksBulkDuplicateBody")


@_attrs_define
class PostApi20251001ResourcesProjectManagementProjectTasksBulkDuplicateBody:
    ids: list[int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_project_management_project_tasks_bulk_duplicate_body = cls(
            ids=ids,
        ...
        post_api_20251001_resources_project_management_project_tasks_bulk_duplicate_body.additional_properties = d
        return post_api_20251001_resources_project_management_project_tasks_bulk_duplicate_body
