...
T = TypeVar("T", bound="PostApi20260701ResourcesPayrollSupplementsBody")


@_attrs_define
class PostApi20260701ResourcesPayrollSupplementsBody:
    amount_in_cents: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_payroll_supplements_body = cls(
            amount_in_cents=amount_in_cents,
            employee_id=employee_id,
            effective_on=effective_on,
            contracts_taxonomy_id=contracts_taxonomy_id,
        ...
        post_api_20260701_resources_payroll_supplements_body.additional_properties = d
        return post_api_20260701_resources_payroll_supplements_body
