...
T = TypeVar(
    "T",
    bound="PerformanceReviewQuestionnairesByStrategyEmployeePotentialScoreManagerQuestionnaireContentItemQuestionsItemMetadata",
)


@_attrs_define
class PerformanceReviewQuestionnairesByStrategyEmployeePotentialScoreManagerQuestionnaireContentItemQuestionsItemMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_review_questionnaires_by_strategy_employee_potential_score_manager_questionnaire_content_item_questions_item_metadata = cls(
        ...
        performance_review_questionnaires_by_strategy_employee_potential_score_manager_questionnaire_content_item_questions_item_metadata.additional_properties = d
        return performance_review_questionnaires_by_strategy_employee_potential_score_manager_questionnaire_content_item_questions_item_metadata
