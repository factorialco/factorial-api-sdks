...
from ..models.put_api_20260401_resources_attendance_edit_timesheet_requests_id_body_location_type import (
    PutApi20260401ResourcesAttendanceEditTimesheetRequestsIdBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesAttendanceEditTimesheetRequestsIdBody")


@_attrs_define
class PutApi20260401ResourcesAttendanceEditTimesheetRequestsIdBody:
    employee_id: int
    id: int
    ...
    location_type: (
        PutApi20260401ResourcesAttendanceEditTimesheetRequestsIdBodyLocationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_attendance_edit_timesheet_requests_id_body = cls(
            employee_id=employee_id,
            id=id,
        ...
        put_api_20260401_resources_attendance_edit_timesheet_requests_id_body.additional_properties = d
        return put_api_20260401_resources_attendance_edit_timesheet_requests_id_body
