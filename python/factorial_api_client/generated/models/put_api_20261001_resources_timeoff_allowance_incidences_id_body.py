...
from ..models.put_api_20261001_resources_timeoff_allowance_incidences_id_body_target_balance import (
    PutApi20261001ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesTimeoffAllowanceIncidencesIdBody")


@_attrs_define
class PutApi20261001ResourcesTimeoffAllowanceIncidencesIdBody:
    id: str
    ...
    target_balance: PutApi20261001ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_target_balance, Unset):
            ...
            target_balance = PutApi20261001ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance(
                _target_balance
            ) if _target_balance is not None else None

        put_api_20261001_resources_timeoff_allowance_incidences_id_body = cls(
            id=id,
        ...
        put_api_20261001_resources_timeoff_allowance_incidences_id_body.additional_properties = d
        return put_api_20261001_resources_timeoff_allowance_incidences_id_body
