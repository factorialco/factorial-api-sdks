...
T = TypeVar(
    "T",
    bound="PerformanceReviewEvaluationAnswerAnsweredQuestionnaireWithSectionsContentItemQuestionsItemQuestionMetadata",
)


@_attrs_define
class PerformanceReviewEvaluationAnswerAnsweredQuestionnaireWithSectionsContentItemQuestionsItemQuestionMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_review_evaluation_answer_answered_questionnaire_with_sections_content_item_questions_item_question_metadata = cls(
        ...
        performance_review_evaluation_answer_answered_questionnaire_with_sections_content_item_questions_item_question_metadata.additional_properties = d
        return performance_review_evaluation_answer_answered_questionnaire_with_sections_content_item_questions_item_question_metadata
