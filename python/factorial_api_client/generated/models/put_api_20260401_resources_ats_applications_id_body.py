...
from ..models.put_api_20260401_resources_ats_applications_id_body_author_type import (
    PutApi20260401ResourcesAtsApplicationsIdBodyAuthorType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesAtsApplicationsIdBody")


@_attrs_define
class PutApi20260401ResourcesAtsApplicationsIdBody:
    id: int
    """ Application id """
    author_id: int | Unset = UNSET
    """ Application author id """
    author_type: PutApi20260401ResourcesAtsApplicationsIdBodyAuthorType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author_type: PutApi20260401ResourcesAtsApplicationsIdBodyAuthorType | Unset
        if isinstance(_author_type, Unset):
            author_type = UNSET
        else:
            author_type = PutApi20260401ResourcesAtsApplicationsIdBodyAuthorType(_author_type) if _author_type is not None else None
        ...
        put_api_20260401_resources_ats_applications_id_body = cls(
            id=id,
            author_id=author_id,
        ...
        put_api_20260401_resources_ats_applications_id_body.additional_properties = d
        return put_api_20260401_resources_ats_applications_id_body
