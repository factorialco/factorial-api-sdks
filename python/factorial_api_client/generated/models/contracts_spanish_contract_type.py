...
T = TypeVar("T", bound="ContractsSpanishContractType")
...
class ContractsSpanishContractType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contracts_spanish_contract_type = cls(
            id=id,
            name=name,
            default=default,
        ...
        contracts_spanish_contract_type.additional_properties = d
        return contracts_spanish_contract_type
