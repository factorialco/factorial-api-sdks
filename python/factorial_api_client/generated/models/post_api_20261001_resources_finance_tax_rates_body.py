...
T = TypeVar("T", bound="PostApi20261001ResourcesFinanceTaxRatesBody")


@_attrs_define
class PostApi20261001ResourcesFinanceTaxRatesBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_finance_tax_rates_body = cls(
        ...
        post_api_20261001_resources_finance_tax_rates_body.additional_properties = d
        return post_api_20261001_resources_finance_tax_rates_body
