...
T = TypeVar("T", bound="PostApi20251001ResourcesTimeoffLeavesBody")


@_attrs_define
class PostApi20251001ResourcesTimeoffLeavesBody:
    employee_id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_timeoff_leaves_body = cls(
            employee_id=employee_id,
            start_on=start_on,
        ...
        post_api_20251001_resources_timeoff_leaves_body.additional_properties = d
        return post_api_20251001_resources_timeoff_leaves_body
