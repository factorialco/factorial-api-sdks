...
from ..models.post_api_20260701_resources_attendance_shifts_clock_in_body_location_type import (
    PostApi20260701ResourcesAttendanceShiftsClockInBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesAttendanceShiftsClockInBody")


@_attrs_define
class PostApi20260701ResourcesAttendanceShiftsClockInBody:
    now: str
    """ Clock in time """
    ...
    location_type: PostApi20260701ResourcesAttendanceShiftsClockInBodyLocationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PostApi20260701ResourcesAttendanceShiftsClockInBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PostApi20260701ResourcesAttendanceShiftsClockInBodyLocationType(
                _location_type
            )
        ...
        post_api_20260701_resources_attendance_shifts_clock_in_body = cls(
            now=now,
        ...
        post_api_20260701_resources_attendance_shifts_clock_in_body.additional_properties = d
        return post_api_20260701_resources_attendance_shifts_clock_in_body
