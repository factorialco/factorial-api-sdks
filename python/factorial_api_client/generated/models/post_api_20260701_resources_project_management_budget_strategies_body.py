...
from ..models.post_api_20260701_resources_project_management_budget_strategies_body_budget_strategy_type import (
    PostApi20260701ResourcesProjectManagementBudgetStrategiesBodyBudgetStrategyType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesProjectManagementBudgetStrategiesBody")


@_attrs_define
class PostApi20260701ResourcesProjectManagementBudgetStrategiesBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_project_management_budget_strategies_body = cls(
            budget_strategy_type=budget_strategy_type,
            project_id=project_id,
        ...
        post_api_20260701_resources_project_management_budget_strategies_body.additional_properties = d
        return post_api_20260701_resources_project_management_budget_strategies_body
