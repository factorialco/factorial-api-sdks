...
from ..models.post_api_20261001_resources_tasks_tasks_body_status import (
    PostApi20261001ResourcesTasksTasksBodyStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesTasksTasksBody")


@_attrs_define
class PostApi20261001ResourcesTasksTasksBody:
    name: str
    """ name of the task. """
    status: PostApi20261001ResourcesTasksTasksBodyStatus
    ...
    """ employee that will be set as the author of the task. Only taken into account when authenticating with an API
    key, requests performed on behalf of a user always use that user as the author. When omitted, the task is
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApi20261001ResourcesTasksTasksBodyStatus(d.pop("status"))
        ...
        post_api_20261001_resources_tasks_tasks_body = cls(
            name=name,
            status=status,
            content=content,
            due_on=due_on,
        ...
        post_api_20261001_resources_tasks_tasks_body.additional_properties = d
        return post_api_20261001_resources_tasks_tasks_body
