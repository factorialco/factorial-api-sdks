...
T = TypeVar("T", bound="PutApi20261001ResourcesProjectManagementProjectsIdBody")


@_attrs_define
class PutApi20261001ResourcesProjectManagementProjectsIdBody:
    id: str
    """ Id project. """
    name: str
    """ Name of the project. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_project_management_projects_id_body = cls(
            id=id,
            name=name,
            code=code,
        ...
        put_api_20261001_resources_project_management_projects_id_body.additional_properties = d
        return put_api_20261001_resources_project_management_projects_id_body
