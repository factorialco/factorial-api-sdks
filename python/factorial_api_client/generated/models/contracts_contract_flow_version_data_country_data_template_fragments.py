...
T = TypeVar("T", bound="ContractsContractFlowVersionDataCountryDataTemplateFragments")


@_attrs_define
class ContractsContractFlowVersionDataCountryDataTemplateFragments:
    """Identifiers of the materialized_template_fragment records that produced this country data. After a legal entity
    change they are the target legal entity's fragments.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contracts_contract_flow_version_data_country_data_template_fragments = cls(
        ...
        contracts_contract_flow_version_data_country_data_template_fragments.additional_properties = d
        return contracts_contract_flow_version_data_country_data_template_fragments
