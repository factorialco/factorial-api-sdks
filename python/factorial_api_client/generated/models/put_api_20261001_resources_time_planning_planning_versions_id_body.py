...
T = TypeVar("T", bound="PutApi20261001ResourcesTimePlanningPlanningVersionsIdBody")


@_attrs_define
class PutApi20261001ResourcesTimePlanningPlanningVersionsIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_time_planning_planning_versions_id_body = cls(
            id=id,
            effective_at=effective_at,
            planning_tool=planning_tool,
        ...
        put_api_20261001_resources_time_planning_planning_versions_id_body.additional_properties = d
        return put_api_20261001_resources_time_planning_planning_versions_id_body
