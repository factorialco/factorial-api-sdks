...
from ..models.put_api_20251001_resources_contracts_compensations_id_body_time_condition import (
    PutApi20251001ResourcesContractsCompensationsIdBodyTimeCondition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20251001ResourcesContractsCompensationsIdBody")


@_attrs_define
class PutApi20251001ResourcesContractsCompensationsIdBody:
    ...
    time_condition: PutApi20251001ResourcesContractsCompensationsIdBodyTimeCondition | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_condition: PutApi20251001ResourcesContractsCompensationsIdBodyTimeCondition | Unset
        if isinstance(_time_condition, Unset):
            time_condition = UNSET
        else:
            time_condition = PutApi20251001ResourcesContractsCompensationsIdBodyTimeCondition(
                _time_condition
            )
        ...
        put_api_20251001_resources_contracts_compensations_id_body = cls(
            contracts_taxonomy_id=contracts_taxonomy_id,
            id=id,
        ...
        put_api_20251001_resources_contracts_compensations_id_body.additional_properties = d
        return put_api_20251001_resources_contracts_compensations_id_body
