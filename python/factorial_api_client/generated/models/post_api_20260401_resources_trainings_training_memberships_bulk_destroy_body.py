...
T = TypeVar("T", bound="PostApi20260401ResourcesTrainingsTrainingMembershipsBulkDestroyBody")


@_attrs_define
class PostApi20260401ResourcesTrainingsTrainingMembershipsBulkDestroyBody:
    ids: list[int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_trainings_training_memberships_bulk_destroy_body = cls(
            ids=ids,
            training_id=training_id,
            all_=all_,
        )

        post_api_20260401_resources_trainings_training_memberships_bulk_destroy_body.additional_properties = d
        return post_api_20260401_resources_trainings_training_memberships_bulk_destroy_body
