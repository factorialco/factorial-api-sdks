...
from ..models.put_api_20251001_resources_trainings_sessions_id_body_schedule import (
    PutApi20251001ResourcesTrainingsSessionsIdBodySchedule,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20251001ResourcesTrainingsSessionsIdBody")


@_attrs_define
class PutApi20251001ResourcesTrainingsSessionsIdBody:
    id: int
    ...
    schedule: PutApi20251001ResourcesTrainingsSessionsIdBodySchedule | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule: PutApi20251001ResourcesTrainingsSessionsIdBodySchedule | Unset
        if isinstance(_schedule, Unset):
            schedule = UNSET
        else:
            schedule = PutApi20251001ResourcesTrainingsSessionsIdBodySchedule(_schedule) if _schedule is not None else None
        ...
        put_api_20251001_resources_trainings_sessions_id_body = cls(
            id=id,
            name=name,
            starts_at=starts_at,
            ends_at=ends_at,
        ...
        put_api_20251001_resources_trainings_sessions_id_body.additional_properties = d
        return put_api_20251001_resources_trainings_sessions_id_body
