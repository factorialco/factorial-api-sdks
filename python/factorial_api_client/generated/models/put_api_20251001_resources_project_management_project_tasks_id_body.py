...
from .. import types
from ..models.put_api_20251001_resources_project_management_project_tasks_id_body_status import (
    PutApi20251001ResourcesProjectManagementProjectTasksIdBodyStatus,
)
from ..types import UNSET, File, FileTypes, Unset

T = TypeVar("T", bound="PutApi20251001ResourcesProjectManagementProjectTasksIdBody")


@_attrs_define
class PutApi20251001ResourcesProjectManagementProjectTasksIdBody:
    id: int
    ...
    files_to_remove: list[int] | Unset = UNSET
    """ Array of files to remove from the project task """
    status: PutApi20251001ResourcesProjectManagementProjectTasksIdBodyStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        files_to_remove = cast(list[int], d.pop("files_to_remove[]", UNSET))

        _status = d.pop("status", UNSET)
        status: PutApi20251001ResourcesProjectManagementProjectTasksIdBodyStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PutApi20251001ResourcesProjectManagementProjectTasksIdBodyStatus(_status) if _status is not None else None

        put_api_20251001_resources_project_management_project_tasks_id_body = cls(
            id=id,
            name=name,
            project_id=project_id,
            content=content,
        ...
        put_api_20251001_resources_project_management_project_tasks_id_body.additional_properties = d
        return put_api_20251001_resources_project_management_project_tasks_id_body
