...
T = TypeVar(
    "T", bound="PutApi20261001ResourcesContractsContractVersionsIdBodyCountryDataInputsItem"
)


@_attrs_define
class PutApi20261001ResourcesContractsContractVersionsIdBodyCountryDataInputsItem:
    field_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_contracts_contract_versions_id_body_country_data_inputs_item = (
            cls(
                field_name=field_name,
                value_id=value_id,
        ...
        put_api_20261001_resources_contracts_contract_versions_id_body_country_data_inputs_item.additional_properties = d
        return (
            put_api_20261001_resources_contracts_contract_versions_id_body_country_data_inputs_item
        )
