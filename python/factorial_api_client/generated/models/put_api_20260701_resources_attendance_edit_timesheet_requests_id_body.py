...
from ..models.put_api_20260701_resources_attendance_edit_timesheet_requests_id_body_location_type import (
    PutApi20260701ResourcesAttendanceEditTimesheetRequestsIdBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260701ResourcesAttendanceEditTimesheetRequestsIdBody")


@_attrs_define
class PutApi20260701ResourcesAttendanceEditTimesheetRequestsIdBody:
    employee_id: str
    id: str
    ...
    location_type: (
        PutApi20260701ResourcesAttendanceEditTimesheetRequestsIdBodyLocationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_attendance_edit_timesheet_requests_id_body = cls(
            employee_id=employee_id,
            id=id,
        ...
        put_api_20260701_resources_attendance_edit_timesheet_requests_id_body.additional_properties = d
        return put_api_20260701_resources_attendance_edit_timesheet_requests_id_body
