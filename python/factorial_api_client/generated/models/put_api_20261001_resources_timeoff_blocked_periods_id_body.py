...
if TYPE_CHECKING:
    from ..models.put_api_20261001_resources_timeoff_blocked_periods_id_body_time_periods_attributes_item import (
        PutApi20261001ResourcesTimeoffBlockedPeriodsIdBodyTimePeriodsAttributesItem,
    )


T = TypeVar("T", bound="PutApi20261001ResourcesTimeoffBlockedPeriodsIdBody")


@_attrs_define
class PutApi20261001ResourcesTimeoffBlockedPeriodsIdBody:
    id: str
    name: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for time_periods_attributes_item_data in self.time_periods_attributes:
            time_periods_attributes_item = time_periods_attributes_item_data.to_dict()
            time_periods_attributes.append(time_periods_attributes_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_periods_attributes = []
        _time_periods_attributes = d.pop("time_periods_attributes")
        for time_periods_attributes_item_data in _time_periods_attributes:
            time_periods_attributes_item = PutApi20261001ResourcesTimeoffBlockedPeriodsIdBodyTimePeriodsAttributesItem.from_dict(
                time_periods_attributes_item_data
            )
        ...
        put_api_20261001_resources_timeoff_blocked_periods_id_body = cls(
            id=id,
            name=name,
            leave_type_ids=leave_type_ids,
            time_periods_attributes=time_periods_attributes,
        ...
        put_api_20261001_resources_timeoff_blocked_periods_id_body.additional_properties = d
        return put_api_20261001_resources_timeoff_blocked_periods_id_body
