...
from ..models.put_api_20260701_resources_contracts_contract_versions_id_body_annual_working_time_distribution import (
    PutApi20260701ResourcesContractsContractVersionsIdBodyAnnualWorkingTimeDistribution,
)
from ..models.put_api_20260701_resources_contracts_contract_versions_id_body_bank_holiday_treatment import (
    PutApi20260701ResourcesContractsContractVersionsIdBodyBankHolidayTreatment,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260701ResourcesContractsContractVersionsIdBody")


@_attrs_define
class PutApi20260701ResourcesContractsContractVersionsIdBody:
    id: str
    ...
    bank_holiday_treatment: (
        PutApi20260701ResourcesContractsContractVersionsIdBodyBankHolidayTreatment | Unset
    ) = UNSET
    ...
    annual_working_time_distribution: (
        PutApi20260701ResourcesContractsContractVersionsIdBodyAnnualWorkingTimeDistribution | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_contracts_contract_versions_id_body = cls(
            id=id,
        ...
        put_api_20260701_resources_contracts_contract_versions_id_body.additional_properties = d
        return put_api_20260701_resources_contracts_contract_versions_id_body
