...
from ..models.performance_review_evaluation_score_reviewer_strategy import (
    PerformanceReviewEvaluationScoreReviewerStrategy,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PerformanceReviewEvaluationScore")
...
class PerformanceReviewEvaluationScore:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_review_evaluation_score = cls(
            id=id,
            review_process_id=review_process_id,
            review_evaluation_id=review_evaluation_id,
            target_access_id=target_access_id,
        ...
        performance_review_evaluation_score.additional_properties = d
        return performance_review_evaluation_score
