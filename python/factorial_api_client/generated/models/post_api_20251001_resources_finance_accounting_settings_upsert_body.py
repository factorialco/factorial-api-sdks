...
T = TypeVar("T", bound="PostApi20251001ResourcesFinanceAccountingSettingsUpsertBody")


@_attrs_define
class PostApi20251001ResourcesFinanceAccountingSettingsUpsertBody:
    legal_entity_id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_finance_accounting_settings_upsert_body = cls(
            legal_entity_id=legal_entity_id,
        ...
        post_api_20251001_resources_finance_accounting_settings_upsert_body.additional_properties = d
        return post_api_20251001_resources_finance_accounting_settings_upsert_body
