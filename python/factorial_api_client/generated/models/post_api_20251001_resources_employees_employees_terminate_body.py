...
T = TypeVar("T", bound="PostApi20251001ResourcesEmployeesEmployeesTerminateBody")


@_attrs_define
class PostApi20251001ResourcesEmployeesEmployeesTerminateBody:
    id: int
    """ id of the employee. """
    terminated_on: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_employees_employees_terminate_body = cls(
            id=id,
            terminated_on=terminated_on,
        ...
        post_api_20251001_resources_employees_employees_terminate_body.additional_properties = d
        return post_api_20251001_resources_employees_employees_terminate_body
