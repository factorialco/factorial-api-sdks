...
from ..models.post_api_20260701_resources_finance_ledger_account_resources_upsert_body_balance_type import (
    PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBodyBalanceType,
)
from ..models.post_api_20260701_resources_finance_ledger_account_resources_upsert_body_operation_type import (
    PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBodyOperationType,
)
from ..models.post_api_20260701_resources_finance_ledger_account_resources_upsert_body_resource_type import (
    PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBodyResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBody")


@_attrs_define
class PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBody:
    legal_entity_id: str
    """ Legal entity identifier. """
    resource_type: PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBodyResourceType
    ...
    balance_type: (
        PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBodyBalanceType | Unset
    ) = UNSET
    """ Ledger account balance type. """
    operation_type: (
        PostApi20260701ResourcesFinanceLedgerAccountResourcesUpsertBodyOperationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_finance_ledger_account_resources_upsert_body.additional_properties = d
        return post_api_20260701_resources_finance_ledger_account_resources_upsert_body
