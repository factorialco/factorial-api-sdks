...
from ..models.post_api_20260701_resources_ats_answers_body_original_question_type import (
    PostApi20260701ResourcesAtsAnswersBodyOriginalQuestionType,
)

T = TypeVar("T", bound="PostApi20260701ResourcesAtsAnswersBody")


@_attrs_define
class PostApi20260701ResourcesAtsAnswersBody:
    ats_question_id: str
    ...
    original_question_type: PostApi20260701ResourcesAtsAnswersBodyOriginalQuestionType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_ats_answers_body = cls(
            ats_question_id=ats_question_id,
            ats_application_id=ats_application_id,
            value=value,
            original_question_label=original_question_label,
        ...
        post_api_20260701_resources_ats_answers_body.additional_properties = d
        return post_api_20260701_resources_ats_answers_body
