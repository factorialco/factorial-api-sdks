...
T = TypeVar("T", bound="PutApi20260701ResourcesTimeoffBlockedPeriodsIdBody")


@_attrs_define
class PutApi20260701ResourcesTimeoffBlockedPeriodsIdBody:
    id: str
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_timeoff_blocked_periods_id_body = cls(
            id=id,
            name=name,
            leave_type_ids=leave_type_ids,
            time_periods_attributes=time_periods_attributes,
        ...
        put_api_20260701_resources_timeoff_blocked_periods_id_body.additional_properties = d
        return put_api_20260701_resources_timeoff_blocked_periods_id_body
