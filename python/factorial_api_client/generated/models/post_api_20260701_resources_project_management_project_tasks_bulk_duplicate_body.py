...
T = TypeVar("T", bound="PostApi20260701ResourcesProjectManagementProjectTasksBulkDuplicateBody")


@_attrs_define
class PostApi20260701ResourcesProjectManagementProjectTasksBulkDuplicateBody:
    ids: list[str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_project_management_project_tasks_bulk_duplicate_body = cls(
            ids=ids,
        ...
        post_api_20260701_resources_project_management_project_tasks_bulk_duplicate_body.additional_properties = d
        return post_api_20260701_resources_project_management_project_tasks_bulk_duplicate_body
