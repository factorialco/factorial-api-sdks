...
T = TypeVar("T", bound="PostApi20261001ResourcesAttendanceShiftsBreakEndBody")


@_attrs_define
class PostApi20261001ResourcesAttendanceShiftsBreakEndBody:
    now: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_attendance_shifts_break_end_body = cls(
            now=now,
        ...
        post_api_20261001_resources_attendance_shifts_break_end_body.additional_properties = d
        return post_api_20261001_resources_attendance_shifts_break_end_body
