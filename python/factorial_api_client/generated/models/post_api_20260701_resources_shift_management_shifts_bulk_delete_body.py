...
T = TypeVar("T", bound="PostApi20260701ResourcesShiftManagementShiftsBulkDeleteBody")


@_attrs_define
class PostApi20260701ResourcesShiftManagementShiftsBulkDeleteBody:
    author_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_shift_management_shifts_bulk_delete_body = cls(
            author_id=author_id,
            ids=ids,
            start_at=start_at,
            end_at=end_at,
        ...
        post_api_20260701_resources_shift_management_shifts_bulk_delete_body.additional_properties = d
        return post_api_20260701_resources_shift_management_shifts_bulk_delete_body
