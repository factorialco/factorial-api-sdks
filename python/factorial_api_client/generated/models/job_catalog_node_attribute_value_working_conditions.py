...
@_attrs_define
class JobCatalogNodeAttributeValueWorkingConditions:
    """Working-conditions payload with agreement info and simple key/value constraints. Numeric values are stored in cents
    (40 hours is stored as 4000).

        Example:
            {"name":"Retail Agreement","description":"Standard UK contract","conditions":[{"key":"max_weekly_hours","value":
                "4000"},{"key":"bank_holidays_treatment","value":"non_workable"}]}
