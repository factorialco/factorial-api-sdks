...
T = TypeVar("T", bound="PutApi20260401ResourcesTimeoffLeaveTypesIdBody")


@_attrs_define
class PutApi20260401ResourcesTimeoffLeaveTypesIdBody:
    id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_timeoff_leave_types_id_body = cls(
            id=id,
            accrues=accrues,
        ...
        put_api_20260401_resources_timeoff_leave_types_id_body.additional_properties = d
        return put_api_20260401_resources_timeoff_leave_types_id_body
