...
T = TypeVar(
    "T",
    bound="PutApi20261001ResourcesCompensationsAdditionalCompensationsIdBodyPerWorkedDayDefinition",
)


@_attrs_define
class PutApi20261001ResourcesCompensationsAdditionalCompensationsIdBodyPerWorkedDayDefinition:
    """Definition object for PerWorkedDay strategies. Same shape as on create — replaces the previous definition when
    supplied.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_compensations_additional_compensations_id_body_per_worked_day_definition = cls(
            calculation_source=calculation_source,
            reference_time=reference_time,
        ...
        put_api_20261001_resources_compensations_additional_compensations_id_body_per_worked_day_definition.additional_properties = d
        return put_api_20261001_resources_compensations_additional_compensations_id_body_per_worked_day_definition
