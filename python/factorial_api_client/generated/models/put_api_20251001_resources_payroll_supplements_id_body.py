...
T = TypeVar("T", bound="PutApi20251001ResourcesPayrollSupplementsIdBody")


@_attrs_define
class PutApi20251001ResourcesPayrollSupplementsIdBody:
    id: int
    """ The supplement id """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_payroll_supplements_id_body = cls(
            id=id,
        ...
        put_api_20251001_resources_payroll_supplements_id_body.additional_properties = d
        return put_api_20251001_resources_payroll_supplements_id_body
