...
T = TypeVar("T", bound="PutApi20251001ResourcesTrainingsTrainingMembershipsIdBody")


@_attrs_define
class PutApi20251001ResourcesTrainingsTrainingMembershipsIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_trainings_training_memberships_id_body = cls(
            id=id,
            training_completed_at=training_completed_at,
        )

        put_api_20251001_resources_trainings_training_memberships_id_body.additional_properties = d
        return put_api_20251001_resources_trainings_training_memberships_id_body
