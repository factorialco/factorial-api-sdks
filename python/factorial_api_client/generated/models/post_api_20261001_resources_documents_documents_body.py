...
from .. import types
from ..models.post_api_20261001_resources_documents_documents_body_space import (
    PostApi20261001ResourcesDocumentsDocumentsBodySpace,
)
from ..types import UNSET, File, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesDocumentsDocumentsBody")


@_attrs_define
class PostApi20261001ResourcesDocumentsDocumentsBody:
    public: bool
    """ flag to indicate if the document is public. """
    space: PostApi20261001ResourcesDocumentsDocumentsBodySpace
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        space = PostApi20261001ResourcesDocumentsDocumentsBodySpace(d.pop("space"))
        ...
        signee_ids = cast(list[str], d.pop("signee_ids[]"))
        ...
        post_api_20261001_resources_documents_documents_body = cls(
            public=public,
            space=space,
            is_pending_assignment=is_pending_assignment,
            file=file,
        ...
        post_api_20261001_resources_documents_documents_body.additional_properties = d
        return post_api_20261001_resources_documents_documents_body
