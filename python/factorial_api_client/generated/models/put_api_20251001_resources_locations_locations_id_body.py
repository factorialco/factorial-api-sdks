...
T = TypeVar("T", bound="PutApi20251001ResourcesLocationsLocationsIdBody")


@_attrs_define
class PutApi20251001ResourcesLocationsLocationsIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_locations_locations_id_body = cls(
            id=id,
            name=name,
            country=country,
            main=main,
        ...
        put_api_20251001_resources_locations_locations_id_body.additional_properties = d
        return put_api_20251001_resources_locations_locations_id_body
