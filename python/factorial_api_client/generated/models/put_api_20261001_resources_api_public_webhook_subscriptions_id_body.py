...
from ..models.put_api_20261001_resources_api_public_webhook_subscriptions_id_body_api_version import (
    PutApi20261001ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesApiPublicWebhookSubscriptionsIdBody")


@_attrs_define
class PutApi20261001ResourcesApiPublicWebhookSubscriptionsIdBody:
    id: str
    ...
    api_version: PutApi20261001ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_api_version, Unset):
            ...
            api_version = PutApi20261001ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion(
                _api_version
            ) if _api_version is not None else None

        put_api_20261001_resources_api_public_webhook_subscriptions_id_body = cls(
            id=id,
        ...
        put_api_20261001_resources_api_public_webhook_subscriptions_id_body.additional_properties = d
        return put_api_20261001_resources_api_public_webhook_subscriptions_id_body
