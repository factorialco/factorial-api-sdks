...
from ..models.post_api_20260401_resources_tasks_tasks_body_status import (
    PostApi20260401ResourcesTasksTasksBodyStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesTasksTasksBody")


@_attrs_define
class PostApi20260401ResourcesTasksTasksBody:
    name: str
    """ name of the task. """
    status: PostApi20260401ResourcesTasksTasksBodyStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApi20260401ResourcesTasksTasksBodyStatus(d.pop("status"))
        ...
        post_api_20260401_resources_tasks_tasks_body = cls(
            name=name,
            status=status,
            content=content,
            due_on=due_on,
        ...
        post_api_20260401_resources_tasks_tasks_body.additional_properties = d
        return post_api_20260401_resources_tasks_tasks_body
