...
T = TypeVar("T", bound="FinanceContactAddress")


@_attrs_define
class FinanceContactAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        finance_contact_address.additional_properties = d
        return finance_contact_address
