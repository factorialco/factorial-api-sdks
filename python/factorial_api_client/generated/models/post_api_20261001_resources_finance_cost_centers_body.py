...
T = TypeVar("T", bound="PostApi20261001ResourcesFinanceCostCentersBody")


@_attrs_define
class PostApi20261001ResourcesFinanceCostCentersBody:
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_finance_cost_centers_body = cls(
            name=name,
            company_id=company_id,
        ...
        post_api_20261001_resources_finance_cost_centers_body.additional_properties = d
        return post_api_20261001_resources_finance_cost_centers_body
