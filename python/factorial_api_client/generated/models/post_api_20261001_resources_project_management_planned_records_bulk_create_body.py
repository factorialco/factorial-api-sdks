...
T = TypeVar("T", bound="PostApi20261001ResourcesProjectManagementPlannedRecordsBulkCreateBody")


@_attrs_define
class PostApi20261001ResourcesProjectManagementPlannedRecordsBulkCreateBody:
    project_worker_ids: list[str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        project_worker_ids = cast(list[str], d.pop("project_worker_ids"))
        ...
        post_api_20261001_resources_project_management_planned_records_bulk_create_body = cls(
            project_worker_ids=project_worker_ids,
            start_date=start_date,
            end_date=end_date,
            daily_minutes=daily_minutes,
        ...
        post_api_20261001_resources_project_management_planned_records_bulk_create_body.additional_properties = d
        return post_api_20261001_resources_project_management_planned_records_bulk_create_body
