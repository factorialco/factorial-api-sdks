...
from ..models.post_api_20261001_resources_attendance_shifts_toggle_clock_body_location_type import (
    PostApi20261001ResourcesAttendanceShiftsToggleClockBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesAttendanceShiftsToggleClockBody")


@_attrs_define
class PostApi20261001ResourcesAttendanceShiftsToggleClockBody:
    employee_id: str
    """ Employee identifier """
    clock_time: str
    """ Clock in or out Timestamp """
    location_type: PostApi20261001ResourcesAttendanceShiftsToggleClockBodyLocationType | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_location_type, Unset):
            ...
            location_type = PostApi20261001ResourcesAttendanceShiftsToggleClockBodyLocationType(
                _location_type
        ...
        post_api_20261001_resources_attendance_shifts_toggle_clock_body = cls(
            employee_id=employee_id,
            clock_time=clock_time,
        ...
        post_api_20261001_resources_attendance_shifts_toggle_clock_body.additional_properties = d
        return post_api_20261001_resources_attendance_shifts_toggle_clock_body
