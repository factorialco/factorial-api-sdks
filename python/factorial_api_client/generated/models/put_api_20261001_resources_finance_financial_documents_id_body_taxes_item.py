...
from ..models.put_api_20261001_resources_finance_financial_documents_id_body_taxes_item_type import (
    PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.put_api_20261001_resources_finance_financial_documents_id_body_taxes_item_tax_rates_item import (
        PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemTaxRatesItem,
    )


T = TypeVar("T", bound="PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItem")


@_attrs_define
class PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItem:
    amount_cents: int | Unset = UNSET
    percentage: float | Unset = UNSET
    base_amount_cents: int | Unset = UNSET
    type_: PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemType | Unset = UNSET
    tax_type_id: str | Unset = UNSET
    tax_type_name: str | Unset = UNSET
    tax_rates: (
        list[PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemTaxRatesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemType(_type_) if _type_ is not None else None
        ...
        tax_rates: (
            list[PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemTaxRatesItem]
            | Unset
        ) = UNSET
        if _tax_rates is not UNSET:
            tax_rates = []
            for tax_rates_item_data in _tax_rates:
                tax_rates_item = PutApi20261001ResourcesFinanceFinancialDocumentsIdBodyTaxesItemTaxRatesItem.from_dict(
                    tax_rates_item_data
                )

                tax_rates.append(tax_rates_item)

        put_api_20261001_resources_finance_financial_documents_id_body_taxes_item = cls(
        ...
        put_api_20261001_resources_finance_financial_documents_id_body_taxes_item.additional_properties = d
        return put_api_20261001_resources_finance_financial_documents_id_body_taxes_item
