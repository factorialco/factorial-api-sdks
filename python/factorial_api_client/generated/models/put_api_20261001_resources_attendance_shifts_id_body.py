...
from ..models.put_api_20261001_resources_attendance_shifts_id_body_location_type import (
    PutApi20261001ResourcesAttendanceShiftsIdBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesAttendanceShiftsIdBody")


@_attrs_define
class PutApi20261001ResourcesAttendanceShiftsIdBody:
    id: str
    """ Id of the shift """
    ...
    location_type: PutApi20261001ResourcesAttendanceShiftsIdBodyLocationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PutApi20261001ResourcesAttendanceShiftsIdBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PutApi20261001ResourcesAttendanceShiftsIdBodyLocationType(
                _location_type
        ...
        put_api_20261001_resources_attendance_shifts_id_body = cls(
            id=id,
            clock_in=clock_in,
            clock_out=clock_out,
            date=date,
        ...
        put_api_20261001_resources_attendance_shifts_id_body.additional_properties = d
        return put_api_20261001_resources_attendance_shifts_id_body
