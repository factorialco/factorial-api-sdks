...
from ..models.put_api_20260401_resources_trainings_sessions_id_body_schedule import (
    PutApi20260401ResourcesTrainingsSessionsIdBodySchedule,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesTrainingsSessionsIdBody")


@_attrs_define
class PutApi20260401ResourcesTrainingsSessionsIdBody:
    id: int
    ...
    schedule: PutApi20260401ResourcesTrainingsSessionsIdBodySchedule | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule: PutApi20260401ResourcesTrainingsSessionsIdBodySchedule | Unset
        if isinstance(_schedule, Unset):
            schedule = UNSET
        else:
            schedule = PutApi20260401ResourcesTrainingsSessionsIdBodySchedule(_schedule) if _schedule is not None else None
        ...
        put_api_20260401_resources_trainings_sessions_id_body = cls(
            id=id,
            name=name,
            starts_at=starts_at,
            ends_at=ends_at,
        ...
        put_api_20260401_resources_trainings_sessions_id_body.additional_properties = d
        return put_api_20260401_resources_trainings_sessions_id_body
