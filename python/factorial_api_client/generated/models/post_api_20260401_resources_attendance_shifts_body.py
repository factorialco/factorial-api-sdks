...
from ..models.post_api_20260401_resources_attendance_shifts_body_location_type import (
    PostApi20260401ResourcesAttendanceShiftsBodyLocationType,
)
from ..models.post_api_20260401_resources_attendance_shifts_body_source import (
    PostApi20260401ResourcesAttendanceShiftsBodySource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesAttendanceShiftsBody")


@_attrs_define
class PostApi20260401ResourcesAttendanceShiftsBody:
    date: str
    """ Date of the shift """
    ...
    location_type: PostApi20260401ResourcesAttendanceShiftsBodyLocationType | Unset = UNSET
    """ Type of the location """
    source: PostApi20260401ResourcesAttendanceShiftsBodySource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PostApi20260401ResourcesAttendanceShiftsBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PostApi20260401ResourcesAttendanceShiftsBodyLocationType(_location_type) if _location_type is not None else None

        _source = d.pop("source", UNSET)
        source: PostApi20260401ResourcesAttendanceShiftsBodySource | Unset
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = PostApi20260401ResourcesAttendanceShiftsBodySource(_source) if _source is not None else None

        time_settings_break_configuration_id = d.pop("time_settings_break_configuration_id", UNSET)

        post_api_20260401_resources_attendance_shifts_body = cls(
            date=date,
        ...
        post_api_20260401_resources_attendance_shifts_body.additional_properties = d
        return post_api_20260401_resources_attendance_shifts_body
