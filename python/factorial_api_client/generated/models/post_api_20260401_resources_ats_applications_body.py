...
from ..models.post_api_20260401_resources_ats_applications_body_author_type import (
    PostApi20260401ResourcesAtsApplicationsBodyAuthorType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesAtsApplicationsBody")


@_attrs_define
class PostApi20260401ResourcesAtsApplicationsBody:
    ats_job_posting_id: int
    """ Application job posting id """
    author_id: int | Unset = UNSET
    """ Application author id """
    author_type: PostApi20260401ResourcesAtsApplicationsBodyAuthorType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author_type: PostApi20260401ResourcesAtsApplicationsBodyAuthorType | Unset
        if isinstance(_author_type, Unset):
            author_type = UNSET
        else:
            author_type = PostApi20260401ResourcesAtsApplicationsBodyAuthorType(_author_type) if _author_type is not None else None
        ...
        post_api_20260401_resources_ats_applications_body = cls(
            ats_job_posting_id=ats_job_posting_id,
            author_id=author_id,
        ...
        post_api_20260401_resources_ats_applications_body.additional_properties = d
        return post_api_20260401_resources_ats_applications_body
