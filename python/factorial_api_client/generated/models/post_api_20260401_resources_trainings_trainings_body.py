...
T = TypeVar("T", bound="PostApi20260401ResourcesTrainingsTrainingsBody")


@_attrs_define
class PostApi20260401ResourcesTrainingsTrainingsBody:
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_trainings_trainings_body = cls(
            name=name,
            description=description,
            external=external,
            year=year,
        ...
        post_api_20260401_resources_trainings_trainings_body.additional_properties = d
        return post_api_20260401_resources_trainings_trainings_body
