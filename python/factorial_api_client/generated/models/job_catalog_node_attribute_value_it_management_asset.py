...
T = TypeVar("T", bound="JobCatalogNodeAttributeValueItManagementAsset")


@_attrs_define
class JobCatalogNodeAttributeValueItManagementAsset:
    """IT asset payload describing the device assigned to the node

    Example:
        {"type_name":"headset","brand":"Apple","name":"AirPods Pro"}
