...
T = TypeVar("T", bound="PostApi20261001ResourcesLocationsLocationsBody")


@_attrs_define
class PostApi20261001ResourcesLocationsLocationsBody:
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_locations_locations_body = cls(
            name=name,
            country=country,
            timezone=timezone,
            company_id=company_id,
        ...
        post_api_20261001_resources_locations_locations_body.additional_properties = d
        return post_api_20261001_resources_locations_locations_body
