...
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_available_days import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyAvailableDays,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_days_type import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyDaysType,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_frequency import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyFrequency,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_negative_counter_type import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyNegativeCounterType,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_proration_type import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyProrationType,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_range_type import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyRangeType,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_rounding import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyRounding,
)
from ..models.put_api_20260401_resources_timeoff_allowances_id_body_tenure_period_transition import (
    PutApi20260401ResourcesTimeoffAllowancesIdBodyTenurePeriodTransition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesTimeoffAllowancesIdBody")


@_attrs_define
class PutApi20260401ResourcesTimeoffAllowancesIdBody:
    id: int
    ...
    """
    available_days: PutApi20260401ResourcesTimeoffAllowancesIdBodyAvailableDays | Unset = UNSET
    ...
    days_type: PutApi20260401ResourcesTimeoffAllowancesIdBodyDaysType | Unset = UNSET
    ...
    frequency: PutApi20260401ResourcesTimeoffAllowancesIdBodyFrequency | Unset = UNSET
    ...
    negative_counter_type: (
        PutApi20260401ResourcesTimeoffAllowancesIdBodyNegativeCounterType | Unset
    ) = UNSET
    ...
    proration_type: PutApi20260401ResourcesTimeoffAllowancesIdBodyProrationType | Unset = UNSET
    ...
    range_type: PutApi20260401ResourcesTimeoffAllowancesIdBodyRangeType | Unset = UNSET
    """ Configures how leaves duration is handled. """
    rounding: PutApi20260401ResourcesTimeoffAllowancesIdBodyRounding | Unset = UNSET
    ...
    tenure_period_transition: (
        PutApi20260401ResourcesTimeoffAllowancesIdBodyTenurePeriodTransition | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        available_days: PutApi20260401ResourcesTimeoffAllowancesIdBodyAvailableDays | Unset
        if isinstance(_available_days, Unset):
            available_days = UNSET
        else:
            available_days = PutApi20260401ResourcesTimeoffAllowancesIdBodyAvailableDays(
                _available_days
            )
        ...
        days_type: PutApi20260401ResourcesTimeoffAllowancesIdBodyDaysType | Unset
        if isinstance(_days_type, Unset):
            days_type = UNSET
        else:
            days_type = PutApi20260401ResourcesTimeoffAllowancesIdBodyDaysType(_days_type) if _days_type is not None else None

        expire_in_months = d.pop("expire_in_months", UNSET)

        _frequency = d.pop("frequency", UNSET)
        frequency: PutApi20260401ResourcesTimeoffAllowancesIdBodyFrequency | Unset
        if isinstance(_frequency, Unset):
            frequency = UNSET
        else:
            frequency = PutApi20260401ResourcesTimeoffAllowancesIdBodyFrequency(_frequency) if _frequency is not None else None
        ...
        proration_type: PutApi20260401ResourcesTimeoffAllowancesIdBodyProrationType | Unset
        if isinstance(_proration_type, Unset):
            proration_type = UNSET
        else:
            proration_type = PutApi20260401ResourcesTimeoffAllowancesIdBodyProrationType(
                _proration_type
            )
        ...
        range_type: PutApi20260401ResourcesTimeoffAllowancesIdBodyRangeType | Unset
        if isinstance(_range_type, Unset):
            range_type = UNSET
        else:
            range_type = PutApi20260401ResourcesTimeoffAllowancesIdBodyRangeType(_range_type) if _range_type is not None else None

        _rounding = d.pop("rounding", UNSET)
        rounding: PutApi20260401ResourcesTimeoffAllowancesIdBodyRounding | Unset
        if isinstance(_rounding, Unset):
            rounding = UNSET
        else:
            rounding = PutApi20260401ResourcesTimeoffAllowancesIdBodyRounding(_rounding) if _rounding is not None else None
        ...
        put_api_20260401_resources_timeoff_allowances_id_body = cls(
            id=id,
        ...
        put_api_20260401_resources_timeoff_allowances_id_body.additional_properties = d
        return put_api_20260401_resources_timeoff_allowances_id_body
