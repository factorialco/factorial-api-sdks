...
from ..models.put_api_20260401_resources_api_public_webhook_subscriptions_id_body_api_version import (
    PutApi20260401ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesApiPublicWebhookSubscriptionsIdBody")


@_attrs_define
class PutApi20260401ResourcesApiPublicWebhookSubscriptionsIdBody:
    id: int
    ...
    api_version: PutApi20260401ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_api_version, Unset):
            ...
            api_version = PutApi20260401ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion(
                _api_version
            ) if _api_version is not None else None

        put_api_20260401_resources_api_public_webhook_subscriptions_id_body = cls(
            id=id,
        ...
        put_api_20260401_resources_api_public_webhook_subscriptions_id_body.additional_properties = d
        return put_api_20260401_resources_api_public_webhook_subscriptions_id_body
