...
from ..models.put_api_20261001_resources_trainings_training_classes_id_body_payment_status import (
    PutApi20261001ResourcesTrainingsTrainingClassesIdBodyPaymentStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesTrainingsTrainingClassesIdBody")


@_attrs_define
class PutApi20261001ResourcesTrainingsTrainingClassesIdBody:
    id: str
    ...
    payment_status: PutApi20261001ResourcesTrainingsTrainingClassesIdBodyPaymentStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_trainings_training_classes_id_body = cls(
            id=id,
            cost=cost,
            subsidized_cost=subsidized_cost,
            salary_cost=salary_cost,
        ...
        put_api_20261001_resources_trainings_training_classes_id_body.additional_properties = d
        return put_api_20261001_resources_trainings_training_classes_id_body
