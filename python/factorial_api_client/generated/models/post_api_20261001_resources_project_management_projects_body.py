...
T = TypeVar("T", bound="PostApi20261001ResourcesProjectManagementProjectsBody")


@_attrs_define
class PostApi20261001ResourcesProjectManagementProjectsBody:
    name: str
    ...
    project_admins: list[str] | Unset = UNSET
    """ Array of employee IDs who are project administrators """
    project_managers: list[str] | Unset = UNSET
    """ Array of employee IDs who are project managers """
    project_viewers: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        project_viewers: list[str] | Unset = UNSET
        if not isinstance(self.project_viewers, Unset):
            project_viewers = self.project_viewers
        ...
        if project_viewers is not UNSET:
            field_dict["project_viewers"] = project_viewers
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_admins = cast(list[str], d.pop("project_admins", UNSET))

        project_managers = cast(list[str], d.pop("project_managers", UNSET))

        project_viewers = cast(list[str], d.pop("project_viewers", UNSET))
        ...
        post_api_20261001_resources_project_management_projects_body = cls(
            name=name,
            code=code,
        ...
        post_api_20261001_resources_project_management_projects_body.additional_properties = d
        return post_api_20261001_resources_project_management_projects_body
