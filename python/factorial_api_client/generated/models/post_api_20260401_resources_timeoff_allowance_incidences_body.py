...
from ..models.post_api_20260401_resources_timeoff_allowance_incidences_body_target_balance import (
    PostApi20260401ResourcesTimeoffAllowanceIncidencesBodyTargetBalance,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesTimeoffAllowanceIncidencesBody")


@_attrs_define
class PostApi20260401ResourcesTimeoffAllowanceIncidencesBody:
    employee_id: int
    """ Employee Id """
    ...
    target_balance: PostApi20260401ResourcesTimeoffAllowanceIncidencesBodyTargetBalance
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_timeoff_allowance_incidences_body = cls(
            employee_id=employee_id,
            timeoff_allowance_id=timeoff_allowance_id,
            days_in_cents=days_in_cents,
            effective_on=effective_on,
        ...
        post_api_20260401_resources_timeoff_allowance_incidences_body.additional_properties = d
        return post_api_20260401_resources_timeoff_allowance_incidences_body
