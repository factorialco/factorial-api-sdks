...
T = TypeVar(
    "T", bound="PostApi20261001ResourcesShiftManagementShiftsBulkCreateBodyPlannedBreaksItem"
)


@_attrs_define
class PostApi20261001ResourcesShiftManagementShiftsBulkCreateBodyPlannedBreaksItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_shift_management_shifts_bulk_create_body_planned_breaks_item = (
            cls(
                break_configuration_id=break_configuration_id,
                id=id,
                start_at=start_at,
        ...
        post_api_20261001_resources_shift_management_shifts_bulk_create_body_planned_breaks_item.additional_properties = d
        return (
            post_api_20261001_resources_shift_management_shifts_bulk_create_body_planned_breaks_item
        )
