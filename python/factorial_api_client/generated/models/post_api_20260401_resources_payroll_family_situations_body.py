...
from ..models.post_api_20260401_resources_payroll_family_situations_body_civil_status import (
    PostApi20260401ResourcesPayrollFamilySituationsBodyCivilStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesPayrollFamilySituationsBody")


@_attrs_define
class PostApi20260401ResourcesPayrollFamilySituationsBody:
    employee_id: int
    """ Employee id. """
    civil_status: PostApi20260401ResourcesPayrollFamilySituationsBodyCivilStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        civil_status: PostApi20260401ResourcesPayrollFamilySituationsBodyCivilStatus | Unset
        if isinstance(_civil_status, Unset):
            civil_status = UNSET
        else:
            civil_status = PostApi20260401ResourcesPayrollFamilySituationsBodyCivilStatus(
                _civil_status
            ) if _civil_status is not None else None

        number_of_dependants = d.pop("number_of_dependants", UNSET)

        post_api_20260401_resources_payroll_family_situations_body = cls(
            employee_id=employee_id,
            civil_status=civil_status,
            number_of_dependants=number_of_dependants,
        )

        post_api_20260401_resources_payroll_family_situations_body.additional_properties = d
        return post_api_20260401_resources_payroll_family_situations_body
