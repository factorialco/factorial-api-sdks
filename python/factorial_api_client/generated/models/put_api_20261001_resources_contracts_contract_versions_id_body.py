...
from ..models.put_api_20261001_resources_contracts_contract_versions_id_body_annual_working_time_distribution import (
    PutApi20261001ResourcesContractsContractVersionsIdBodyAnnualWorkingTimeDistribution,
)
from ..models.put_api_20261001_resources_contracts_contract_versions_id_body_bank_holiday_treatment import (
    PutApi20261001ResourcesContractsContractVersionsIdBodyBankHolidayTreatment,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.put_api_20261001_resources_contracts_contract_versions_id_body_country_data_inputs_item import (
        PutApi20261001ResourcesContractsContractVersionsIdBodyCountryDataInputsItem,
    )


T = TypeVar("T", bound="PutApi20261001ResourcesContractsContractVersionsIdBody")


@_attrs_define
class PutApi20261001ResourcesContractsContractVersionsIdBody:
    id: str
    ...
    bank_holiday_treatment: (
        PutApi20261001ResourcesContractsContractVersionsIdBodyBankHolidayTreatment | Unset
    ) = UNSET
    ...
    annual_working_time_distribution: (
        PutApi20261001ResourcesContractsContractVersionsIdBodyAnnualWorkingTimeDistribution | Unset
    ) = UNSET
    ...
    endpoint. """
    country_data_inputs: (
        list[PutApi20261001ResourcesContractsContractVersionsIdBodyCountryDataInputsItem] | Unset
    ) = UNSET
    """ List of country-specific field inputs (e.g. contract_type). Each entry sets one templated field. Discover
    valid field_name/value_id combinations per country and legal entity via GET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        country_data_inputs: (
            list[PutApi20261001ResourcesContractsContractVersionsIdBodyCountryDataInputsItem]
            | Unset
        ) = UNSET
        if _country_data_inputs is not UNSET:
            country_data_inputs = []
            for country_data_inputs_item_data in _country_data_inputs:
                country_data_inputs_item = PutApi20261001ResourcesContractsContractVersionsIdBodyCountryDataInputsItem.from_dict(
                    country_data_inputs_item_data
                )

                country_data_inputs.append(country_data_inputs_item)

        put_api_20261001_resources_contracts_contract_versions_id_body = cls(
            id=id,
        ...
        put_api_20261001_resources_contracts_contract_versions_id_body.additional_properties = d
        return put_api_20261001_resources_contracts_contract_versions_id_body
