...
T = TypeVar("T", bound="PostApi20260701ResourcesPostsPostsBody")


@_attrs_define
class PostApi20260701ResourcesPostsPostsBody:
    title: str
    """ title of the post """
    description: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_posts_posts_body = cls(
            title=title,
            description=description,
            post_group_id=post_group_id,
        ...
        post_api_20260701_resources_posts_posts_body.additional_properties = d
        return post_api_20260701_resources_posts_posts_body
