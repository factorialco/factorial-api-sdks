...
from ..models.put_api_20260401_resources_timeoff_allowance_incidences_id_body_target_balance import (
    PutApi20260401ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesTimeoffAllowanceIncidencesIdBody")


@_attrs_define
class PutApi20260401ResourcesTimeoffAllowanceIncidencesIdBody:
    id: int
    ...
    target_balance: PutApi20260401ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_timeoff_allowance_incidences_id_body.additional_properties = d
        return put_api_20260401_resources_timeoff_allowance_incidences_id_body
