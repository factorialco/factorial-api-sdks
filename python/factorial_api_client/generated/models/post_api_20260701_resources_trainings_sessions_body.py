...
from ..models.post_api_20260701_resources_trainings_sessions_body_modality import (
    PostApi20260701ResourcesTrainingsSessionsBodyModality,
)
from ..models.post_api_20260701_resources_trainings_sessions_body_schedule import (
    PostApi20260701ResourcesTrainingsSessionsBodySchedule,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesTrainingsSessionsBody")


@_attrs_define
class PostApi20260701ResourcesTrainingsSessionsBody:
    name: str
    """ Session name """
    training_id: str
    ...
    modality: PostApi20260701ResourcesTrainingsSessionsBodyModality | Unset = UNSET
    """ Online, In person or mixed """
    schedule: PostApi20260701ResourcesTrainingsSessionsBodySchedule | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modality: PostApi20260701ResourcesTrainingsSessionsBodyModality | Unset
        if isinstance(_modality, Unset):
            modality = UNSET
        else:
            modality = PostApi20260701ResourcesTrainingsSessionsBodyModality(_modality) if _modality is not None else None

        _schedule = d.pop("schedule", UNSET)
        schedule: PostApi20260701ResourcesTrainingsSessionsBodySchedule | Unset
        if isinstance(_schedule, Unset):
            schedule = UNSET
        else:
            schedule = PostApi20260701ResourcesTrainingsSessionsBodySchedule(_schedule) if _schedule is not None else None
        ...
        post_api_20260701_resources_trainings_sessions_body = cls(
            name=name,
            training_id=training_id,
        ...
        post_api_20260701_resources_trainings_sessions_body.additional_properties = d
        return post_api_20260701_resources_trainings_sessions_body
