...
T = TypeVar("T", bound="PutApi20261001ResourcesFinanceContactsIdBodyAddress")


@_attrs_define
class PutApi20261001ResourcesFinanceContactsIdBodyAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_finance_contacts_id_body_address = cls(
            line1=line1,
            city=city,
            postal_code=postal_code,
            state=state,
        ...
        put_api_20261001_resources_finance_contacts_id_body_address.additional_properties = d
        return put_api_20261001_resources_finance_contacts_id_body_address
