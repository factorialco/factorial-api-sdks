...
T = TypeVar("T", bound="PostApi20260701ResourcesTimePlanningPlanningVersionsBulkCreateBody")


@_attrs_define
class PostApi20260701ResourcesTimePlanningPlanningVersionsBulkCreateBody:
    effective_at: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_time_planning_planning_versions_bulk_create_body = cls(
            effective_at=effective_at,
            planning_tool=planning_tool,
            employee_ids=employee_ids,
        ...
        post_api_20260701_resources_time_planning_planning_versions_bulk_create_body.additional_properties = d
        return post_api_20260701_resources_time_planning_planning_versions_bulk_create_body
