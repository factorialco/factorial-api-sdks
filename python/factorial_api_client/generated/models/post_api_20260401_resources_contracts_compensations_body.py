...
from ..models.post_api_20260401_resources_contracts_compensations_body_time_condition import (
    PostApi20260401ResourcesContractsCompensationsBodyTimeCondition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesContractsCompensationsBody")


@_attrs_define
class PostApi20260401ResourcesContractsCompensationsBody:
    ...
    time_condition: PostApi20260401ResourcesContractsCompensationsBodyTimeCondition | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_condition: PostApi20260401ResourcesContractsCompensationsBodyTimeCondition | Unset
        if isinstance(_time_condition, Unset):
            time_condition = UNSET
        else:
            time_condition = PostApi20260401ResourcesContractsCompensationsBodyTimeCondition(
                _time_condition
            )
        ...
        post_api_20260401_resources_contracts_compensations_body = cls(
            contract_version_id=contract_version_id,
            contracts_taxonomy_id=contracts_taxonomy_id,
        ...
        post_api_20260401_resources_contracts_compensations_body.additional_properties = d
        return post_api_20260401_resources_contracts_compensations_body
