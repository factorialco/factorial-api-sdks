...
from ..models.post_api_20251001_resources_attendance_edit_timesheet_requests_body_location_type import (
    PostApi20251001ResourcesAttendanceEditTimesheetRequestsBodyLocationType,
)
from ..models.post_api_20251001_resources_attendance_edit_timesheet_requests_body_request_type import (
    PostApi20251001ResourcesAttendanceEditTimesheetRequestsBodyRequestType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesAttendanceEditTimesheetRequestsBody")


@_attrs_define
class PostApi20251001ResourcesAttendanceEditTimesheetRequestsBody:
    employee_id: int
    request_type: PostApi20251001ResourcesAttendanceEditTimesheetRequestsBodyRequestType
    ...
    location_type: (
        PostApi20251001ResourcesAttendanceEditTimesheetRequestsBodyLocationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_location_type, Unset):
            ...
            location_type = PostApi20251001ResourcesAttendanceEditTimesheetRequestsBodyLocationType(
                _location_type
            )

        observations = d.pop("observations", UNSET)

        post_api_20251001_resources_attendance_edit_timesheet_requests_body = cls(
            employee_id=employee_id,
            request_type=request_type,
            reason=reason,
            date=date,
        ...
        post_api_20251001_resources_attendance_edit_timesheet_requests_body.additional_properties = d
        return post_api_20251001_resources_attendance_edit_timesheet_requests_body
