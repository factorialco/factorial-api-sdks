...
T = TypeVar("T", bound="PostApi20260701ResourcesProjectManagementPlannedRecordsBulkCreateBody")


@_attrs_define
class PostApi20260701ResourcesProjectManagementPlannedRecordsBulkCreateBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_project_management_planned_records_bulk_create_body = cls(
            project_worker_ids=project_worker_ids,
            start_date=start_date,
            end_date=end_date,
            daily_minutes=daily_minutes,
        ...
        post_api_20260701_resources_project_management_planned_records_bulk_create_body.additional_properties = d
        return post_api_20260701_resources_project_management_planned_records_bulk_create_body
