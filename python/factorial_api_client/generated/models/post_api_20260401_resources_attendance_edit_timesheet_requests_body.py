...
from ..models.post_api_20260401_resources_attendance_edit_timesheet_requests_body_location_type import (
    PostApi20260401ResourcesAttendanceEditTimesheetRequestsBodyLocationType,
)
from ..models.post_api_20260401_resources_attendance_edit_timesheet_requests_body_request_type import (
    PostApi20260401ResourcesAttendanceEditTimesheetRequestsBodyRequestType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesAttendanceEditTimesheetRequestsBody")


@_attrs_define
class PostApi20260401ResourcesAttendanceEditTimesheetRequestsBody:
    employee_id: int
    request_type: PostApi20260401ResourcesAttendanceEditTimesheetRequestsBodyRequestType
    ...
    location_type: (
        PostApi20260401ResourcesAttendanceEditTimesheetRequestsBodyLocationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_attendance_edit_timesheet_requests_body = cls(
            employee_id=employee_id,
            request_type=request_type,
            reason=reason,
            date=date,
        ...
        post_api_20260401_resources_attendance_edit_timesheet_requests_body.additional_properties = d
        return post_api_20260401_resources_attendance_edit_timesheet_requests_body
