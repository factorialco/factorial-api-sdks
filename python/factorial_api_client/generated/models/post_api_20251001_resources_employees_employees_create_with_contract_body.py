...
from ..models.post_api_20251001_resources_employees_employees_create_with_contract_body_contracts_annual_working_time_distribution import (
    PostApi20251001ResourcesEmployeesEmployeesCreateWithContractBodyContractsAnnualWorkingTimeDistribution,
)
from ..models.post_api_20251001_resources_employees_employees_create_with_contract_body_contracts_bank_holiday_treatment import (
    PostApi20251001ResourcesEmployeesEmployeesCreateWithContractBodyContractsBankHolidayTreatment,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesEmployeesEmployeesCreateWithContractBody")


@_attrs_define
class PostApi20251001ResourcesEmployeesEmployeesCreateWithContractBody:
    company_id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_contracts_bank_holiday_treatment, Unset):
            ...
            contracts_bank_holiday_treatment = PostApi20251001ResourcesEmployeesEmployeesCreateWithContractBodyContractsBankHolidayTreatment(
        ...
        if isinstance(_contracts_annual_working_time_distribution, Unset):
            ...
            contracts_annual_working_time_distribution = PostApi20251001ResourcesEmployeesEmployeesCreateWithContractBodyContractsAnnualWorkingTimeDistribution(
        ...
        post_api_20251001_resources_employees_employees_create_with_contract_body = cls(
            company_id=company_id,
            first_name=first_name,
            last_name=last_name,
            email=email,
        ...
        post_api_20251001_resources_employees_employees_create_with_contract_body.additional_properties = d
        return post_api_20251001_resources_employees_employees_create_with_contract_body
