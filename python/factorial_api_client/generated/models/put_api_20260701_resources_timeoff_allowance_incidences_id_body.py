...
from ..models.put_api_20260701_resources_timeoff_allowance_incidences_id_body_target_balance import (
    PutApi20260701ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260701ResourcesTimeoffAllowanceIncidencesIdBody")


@_attrs_define
class PutApi20260701ResourcesTimeoffAllowanceIncidencesIdBody:
    id: str
    ...
    target_balance: PutApi20260701ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_target_balance, Unset):
            ...
            target_balance = PutApi20260701ResourcesTimeoffAllowanceIncidencesIdBodyTargetBalance(
                _target_balance
            ) if _target_balance is not None else None

        put_api_20260701_resources_timeoff_allowance_incidences_id_body = cls(
            id=id,
        ...
        put_api_20260701_resources_timeoff_allowance_incidences_id_body.additional_properties = d
        return put_api_20260701_resources_timeoff_allowance_incidences_id_body
