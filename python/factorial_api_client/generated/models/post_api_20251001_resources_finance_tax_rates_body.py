...
T = TypeVar("T", bound="PostApi20251001ResourcesFinanceTaxRatesBody")


@_attrs_define
class PostApi20251001ResourcesFinanceTaxRatesBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_finance_tax_rates_body = cls(
        ...
        post_api_20251001_resources_finance_tax_rates_body.additional_properties = d
        return post_api_20251001_resources_finance_tax_rates_body
