...
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_available_days import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyAvailableDays,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_days_type import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyDaysType,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_frequency import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyFrequency,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_negative_counter_type import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyNegativeCounterType,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_proration_type import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyProrationType,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_range_type import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyRangeType,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_rounding import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyRounding,
)
from ..models.put_api_20251001_resources_timeoff_allowances_id_body_tenure_period_transition import (
    PutApi20251001ResourcesTimeoffAllowancesIdBodyTenurePeriodTransition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20251001ResourcesTimeoffAllowancesIdBody")


@_attrs_define
class PutApi20251001ResourcesTimeoffAllowancesIdBody:
    id: int
    ...
    """
    available_days: PutApi20251001ResourcesTimeoffAllowancesIdBodyAvailableDays | Unset = UNSET
    ...
    days_type: PutApi20251001ResourcesTimeoffAllowancesIdBodyDaysType | Unset = UNSET
    ...
    frequency: PutApi20251001ResourcesTimeoffAllowancesIdBodyFrequency | Unset = UNSET
    ...
    leave_type_ids: list[int] | Unset = UNSET
    ...
    negative_counter_type: (
        PutApi20251001ResourcesTimeoffAllowancesIdBodyNegativeCounterType | Unset
    ) = UNSET
    ...
    proration_type: PutApi20251001ResourcesTimeoffAllowancesIdBodyProrationType | Unset = UNSET
    ...
    range_type: PutApi20251001ResourcesTimeoffAllowancesIdBodyRangeType | Unset = UNSET
    """ Configures how leaves duration is handled. """
    rounding: PutApi20251001ResourcesTimeoffAllowancesIdBodyRounding | Unset = UNSET
    ...
    tenure_period_transition: (
        PutApi20251001ResourcesTimeoffAllowancesIdBodyTenurePeriodTransition | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        available_days: PutApi20251001ResourcesTimeoffAllowancesIdBodyAvailableDays | Unset
        if isinstance(_available_days, Unset):
            available_days = UNSET
        else:
            available_days = PutApi20251001ResourcesTimeoffAllowancesIdBodyAvailableDays(
                _available_days
            )
        ...
        days_type: PutApi20251001ResourcesTimeoffAllowancesIdBodyDaysType | Unset
        if isinstance(_days_type, Unset):
            days_type = UNSET
        else:
            days_type = PutApi20251001ResourcesTimeoffAllowancesIdBodyDaysType(_days_type) if _days_type is not None else None

        expire_in_months = d.pop("expire_in_months", UNSET)

        _frequency = d.pop("frequency", UNSET)
        frequency: PutApi20251001ResourcesTimeoffAllowancesIdBodyFrequency | Unset
        if isinstance(_frequency, Unset):
            frequency = UNSET
        else:
            frequency = PutApi20251001ResourcesTimeoffAllowancesIdBodyFrequency(_frequency) if _frequency is not None else None

        holiday_allowance_in_cents = d.pop("holiday_allowance_in_cents", UNSET)

        leave_type_ids = cast(list[int], d.pop("leave_type_ids", UNSET))
        ...
        proration_type: PutApi20251001ResourcesTimeoffAllowancesIdBodyProrationType | Unset
        if isinstance(_proration_type, Unset):
            proration_type = UNSET
        else:
            proration_type = PutApi20251001ResourcesTimeoffAllowancesIdBodyProrationType(
                _proration_type
            )
        ...
        range_type: PutApi20251001ResourcesTimeoffAllowancesIdBodyRangeType | Unset
        if isinstance(_range_type, Unset):
            range_type = UNSET
        else:
            range_type = PutApi20251001ResourcesTimeoffAllowancesIdBodyRangeType(_range_type) if _range_type is not None else None

        _rounding = d.pop("rounding", UNSET)
        rounding: PutApi20251001ResourcesTimeoffAllowancesIdBodyRounding | Unset
        if isinstance(_rounding, Unset):
            rounding = UNSET
        else:
            rounding = PutApi20251001ResourcesTimeoffAllowancesIdBodyRounding(_rounding) if _rounding is not None else None
        ...
        put_api_20251001_resources_timeoff_allowances_id_body = cls(
            id=id,
        ...
        put_api_20251001_resources_timeoff_allowances_id_body.additional_properties = d
        return put_api_20251001_resources_timeoff_allowances_id_body
