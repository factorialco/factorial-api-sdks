...
T = TypeVar(
    "T",
    bound="PerformanceReviewQuestionnairesByStrategyManagerQuestionnaireContentItemQuestionsItemMetadata",
)


@_attrs_define
class PerformanceReviewQuestionnairesByStrategyManagerQuestionnaireContentItemQuestionsItemMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_review_questionnaires_by_strategy_manager_questionnaire_content_item_questions_item_metadata = cls(
        ...
        performance_review_questionnaires_by_strategy_manager_questionnaire_content_item_questions_item_metadata.additional_properties = d
        return performance_review_questionnaires_by_strategy_manager_questionnaire_content_item_questions_item_metadata
