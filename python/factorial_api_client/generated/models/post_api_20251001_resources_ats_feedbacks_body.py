...
T = TypeVar("T", bound="PostApi20251001ResourcesAtsFeedbacksBody")


@_attrs_define
class PostApi20251001ResourcesAtsFeedbacksBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_ats_feedbacks_body = cls(
            ats_candidate_id=ats_candidate_id,
            rating=rating,
        ...
        post_api_20251001_resources_ats_feedbacks_body.additional_properties = d
        return post_api_20251001_resources_ats_feedbacks_body
