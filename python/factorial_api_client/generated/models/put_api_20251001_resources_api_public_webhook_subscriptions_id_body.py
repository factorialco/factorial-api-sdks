...
from ..models.put_api_20251001_resources_api_public_webhook_subscriptions_id_body_api_version import (
    PutApi20251001ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20251001ResourcesApiPublicWebhookSubscriptionsIdBody")


@_attrs_define
class PutApi20251001ResourcesApiPublicWebhookSubscriptionsIdBody:
    id: int
    ...
    api_version: PutApi20251001ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_api_version, Unset):
            ...
            api_version = PutApi20251001ResourcesApiPublicWebhookSubscriptionsIdBodyApiVersion(
                _api_version
            )

        put_api_20251001_resources_api_public_webhook_subscriptions_id_body = cls(
            id=id,
        ...
        put_api_20251001_resources_api_public_webhook_subscriptions_id_body.additional_properties = d
        return put_api_20251001_resources_api_public_webhook_subscriptions_id_body
