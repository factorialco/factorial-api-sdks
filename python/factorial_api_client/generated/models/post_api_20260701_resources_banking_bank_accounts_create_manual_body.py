...
from ..models.post_api_20260701_resources_banking_bank_accounts_create_manual_body_account_number_type import (
    PostApi20260701ResourcesBankingBankAccountsCreateManualBodyAccountNumberType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesBankingBankAccountsCreateManualBody")


@_attrs_define
class PostApi20260701ResourcesBankingBankAccountsCreateManualBody:
    legal_entity_id: str
    ...
    bank_account_membership_employee_ids: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_account_membership_employee_ids = cast(
            list[str], d.pop("bank_account_membership_employee_ids", UNSET)
        )

        external_id = d.pop("external_id", UNSET)

        post_api_20260701_resources_banking_bank_accounts_create_manual_body = cls(
            legal_entity_id=legal_entity_id,
            currency=currency,
            account_number=account_number,
            account_number_type=account_number_type,
        ...
        post_api_20260701_resources_banking_bank_accounts_create_manual_body.additional_properties = d
        return post_api_20260701_resources_banking_bank_accounts_create_manual_body
