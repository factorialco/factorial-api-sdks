...
from ..models.post_api_20251001_resources_timeoff_allowances_body_accrued_units_availability import (
    PostApi20251001ResourcesTimeoffAllowancesBodyAccruedUnitsAvailability,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_allowance_type import (
    PostApi20251001ResourcesTimeoffAllowancesBodyAllowanceType,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_available_days import (
    PostApi20251001ResourcesTimeoffAllowancesBodyAvailableDays,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_cycle_start import (
    PostApi20251001ResourcesTimeoffAllowancesBodyCycleStart,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_days_type import (
    PostApi20251001ResourcesTimeoffAllowancesBodyDaysType,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_frequency import (
    PostApi20251001ResourcesTimeoffAllowancesBodyFrequency,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_negative_counter_type import (
    PostApi20251001ResourcesTimeoffAllowancesBodyNegativeCounterType,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_proration_type import (
    PostApi20251001ResourcesTimeoffAllowancesBodyProrationType,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_range_type import (
    PostApi20251001ResourcesTimeoffAllowancesBodyRangeType,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_rounding import (
    PostApi20251001ResourcesTimeoffAllowancesBodyRounding,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_source_units import (
    PostApi20251001ResourcesTimeoffAllowancesBodySourceUnits,
)
from ..models.post_api_20251001_resources_timeoff_allowances_body_tenure_period_transition import (
    PostApi20251001ResourcesTimeoffAllowancesBodyTenurePeriodTransition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesTimeoffAllowancesBody")


@_attrs_define
class PostApi20251001ResourcesTimeoffAllowancesBody:
    accrued_units_availability: (
        PostApi20251001ResourcesTimeoffAllowancesBodyAccruedUnitsAvailability
    )
    """ When can the accrued units be spent. """
    allowance_type: PostApi20251001ResourcesTimeoffAllowancesBodyAllowanceType
    """ Sets the allowance units. Can be "days" or "hours" """
    available_days: PostApi20251001ResourcesTimeoffAllowancesBodyAvailableDays
    ...
    cycle_start: PostApi20251001ResourcesTimeoffAllowancesBodyCycleStart
    """ When does the cycle start. """
    days_type: PostApi20251001ResourcesTimeoffAllowancesBodyDaysType
    ...
    negative_counter_type: PostApi20251001ResourcesTimeoffAllowancesBodyNegativeCounterType
    """ Whether the allowance allows to request more days than available. """
    proration_type: PostApi20251001ResourcesTimeoffAllowancesBodyProrationType
    ...
    rounding: PostApi20251001ResourcesTimeoffAllowancesBodyRounding
    """ How the accrued units of the allowance are rounded. It depends if the allowance is set in hours or days. """
    source_units: PostApi20251001ResourcesTimeoffAllowancesBodySourceUnits
    ...
    frequency: PostApi20251001ResourcesTimeoffAllowancesBodyFrequency | Unset = UNSET
    ...
    range_type: PostApi20251001ResourcesTimeoffAllowancesBodyRangeType | Unset = UNSET
    """ Configures how leaves duration is handled. """
    tenure_period_transition: (
        PostApi20251001ResourcesTimeoffAllowancesBodyTenurePeriodTransition | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cycle_start = PostApi20251001ResourcesTimeoffAllowancesBodyCycleStart(d.pop("cycle_start"))

        days_type = PostApi20251001ResourcesTimeoffAllowancesBodyDaysType(d.pop("days_type"))
        ...
        rounding = PostApi20251001ResourcesTimeoffAllowancesBodyRounding(d.pop("rounding"))
        ...
        frequency: PostApi20251001ResourcesTimeoffAllowancesBodyFrequency | Unset
        if isinstance(_frequency, Unset):
            frequency = UNSET
        else:
            frequency = PostApi20251001ResourcesTimeoffAllowancesBodyFrequency(_frequency) if _frequency is not None else None
        ...
        range_type: PostApi20251001ResourcesTimeoffAllowancesBodyRangeType | Unset
        if isinstance(_range_type, Unset):
            range_type = UNSET
        else:
            range_type = PostApi20251001ResourcesTimeoffAllowancesBodyRangeType(_range_type) if _range_type is not None else None
        ...
        post_api_20251001_resources_timeoff_allowances_body = cls(
            accrued_units_availability=accrued_units_availability,
            allowance_type=allowance_type,
            available_days=available_days,
            count_holiday_as_workable=count_holiday_as_workable,
        ...
        post_api_20251001_resources_timeoff_allowances_body.additional_properties = d
        return post_api_20251001_resources_timeoff_allowances_body
