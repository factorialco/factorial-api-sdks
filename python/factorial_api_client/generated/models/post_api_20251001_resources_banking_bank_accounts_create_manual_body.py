...
from ..models.post_api_20251001_resources_banking_bank_accounts_create_manual_body_account_number_type import (
    PostApi20251001ResourcesBankingBankAccountsCreateManualBodyAccountNumberType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesBankingBankAccountsCreateManualBody")


@_attrs_define
class PostApi20251001ResourcesBankingBankAccountsCreateManualBody:
    legal_entity_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_banking_bank_accounts_create_manual_body = cls(
            legal_entity_id=legal_entity_id,
            currency=currency,
            account_number=account_number,
            account_number_type=account_number_type,
        ...
        post_api_20251001_resources_banking_bank_accounts_create_manual_body.additional_properties = d
        return post_api_20251001_resources_banking_bank_accounts_create_manual_body
