...
T = TypeVar("T", bound="PostApi20260401ResourcesAttendanceShiftsClockOutBody")


@_attrs_define
class PostApi20260401ResourcesAttendanceShiftsClockOutBody:
    now: str
    """ Clock out time """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_attendance_shifts_clock_out_body = cls(
            now=now,
        ...
        post_api_20260401_resources_attendance_shifts_clock_out_body.additional_properties = d
        return post_api_20260401_resources_attendance_shifts_clock_out_body
