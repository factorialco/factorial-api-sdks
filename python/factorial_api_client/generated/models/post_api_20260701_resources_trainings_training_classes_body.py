...
from ..models.post_api_20260701_resources_trainings_training_classes_body_payment_status import (
    PostApi20260701ResourcesTrainingsTrainingClassesBodyPaymentStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesTrainingsTrainingClassesBody")


@_attrs_define
class PostApi20260701ResourcesTrainingsTrainingClassesBody:
    start_date: str
    ...
    payment_status: PostApi20260701ResourcesTrainingsTrainingClassesBodyPaymentStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_trainings_training_classes_body = cls(
            start_date=start_date,
            end_date=end_date,
            training_id=training_id,
            company_id=company_id,
        ...
        post_api_20260701_resources_trainings_training_classes_body.additional_properties = d
        return post_api_20260701_resources_trainings_training_classes_body
