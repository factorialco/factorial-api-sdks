...
from ..models.post_api_20260701_resources_attendance_shifts_toggle_clock_body_location_type import (
    PostApi20260701ResourcesAttendanceShiftsToggleClockBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesAttendanceShiftsToggleClockBody")


@_attrs_define
class PostApi20260701ResourcesAttendanceShiftsToggleClockBody:
    employee_id: str
    """ Employee identifier """
    clock_time: str
    """ Clock in or out Timestamp """
    location_type: PostApi20260701ResourcesAttendanceShiftsToggleClockBodyLocationType | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_location_type, Unset):
            ...
            location_type = PostApi20260701ResourcesAttendanceShiftsToggleClockBodyLocationType(
                _location_type
        ...
        post_api_20260701_resources_attendance_shifts_toggle_clock_body = cls(
            employee_id=employee_id,
            clock_time=clock_time,
        ...
        post_api_20260701_resources_attendance_shifts_toggle_clock_body.additional_properties = d
        return post_api_20260701_resources_attendance_shifts_toggle_clock_body
