...
from ..models.post_api_20261001_resources_attendance_shifts_clock_in_body_location_type import (
    PostApi20261001ResourcesAttendanceShiftsClockInBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesAttendanceShiftsClockInBody")


@_attrs_define
class PostApi20261001ResourcesAttendanceShiftsClockInBody:
    now: str
    """ Clock in time """
    ...
    location_type: PostApi20261001ResourcesAttendanceShiftsClockInBodyLocationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PostApi20261001ResourcesAttendanceShiftsClockInBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PostApi20261001ResourcesAttendanceShiftsClockInBodyLocationType(
                _location_type
        ...
        post_api_20261001_resources_attendance_shifts_clock_in_body = cls(
            now=now,
        ...
        post_api_20261001_resources_attendance_shifts_clock_in_body.additional_properties = d
        return post_api_20261001_resources_attendance_shifts_clock_in_body
