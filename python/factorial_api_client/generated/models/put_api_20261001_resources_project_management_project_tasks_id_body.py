...
from .. import types
from ..models.put_api_20261001_resources_project_management_project_tasks_id_body_status import (
    PutApi20261001ResourcesProjectManagementProjectTasksIdBodyStatus,
)
from ..types import UNSET, File, FileTypes, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesProjectManagementProjectTasksIdBody")


@_attrs_define
class PutApi20261001ResourcesProjectManagementProjectTasksIdBody:
    id: str
    ...
    status: PutApi20261001ResourcesProjectManagementProjectTasksIdBodyStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: PutApi20261001ResourcesProjectManagementProjectTasksIdBodyStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PutApi20261001ResourcesProjectManagementProjectTasksIdBodyStatus(_status) if _status is not None else None

        put_api_20261001_resources_project_management_project_tasks_id_body = cls(
            id=id,
            name=name,
            project_id=project_id,
            content=content,
        ...
        put_api_20261001_resources_project_management_project_tasks_id_body.additional_properties = d
        return put_api_20261001_resources_project_management_project_tasks_id_body
