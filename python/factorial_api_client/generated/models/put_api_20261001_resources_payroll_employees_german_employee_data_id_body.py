...
T = TypeVar("T", bound="PutApi20261001ResourcesPayrollEmployeesGermanEmployeeDataIdBody")


@_attrs_define
class PutApi20261001ResourcesPayrollEmployeesGermanEmployeeDataIdBody:
    id: str
    ...
    place_of_birth: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_payroll_employees_german_employee_data_id_body = cls(
            id=id,
        ...
        put_api_20261001_resources_payroll_employees_german_employee_data_id_body.additional_properties = d
        return put_api_20261001_resources_payroll_employees_german_employee_data_id_body
