...
T = TypeVar("T", bound="PostApi20260401ResourcesProjectManagementProjectWorkersBulkAssignBody")


@_attrs_define
class PostApi20260401ResourcesProjectManagementProjectWorkersBulkAssignBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_project_management_project_workers_bulk_assign_body = cls(
            employee_ids=employee_ids,
            project_id=project_id,
            project_ids=project_ids,
        )

        post_api_20260401_resources_project_management_project_workers_bulk_assign_body.additional_properties = d
        return post_api_20260401_resources_project_management_project_workers_bulk_assign_body
