...
T = TypeVar("T", bound="AtsQuestionOptionsItem")


@_attrs_define
class AtsQuestionOptionsItem:
    text: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ats_question_options_item = cls(
            text=text,
            disqualifies=disqualifies,
        )

        ats_question_options_item.additional_properties = d
        return ats_question_options_item
