...
if TYPE_CHECKING:
    from ..models.post_api_20261001_resources_trainings_trainings_body_attachments_item import (
        PostApi20261001ResourcesTrainingsTrainingsBodyAttachmentsItem,
    )


T = TypeVar("T", bound="PostApi20261001ResourcesTrainingsTrainingsBody")


@_attrs_define
class PostApi20261001ResourcesTrainingsTrainingsBody:
    name: str
    ...
    attachments: list[PostApi20261001ResourcesTrainingsTrainingsBodyAttachmentsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for attachments_item_data in _attachments:
            attachments_item = (
                PostApi20261001ResourcesTrainingsTrainingsBodyAttachmentsItem.from_dict(
        ...
        post_api_20261001_resources_trainings_trainings_body = cls(
            name=name,
            description=description,
            external=external,
            year=year,
        ...
        post_api_20261001_resources_trainings_trainings_body.additional_properties = d
        return post_api_20261001_resources_trainings_trainings_body
