...
from ..models.post_api_20261001_resources_ats_job_postings_body_category import (
    PostApi20261001ResourcesAtsJobPostingsBodyCategory,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_contract_type import (
    PostApi20261001ResourcesAtsJobPostingsBodyContractType,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_cover_letter_requirement import (
    PostApi20261001ResourcesAtsJobPostingsBodyCoverLetterRequirement,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_cv_requirement import (
    PostApi20261001ResourcesAtsJobPostingsBodyCvRequirement,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_personal_url_requirement import (
    PostApi20261001ResourcesAtsJobPostingsBodyPersonalUrlRequirement,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_phone_requirement import (
    PostApi20261001ResourcesAtsJobPostingsBodyPhoneRequirement,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_photo_requirement import (
    PostApi20261001ResourcesAtsJobPostingsBodyPhotoRequirement,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_salary_format import (
    PostApi20261001ResourcesAtsJobPostingsBodySalaryFormat,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_salary_period import (
    PostApi20261001ResourcesAtsJobPostingsBodySalaryPeriod,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_schedule_type import (
    PostApi20261001ResourcesAtsJobPostingsBodyScheduleType,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_status import (
    PostApi20261001ResourcesAtsJobPostingsBodyStatus,
)
from ..models.post_api_20261001_resources_ats_job_postings_body_workplace_type import (
    PostApi20261001ResourcesAtsJobPostingsBodyWorkplaceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesAtsJobPostingsBody")


@_attrs_define
class PostApi20261001ResourcesAtsJobPostingsBody:
    title: str
    status: PostApi20261001ResourcesAtsJobPostingsBodyStatus
    cv_requirement: PostApi20261001ResourcesAtsJobPostingsBodyCvRequirement
    cover_letter_requirement: PostApi20261001ResourcesAtsJobPostingsBodyCoverLetterRequirement
    phone_requirement: PostApi20261001ResourcesAtsJobPostingsBodyPhoneRequirement
    photo_requirement: PostApi20261001ResourcesAtsJobPostingsBodyPhotoRequirement
    personal_url_requirement: PostApi20261001ResourcesAtsJobPostingsBodyPersonalUrlRequirement
    description: str | Unset = UNSET
    contract_type: PostApi20261001ResourcesAtsJobPostingsBodyContractType | Unset = UNSET
    category: PostApi20261001ResourcesAtsJobPostingsBodyCategory | Unset = UNSET
    workplace_type: PostApi20261001ResourcesAtsJobPostingsBodyWorkplaceType | Unset = UNSET
    schedule_type: PostApi20261001ResourcesAtsJobPostingsBodyScheduleType | Unset = UNSET
    team_id: str | Unset = UNSET
    location_id: str | Unset = UNSET
    salary_format: PostApi20261001ResourcesAtsJobPostingsBodySalaryFormat | Unset = UNSET
    salary_from_amount_in_cents: int | Unset = UNSET
    salary_to_amount_in_cents: int | Unset = UNSET
    salary_period: PostApi20261001ResourcesAtsJobPostingsBodySalaryPeriod | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApi20261001ResourcesAtsJobPostingsBodyStatus(d.pop("status"))
        ...
        contract_type: PostApi20261001ResourcesAtsJobPostingsBodyContractType | Unset
        if isinstance(_contract_type, Unset):
            contract_type = UNSET
        else:
            contract_type = PostApi20261001ResourcesAtsJobPostingsBodyContractType(_contract_type) if _contract_type is not None else None

        _category = d.pop("category", UNSET)
        category: PostApi20261001ResourcesAtsJobPostingsBodyCategory | Unset
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = PostApi20261001ResourcesAtsJobPostingsBodyCategory(_category) if _category is not None else None

        _workplace_type = d.pop("workplace_type", UNSET)
        workplace_type: PostApi20261001ResourcesAtsJobPostingsBodyWorkplaceType | Unset
        if isinstance(_workplace_type, Unset):
            workplace_type = UNSET
        else:
            workplace_type = PostApi20261001ResourcesAtsJobPostingsBodyWorkplaceType(
                _workplace_type
            ) if _workplace_type is not None else None

        _schedule_type = d.pop("schedule_type", UNSET)
        schedule_type: PostApi20261001ResourcesAtsJobPostingsBodyScheduleType | Unset
        if isinstance(_schedule_type, Unset):
            schedule_type = UNSET
        else:
            schedule_type = PostApi20261001ResourcesAtsJobPostingsBodyScheduleType(_schedule_type) if _schedule_type is not None else None
        ...
        salary_format: PostApi20261001ResourcesAtsJobPostingsBodySalaryFormat | Unset
        if isinstance(_salary_format, Unset):
            salary_format = UNSET
        else:
            salary_format = PostApi20261001ResourcesAtsJobPostingsBodySalaryFormat(_salary_format) if _salary_format is not None else None
        ...
        salary_period: PostApi20261001ResourcesAtsJobPostingsBodySalaryPeriod | Unset
        if isinstance(_salary_period, Unset):
            salary_period = UNSET
        else:
            salary_period = PostApi20261001ResourcesAtsJobPostingsBodySalaryPeriod(_salary_period) if _salary_period is not None else None

        post_api_20261001_resources_ats_job_postings_body = cls(
            title=title,
            status=status,
            cv_requirement=cv_requirement,
            cover_letter_requirement=cover_letter_requirement,
        ...
        post_api_20261001_resources_ats_job_postings_body.additional_properties = d
        return post_api_20261001_resources_ats_job_postings_body
