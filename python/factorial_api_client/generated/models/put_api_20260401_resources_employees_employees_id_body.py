...
T = TypeVar("T", bound="PutApi20260401ResourcesEmployeesEmployeesIdBody")


@_attrs_define
class PutApi20260401ResourcesEmployeesEmployeesIdBody:
    id: int
    """ id of the employee. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_employees_employees_id_body = cls(
            id=id,
            access_id=access_id,
            gender=gender,
        ...
        put_api_20260401_resources_employees_employees_id_body.additional_properties = d
        return put_api_20260401_resources_employees_employees_id_body
