...
T = TypeVar("T", bound="PutApi20260401ResourcesLocationsLocationsIdBody")


@_attrs_define
class PutApi20260401ResourcesLocationsLocationsIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_locations_locations_id_body = cls(
            id=id,
            name=name,
            country=country,
            main=main,
        ...
        put_api_20260401_resources_locations_locations_id_body.additional_properties = d
        return put_api_20260401_resources_locations_locations_id_body
