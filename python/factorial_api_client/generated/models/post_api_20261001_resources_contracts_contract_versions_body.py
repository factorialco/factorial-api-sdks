...
from ..models.post_api_20261001_resources_contracts_contract_versions_body_annual_working_time_distribution import (
    PostApi20261001ResourcesContractsContractVersionsBodyAnnualWorkingTimeDistribution,
)
from ..models.post_api_20261001_resources_contracts_contract_versions_body_bank_holiday_treatment import (
    PostApi20261001ResourcesContractsContractVersionsBodyBankHolidayTreatment,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_20261001_resources_contracts_contract_versions_body_country_data_inputs_item import (
        PostApi20261001ResourcesContractsContractVersionsBodyCountryDataInputsItem,
    )


T = TypeVar("T", bound="PostApi20261001ResourcesContractsContractVersionsBody")


@_attrs_define
class PostApi20261001ResourcesContractsContractVersionsBody:
    employee_id: str
    ...
    annual_working_time_distribution: (
        PostApi20261001ResourcesContractsContractVersionsBodyAnnualWorkingTimeDistribution | Unset
    ) = UNSET
    ...
    bank_holiday_treatment: (
        PostApi20261001ResourcesContractsContractVersionsBodyBankHolidayTreatment | Unset
    ) = UNSET
    ...
    endpoint. """
    country_data_inputs: (
        list[PostApi20261001ResourcesContractsContractVersionsBodyCountryDataInputsItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _country_data_inputs is not UNSET:
            ...
            for country_data_inputs_item_data in _country_data_inputs:
                country_data_inputs_item = PostApi20261001ResourcesContractsContractVersionsBodyCountryDataInputsItem.from_dict(
                    country_data_inputs_item_data
                )

                country_data_inputs.append(country_data_inputs_item)

        post_api_20261001_resources_contracts_contract_versions_body = cls(
            employee_id=employee_id,
            effective_on=effective_on,
            starts_on=starts_on,
            ends_on=ends_on,
        ...
        post_api_20261001_resources_contracts_contract_versions_body.additional_properties = d
        return post_api_20261001_resources_contracts_contract_versions_body
