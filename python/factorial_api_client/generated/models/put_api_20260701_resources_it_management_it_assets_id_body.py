...
T = TypeVar("T", bound="PutApi20260701ResourcesItManagementItAssetsIdBody")


@_attrs_define
class PutApi20260701ResourcesItManagementItAssetsIdBody:
    id: str
    """ IT Asset identifier """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_it_management_it_assets_id_body = cls(
            id=id,
        ...
        put_api_20260701_resources_it_management_it_assets_id_body.additional_properties = d
        return put_api_20260701_resources_it_management_it_assets_id_body
