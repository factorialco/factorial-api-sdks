...
T = TypeVar("T", bound="PostApi20261001ResourcesItManagementItAssetModelsBody")


@_attrs_define
class PostApi20261001ResourcesItManagementItAssetModelsBody:
    brand: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_it_management_it_asset_models_body = cls(
            brand=brand,
            name=name,
            type_name=type_name,
        ...
        post_api_20261001_resources_it_management_it_asset_models_body.additional_properties = d
        return post_api_20261001_resources_it_management_it_asset_models_body
