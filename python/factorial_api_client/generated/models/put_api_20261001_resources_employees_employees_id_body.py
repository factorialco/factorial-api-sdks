...
from ..models.put_api_20261001_resources_employees_employees_id_body_bank_number_format import (
...
class PutApi20261001ResourcesEmployeesEmployeesIdBody:
    ...
    bank_number_format: PutApi20261001ResourcesEmployeesEmployeesIdBodyBankNumberFormat | Unset = (
        UNSET
    )
    """ format of bank_number. Required when bank_number is set. """
    swift_bic: str | Unset = UNSET
    """ SWIFT/BIC for iban, the sort code for sort_code_and_account_number, the routing number for
    routing_number_and_account_number, the bank name for bank_name_and_account_number. Required for those three
    formats. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_bank_number_format, Unset):
            ...
            bank_number_format = PutApi20261001ResourcesEmployeesEmployeesIdBodyBankNumberFormat(
                _bank_number_format
            ) if _bank_number_format is not None else None
