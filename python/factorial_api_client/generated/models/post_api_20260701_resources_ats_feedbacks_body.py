...
T = TypeVar("T", bound="PostApi20260701ResourcesAtsFeedbacksBody")


@_attrs_define
class PostApi20260701ResourcesAtsFeedbacksBody:
    ...
    mention_ids: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mention_ids = cast(list[str], d.pop("mention_ids", UNSET))

        ats_evaluation_forms_id = d.pop("ats_evaluation_forms_id", UNSET)

        post_api_20260701_resources_ats_feedbacks_body = cls(
            ats_candidate_id=ats_candidate_id,
            rating=rating,
        ...
        post_api_20260701_resources_ats_feedbacks_body.additional_properties = d
        return post_api_20260701_resources_ats_feedbacks_body
