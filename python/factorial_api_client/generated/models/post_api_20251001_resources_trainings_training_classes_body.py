...
T = TypeVar("T", bound="PostApi20251001ResourcesTrainingsTrainingClassesBody")


@_attrs_define
class PostApi20251001ResourcesTrainingsTrainingClassesBody:
    start_date: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_trainings_training_classes_body = cls(
            start_date=start_date,
            end_date=end_date,
            training_id=training_id,
            company_id=company_id,
        ...
        post_api_20251001_resources_trainings_training_classes_body.additional_properties = d
        return post_api_20251001_resources_trainings_training_classes_body
