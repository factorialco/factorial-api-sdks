...
T = TypeVar("T", bound="PutApi20251001ResourcesAtsQuestionsIdBody")


@_attrs_define
class PutApi20251001ResourcesAtsQuestionsIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_ats_questions_id_body = cls(
            id=id,
            label=label,
            position=position,
            mandatory=mandatory,
        ...
        put_api_20251001_resources_ats_questions_id_body.additional_properties = d
        return put_api_20251001_resources_ats_questions_id_body
