...
from ..models.performance_review_questionnaires_by_strategy_manager_questionnaire_reviewer_strategy import (
    PerformanceReviewQuestionnairesByStrategyManagerQuestionnaireReviewerStrategy,
)

if TYPE_CHECKING:
    from ..models.performance_review_questionnaires_by_strategy_manager_questionnaire_content_item import (
...
class PerformanceReviewQuestionnairesByStrategyManagerQuestionnaire:
    ...
    reviewer_strategy: PerformanceReviewQuestionnairesByStrategyManagerQuestionnaireReviewerStrategy
    content: list[PerformanceReviewQuestionnairesByStrategyManagerQuestionnaireContentItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for content_item_data in _content:
            content_item = (
                PerformanceReviewQuestionnairesByStrategyManagerQuestionnaireContentItem.from_dict(
                    content_item_data
                )
            )
