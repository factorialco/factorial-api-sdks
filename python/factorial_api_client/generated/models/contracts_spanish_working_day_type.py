...
T = TypeVar("T", bound="ContractsSpanishWorkingDayType")
...
class ContractsSpanishWorkingDayType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contracts_spanish_working_day_type = cls(
            id=id,
            name=name,
            default=default,
        ...
        contracts_spanish_working_day_type.additional_properties = d
        return contracts_spanish_working_day_type
