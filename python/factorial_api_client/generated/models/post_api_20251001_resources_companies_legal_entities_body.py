...
T = TypeVar("T", bound="PostApi20251001ResourcesCompaniesLegalEntitiesBody")


@_attrs_define
class PostApi20251001ResourcesCompaniesLegalEntitiesBody:
    company_id: int
    """ company identifier """
    country: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_companies_legal_entities_body = cls(
            company_id=company_id,
            country=country,
            legal_name=legal_name,
            currency=currency,
        ...
        post_api_20251001_resources_companies_legal_entities_body.additional_properties = d
        return post_api_20251001_resources_companies_legal_entities_body
