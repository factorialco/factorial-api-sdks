...
T = TypeVar(
    "T",
    bound="PostApi20261001ResourcesCompensationsAdditionalCompensationsBodyPerWorkedDayDefinition",
)


@_attrs_define
class PostApi20261001ResourcesCompensationsAdditionalCompensationsBodyPerWorkedDayDefinition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_compensations_additional_compensations_body_per_worked_day_definition = cls(
            calculation_source=calculation_source,
            reference_time=reference_time,
        ...
        post_api_20261001_resources_compensations_additional_compensations_body_per_worked_day_definition.additional_properties = d
        return post_api_20261001_resources_compensations_additional_compensations_body_per_worked_day_definition
