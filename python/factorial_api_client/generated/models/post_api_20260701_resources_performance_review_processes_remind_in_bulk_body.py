...
from ..models.post_api_20260701_resources_performance_review_processes_remind_in_bulk_body_evaluation_types import (
    PostApi20260701ResourcesPerformanceReviewProcessesRemindInBulkBodyEvaluationTypes,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesPerformanceReviewProcessesRemindInBulkBody")


@_attrs_define
class PostApi20260701ResourcesPerformanceReviewProcessesRemindInBulkBody:
    id: str
    """ Review process ID """
    evaluation_types: (
        PostApi20260701ResourcesPerformanceReviewProcessesRemindInBulkBodyEvaluationTypes | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_performance_review_processes_remind_in_bulk_body.additional_properties = d
        return post_api_20260701_resources_performance_review_processes_remind_in_bulk_body
