...
from ..models.put_api_20260701_resources_contracts_compensations_id_body_time_condition import (
    PutApi20260701ResourcesContractsCompensationsIdBodyTimeCondition,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260701ResourcesContractsCompensationsIdBody")


@_attrs_define
class PutApi20260701ResourcesContractsCompensationsIdBody:
    ...
    time_condition: PutApi20260701ResourcesContractsCompensationsIdBodyTimeCondition | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_condition: PutApi20260701ResourcesContractsCompensationsIdBodyTimeCondition | Unset
        ...
        put_api_20260701_resources_contracts_compensations_id_body = cls(
            contracts_taxonomy_id=contracts_taxonomy_id,
            id=id,
        ...
        put_api_20260701_resources_contracts_compensations_id_body.additional_properties = d
        return put_api_20260701_resources_contracts_compensations_id_body
