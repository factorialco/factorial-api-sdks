...
from ..models.put_api_20260401_resources_project_management_budget_strategies_id_body_budget_strategy_type import (
    PutApi20260401ResourcesProjectManagementBudgetStrategiesIdBodyBudgetStrategyType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260401ResourcesProjectManagementBudgetStrategiesIdBody")


@_attrs_define
class PutApi20260401ResourcesProjectManagementBudgetStrategiesIdBody:
    id: int
    ...
    budget_strategy_type: (
        PutApi20260401ResourcesProjectManagementBudgetStrategiesIdBodyBudgetStrategyType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_project_management_budget_strategies_id_body = cls(
            id=id,
        ...
        put_api_20260401_resources_project_management_budget_strategies_id_body.additional_properties = d
        return put_api_20260401_resources_project_management_budget_strategies_id_body
