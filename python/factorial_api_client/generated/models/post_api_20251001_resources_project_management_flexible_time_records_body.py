...
T = TypeVar("T", bound="PostApi20251001ResourcesProjectManagementFlexibleTimeRecordsBody")


@_attrs_define
class PostApi20251001ResourcesProjectManagementFlexibleTimeRecordsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_project_management_flexible_time_records_body = cls(
            project_worker_id=project_worker_id,
            date=date,
            imputed_minutes=imputed_minutes,
        ...
        post_api_20251001_resources_project_management_flexible_time_records_body.additional_properties = d
        return post_api_20251001_resources_project_management_flexible_time_records_body
