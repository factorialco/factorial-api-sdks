...
T = TypeVar("T", bound="PostApi20261001ResourcesShiftManagementShiftsBody")


@_attrs_define
class PostApi20261001ResourcesShiftManagementShiftsBody:
    start_at: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_shift_management_shifts_body = cls(
            start_at=start_at,
            end_at=end_at,
            employee_id=employee_id,
            company_id=company_id,
        ...
        post_api_20261001_resources_shift_management_shifts_body.additional_properties = d
        return post_api_20261001_resources_shift_management_shifts_body
