...
T = TypeVar("T", bound="PutApi20260401ResourcesAtsCandidatesIdBody")


@_attrs_define
class PutApi20260401ResourcesAtsCandidatesIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_ats_candidates_id_body = cls(
            id=id,
            email=email,
        ...
        put_api_20260401_resources_ats_candidates_id_body.additional_properties = d
        return put_api_20260401_resources_ats_candidates_id_body
