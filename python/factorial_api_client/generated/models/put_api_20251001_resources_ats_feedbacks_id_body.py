...
T = TypeVar("T", bound="PutApi20251001ResourcesAtsFeedbacksIdBody")


@_attrs_define
class PutApi20251001ResourcesAtsFeedbacksIdBody:
    id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_ats_feedbacks_id_body = cls(
            id=id,
            rating=rating,
        ...
        put_api_20251001_resources_ats_feedbacks_id_body.additional_properties = d
        return put_api_20251001_resources_ats_feedbacks_id_body
