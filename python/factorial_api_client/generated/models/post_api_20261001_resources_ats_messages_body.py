...
from .. import types
from ..models.post_api_20261001_resources_ats_messages_body_sent_by_type import (
    PostApi20261001ResourcesAtsMessagesBodySentByType,
)
from ..types import UNSET, File, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesAtsMessagesBody")


@_attrs_define
class PostApi20261001ResourcesAtsMessagesBody:
    content: str
    sent_by_id: str
    sent_by_type: PostApi20261001ResourcesAtsMessagesBodySentByType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sent_by_type = PostApi20261001ResourcesAtsMessagesBodySentByType(d.pop("sent_by_type"))
        ...
        post_api_20261001_resources_ats_messages_body = cls(
            content=content,
            sent_by_id=sent_by_id,
            sent_by_type=sent_by_type,
            ats_application_id=ats_application_id,
        ...
        post_api_20261001_resources_ats_messages_body.additional_properties = d
        return post_api_20261001_resources_ats_messages_body
