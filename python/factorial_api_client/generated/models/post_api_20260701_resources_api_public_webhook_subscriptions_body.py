...
from ..models.post_api_20260701_resources_api_public_webhook_subscriptions_body_api_version import (
    PostApi20260701ResourcesApiPublicWebhookSubscriptionsBodyApiVersion,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesApiPublicWebhookSubscriptionsBody")


@_attrs_define
class PostApi20260701ResourcesApiPublicWebhookSubscriptionsBody:
    ...
    api_version: PostApi20260701ResourcesApiPublicWebhookSubscriptionsBodyApiVersion | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_version: PostApi20260701ResourcesApiPublicWebhookSubscriptionsBodyApiVersion | Unset
        if isinstance(_api_version, Unset):
            api_version = UNSET
        else:
            api_version = PostApi20260701ResourcesApiPublicWebhookSubscriptionsBodyApiVersion(
                _api_version
            ) if _api_version is not None else None

        post_api_20260701_resources_api_public_webhook_subscriptions_body = cls(
            subscription_type=subscription_type,
            target_url=target_url,
            company_id=company_id,
            name=name,
        ...
        post_api_20260701_resources_api_public_webhook_subscriptions_body.additional_properties = d
        return post_api_20260701_resources_api_public_webhook_subscriptions_body
