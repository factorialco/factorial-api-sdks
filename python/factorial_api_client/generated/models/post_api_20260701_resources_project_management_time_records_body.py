...
T = TypeVar("T", bound="PostApi20260701ResourcesProjectManagementTimeRecordsBody")


@_attrs_define
class PostApi20260701ResourcesProjectManagementTimeRecordsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_project_management_time_records_body = cls(
            project_worker_id=project_worker_id,
            attendance_shift_id=attendance_shift_id,
            subproject_id=subproject_id,
        )

        post_api_20260701_resources_project_management_time_records_body.additional_properties = d
        return post_api_20260701_resources_project_management_time_records_body
