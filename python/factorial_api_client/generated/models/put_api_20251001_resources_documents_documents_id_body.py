...
T = TypeVar("T", bound="PutApi20251001ResourcesDocumentsDocumentsIdBody")


@_attrs_define
class PutApi20251001ResourcesDocumentsDocumentsIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20251001_resources_documents_documents_id_body = cls(
            id=id,
            public=public,
            request_esignature=request_esignature,
            signee_ids=signee_ids,
        ...
        put_api_20251001_resources_documents_documents_id_body.additional_properties = d
        return put_api_20251001_resources_documents_documents_id_body
