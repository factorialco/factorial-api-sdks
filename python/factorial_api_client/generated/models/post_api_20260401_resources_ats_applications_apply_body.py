...
T = TypeVar("T", bound="PostApi20260401ResourcesAtsApplicationsApplyBody")


@_attrs_define
class PostApi20260401ResourcesAtsApplicationsApplyBody:
    first_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_ats_applications_apply_body = cls(
            first_name=first_name,
            last_name=last_name,
            ats_job_posting_id=ats_job_posting_id,
            email=email,
        ...
        post_api_20260401_resources_ats_applications_apply_body.additional_properties = d
        return post_api_20260401_resources_ats_applications_apply_body
