...
T = TypeVar("T", bound="PostApi20260401ResourcesShiftManagementShiftsBulkCreateBody")


@_attrs_define
class PostApi20260401ResourcesShiftManagementShiftsBulkCreateBody:
    shifts: list[Any]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_shift_management_shifts_bulk_create_body = cls(
            shifts=shifts,
            planned_breaks=planned_breaks,
        )

        post_api_20260401_resources_shift_management_shifts_bulk_create_body.additional_properties = d
        return post_api_20260401_resources_shift_management_shifts_bulk_create_body
