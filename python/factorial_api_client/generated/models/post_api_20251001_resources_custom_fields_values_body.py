...
T = TypeVar("T", bound="PostApi20251001ResourcesCustomFieldsValuesBody")


@_attrs_define
class PostApi20251001ResourcesCustomFieldsValuesBody:
    field_id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_custom_fields_values_body = cls(
            field_id=field_id,
            valuable_type=valuable_type,
            valuable_id=valuable_id,
            value=value,
        ...
        post_api_20251001_resources_custom_fields_values_body.additional_properties = d
        return post_api_20251001_resources_custom_fields_values_body
