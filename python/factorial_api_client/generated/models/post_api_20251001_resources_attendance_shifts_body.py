...
from ..models.post_api_20251001_resources_attendance_shifts_body_location_type import (
    PostApi20251001ResourcesAttendanceShiftsBodyLocationType,
)
from ..models.post_api_20251001_resources_attendance_shifts_body_source import (
    PostApi20251001ResourcesAttendanceShiftsBodySource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesAttendanceShiftsBody")


@_attrs_define
class PostApi20251001ResourcesAttendanceShiftsBody:
    date: str
    """ Date of the shift """
    ...
    location_type: PostApi20251001ResourcesAttendanceShiftsBodyLocationType | Unset = UNSET
    """ Type of the location """
    source: PostApi20251001ResourcesAttendanceShiftsBodySource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PostApi20251001ResourcesAttendanceShiftsBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PostApi20251001ResourcesAttendanceShiftsBodyLocationType(_location_type) if _location_type is not None else None

        _source = d.pop("source", UNSET)
        source: PostApi20251001ResourcesAttendanceShiftsBodySource | Unset
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = PostApi20251001ResourcesAttendanceShiftsBodySource(_source) if _source is not None else None

        time_settings_break_configuration_id = d.pop("time_settings_break_configuration_id", UNSET)

        post_api_20251001_resources_attendance_shifts_body = cls(
            date=date,
        ...
        post_api_20251001_resources_attendance_shifts_body.additional_properties = d
        return post_api_20251001_resources_attendance_shifts_body
