...
T = TypeVar("T", bound="PutApi20261001ResourcesTrainingsTrainingsIdBody")


@_attrs_define
class PutApi20261001ResourcesTrainingsTrainingsIdBody:
    id: str
    name: str
    description: str
    external: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_trainings_trainings_id_body = cls(
            id=id,
            name=name,
            description=description,
            external=external,
        ...
        put_api_20261001_resources_trainings_trainings_id_body.additional_properties = d
        return put_api_20261001_resources_trainings_trainings_id_body
