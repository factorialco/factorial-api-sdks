...
T = TypeVar("T", bound="PutApi20260701ResourcesAtsCandidatesIdBody")


@_attrs_define
class PutApi20260701ResourcesAtsCandidatesIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_ats_candidates_id_body = cls(
            id=id,
            email=email,
        ...
        put_api_20260701_resources_ats_candidates_id_body.additional_properties = d
        return put_api_20260701_resources_ats_candidates_id_body
