...
from ..models.post_api_20260401_resources_finance_ledger_account_resources_upsert_body_balance_type import (
    PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBodyBalanceType,
)
from ..models.post_api_20260401_resources_finance_ledger_account_resources_upsert_body_operation_type import (
    PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBodyOperationType,
)
from ..models.post_api_20260401_resources_finance_ledger_account_resources_upsert_body_resource_type import (
    PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBodyResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBody")


@_attrs_define
class PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBody:
    legal_entity_id: int
    """ Legal entity identifier. """
    resource_type: PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBodyResourceType
    ...
    balance_type: (
        PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBodyBalanceType | Unset
    ) = UNSET
    """ Ledger account balance type. """
    operation_type: (
        PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBodyOperationType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_finance_ledger_account_resources_upsert_body = cls(
            legal_entity_id=legal_entity_id,
            resource_type=resource_type,
            id=id,
            name=name,
        ...
        post_api_20260401_resources_finance_ledger_account_resources_upsert_body.additional_properties = d
        return post_api_20260401_resources_finance_ledger_account_resources_upsert_body
