...
if TYPE_CHECKING:
    from ..models.performance_review_evaluation_answer_answered_employee_score_questionnaire_content_item_questions_item_answer_answer_rating import (
...
T = TypeVar(
    "T",
    bound="PerformanceReviewEvaluationAnswerAnsweredEmployeeScoreQuestionnaireContentItemQuestionsItemAnswer",
)


@_attrs_define
class PerformanceReviewEvaluationAnswerAnsweredEmployeeScoreQuestionnaireContentItemQuestionsItemAnswer:
    uuid: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_answer_rating, Unset):
            ...
            answer_rating = PerformanceReviewEvaluationAnswerAnsweredEmployeeScoreQuestionnaireContentItemQuestionsItemAnswerAnswerRating.from_dict(
                _answer_rating
            )

        performance_review_evaluation_answer_answered_employee_score_questionnaire_content_item_questions_item_answer = cls(
            uuid=uuid,
        ...
        performance_review_evaluation_answer_answered_employee_score_questionnaire_content_item_questions_item_answer.additional_properties = d
        return performance_review_evaluation_answer_answered_employee_score_questionnaire_content_item_questions_item_answer
