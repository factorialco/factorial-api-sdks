...
T = TypeVar("T", bound="ContractsSpanishProfessionalCategory")


@_attrs_define
class ContractsSpanishProfessionalCategory:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contracts_spanish_professional_category = cls(
            id=id,
            name=name,
            default=default,
        ...
        contracts_spanish_professional_category.additional_properties = d
        return contracts_spanish_professional_category
