...
from .. import types
from ..models.post_api_20260701_resources_project_management_project_tasks_body_status import (
    PostApi20260701ResourcesProjectManagementProjectTasksBodyStatus,
)
from ..types import UNSET, File, FileTypes, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesProjectManagementProjectTasksBody")


@_attrs_define
class PostApi20260701ResourcesProjectManagementProjectTasksBody:
    name: str
    """ The name of the project task """
    project_id: str
    """ The ID of the project where the task belongs """
    status: PostApi20260701ResourcesProjectManagementProjectTasksBodyStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApi20260701ResourcesProjectManagementProjectTasksBodyStatus(d.pop("status"))
        ...
        post_api_20260701_resources_project_management_project_tasks_body = cls(
            name=name,
            project_id=project_id,
            status=status,
            content=content,
        ...
        post_api_20260701_resources_project_management_project_tasks_body.additional_properties = d
        return post_api_20260701_resources_project_management_project_tasks_body
