...
T = TypeVar("T", bound="PostApi20251001ResourcesAttendanceShiftsClockOutBody")


@_attrs_define
class PostApi20251001ResourcesAttendanceShiftsClockOutBody:
    now: str
    """ Clock out time """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_attendance_shifts_clock_out_body = cls(
            now=now,
        ...
        post_api_20251001_resources_attendance_shifts_clock_out_body.additional_properties = d
        return post_api_20251001_resources_attendance_shifts_clock_out_body
