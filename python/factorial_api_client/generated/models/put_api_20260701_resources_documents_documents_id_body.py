...
T = TypeVar("T", bound="PutApi20260701ResourcesDocumentsDocumentsIdBody")


@_attrs_define
class PutApi20260701ResourcesDocumentsDocumentsIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_documents_documents_id_body = cls(
            id=id,
            public=public,
            request_esignature=request_esignature,
            signee_ids=signee_ids,
        ...
        put_api_20260701_resources_documents_documents_id_body.additional_properties = d
        return put_api_20260701_resources_documents_documents_id_body
