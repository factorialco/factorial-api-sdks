...
T = TypeVar("T", bound="PostApi20260401ResourcesCustomResourcesValuesBody")


@_attrs_define
class PostApi20260401ResourcesCustomResourcesValuesBody:
    schema_id: int
    ...
    custom_resource_id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_custom_resources_values_body = cls(
            schema_id=schema_id,
            employee_id=employee_id,
            field_id=field_id,
            value=value,
        ...
        post_api_20260401_resources_custom_resources_values_body.additional_properties = d
        return post_api_20260401_resources_custom_resources_values_body
