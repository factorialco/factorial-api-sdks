...
T = TypeVar("T", bound="PostApi20260401ResourcesTimeoffLeavesBody")


@_attrs_define
class PostApi20260401ResourcesTimeoffLeavesBody:
    employee_id: int
    ...
    relapse_leave_id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_timeoff_leaves_body = cls(
            employee_id=employee_id,
            start_on=start_on,
        ...
        post_api_20260401_resources_timeoff_leaves_body.additional_properties = d
        return post_api_20260401_resources_timeoff_leaves_body
