...
from ..models.post_api_20251001_resources_performance_review_questionnaire_by_strategies_update_questionnaire_for_strategy_body_strategy import (
    PostApi20251001ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateQuestionnaireForStrategyBodyStrategy,
)

T = TypeVar(
    "T",
    bound="PostApi20251001ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateQuestionnaireForStrategyBody",
)


@_attrs_define
class PostApi20251001ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateQuestionnaireForStrategyBody:
    performance_review_process_id: int
    """ Review process ID """
    strategy: PostApi20251001ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateQuestionnaireForStrategyBodyStrategy
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_performance_review_questionnaire_by_strategies_update_questionnaire_for_strategy_body = cls(
            performance_review_process_id=performance_review_process_id,
            strategy=strategy,
            questionnaire_content=questionnaire_content,
        )

        post_api_20251001_resources_performance_review_questionnaire_by_strategies_update_questionnaire_for_strategy_body.additional_properties = d
        return post_api_20251001_resources_performance_review_questionnaire_by_strategies_update_questionnaire_for_strategy_body
