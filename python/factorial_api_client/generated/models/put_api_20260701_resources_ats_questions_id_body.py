...
T = TypeVar("T", bound="PutApi20260701ResourcesAtsQuestionsIdBody")


@_attrs_define
class PutApi20260701ResourcesAtsQuestionsIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_ats_questions_id_body = cls(
            id=id,
            label=label,
            position=position,
            mandatory=mandatory,
        ...
        put_api_20260701_resources_ats_questions_id_body.additional_properties = d
        return put_api_20260701_resources_ats_questions_id_body
