...
from ..models.post_api_20261001_resources_attendance_shifts_body_location_type import (
    PostApi20261001ResourcesAttendanceShiftsBodyLocationType,
)
from ..models.post_api_20261001_resources_attendance_shifts_body_source import (
    PostApi20261001ResourcesAttendanceShiftsBodySource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20261001ResourcesAttendanceShiftsBody")


@_attrs_define
class PostApi20261001ResourcesAttendanceShiftsBody:
    date: str
    """ Date of the shift """
    ...
    location_type: PostApi20261001ResourcesAttendanceShiftsBodyLocationType | Unset = UNSET
    """ Type of the location """
    source: PostApi20261001ResourcesAttendanceShiftsBodySource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PostApi20261001ResourcesAttendanceShiftsBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PostApi20261001ResourcesAttendanceShiftsBodyLocationType(_location_type) if _location_type is not None else None

        _source = d.pop("source", UNSET)
        source: PostApi20261001ResourcesAttendanceShiftsBodySource | Unset
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = PostApi20261001ResourcesAttendanceShiftsBodySource(_source) if _source is not None else None
        ...
        post_api_20261001_resources_attendance_shifts_body = cls(
            date=date,
        ...
        post_api_20261001_resources_attendance_shifts_body.additional_properties = d
        return post_api_20261001_resources_attendance_shifts_body
