...
T = TypeVar("T", bound="PutApi20261001ResourcesPostsPostsIdBody")


@_attrs_define
class PutApi20261001ResourcesPostsPostsIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_posts_posts_id_body = cls(
            id=id,
            title=title,
        ...
        put_api_20261001_resources_posts_posts_id_body.additional_properties = d
        return put_api_20261001_resources_posts_posts_id_body
