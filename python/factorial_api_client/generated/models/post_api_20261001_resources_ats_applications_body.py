...
from ..models.post_api_20261001_resources_ats_applications_body_author_type import (
    PostApi20261001ResourcesAtsApplicationsBodyAuthorType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_20261001_resources_ats_applications_body_answers_item import (
        PostApi20261001ResourcesAtsApplicationsBodyAnswersItem,
    )


T = TypeVar("T", bound="PostApi20261001ResourcesAtsApplicationsBody")


@_attrs_define
class PostApi20261001ResourcesAtsApplicationsBody:
    ats_job_posting_id: str
    """ Application job posting id """
    author_id: str | Unset = UNSET
    """ Application author id """
    author_type: PostApi20261001ResourcesAtsApplicationsBodyAuthorType | Unset = UNSET
    ...
    """ Application medium """
    answers: list[PostApi20261001ResourcesAtsApplicationsBodyAnswersItem] | Unset = UNSET
    """ answers """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author_type: PostApi20261001ResourcesAtsApplicationsBodyAuthorType | Unset
        if isinstance(_author_type, Unset):
            author_type = UNSET
        else:
            author_type = PostApi20261001ResourcesAtsApplicationsBodyAuthorType(_author_type) if _author_type is not None else None
        ...
        if _answers is not UNSET:
            ...
            for answers_item_data in _answers:
                answers_item = PostApi20261001ResourcesAtsApplicationsBodyAnswersItem.from_dict(
                    answers_item_data
                )

                answers.append(answers_item)

        post_api_20261001_resources_ats_applications_body = cls(
            ats_job_posting_id=ats_job_posting_id,
            author_id=author_id,
        ...
        post_api_20261001_resources_ats_applications_body.additional_properties = d
        return post_api_20261001_resources_ats_applications_body
