...
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_available_days import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyAvailableDays,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_days_type import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyDaysType,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_frequency import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyFrequency,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_negative_counter_type import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyNegativeCounterType,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_proration_type import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyProrationType,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_range_type import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyRangeType,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_rounding import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyRounding,
)
from ..models.put_api_20261001_resources_timeoff_allowances_id_body_tenure_period_transition import (
    PutApi20261001ResourcesTimeoffAllowancesIdBodyTenurePeriodTransition,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.put_api_20261001_resources_timeoff_allowances_id_body_tenure_periods_item import (
        PutApi20261001ResourcesTimeoffAllowancesIdBodyTenurePeriodsItem,
    )


T = TypeVar("T", bound="PutApi20261001ResourcesTimeoffAllowancesIdBody")


@_attrs_define
class PutApi20261001ResourcesTimeoffAllowancesIdBody:
    id: str
    ...
    """
    available_days: PutApi20261001ResourcesTimeoffAllowancesIdBodyAvailableDays | Unset = UNSET
    ...
    days_type: PutApi20261001ResourcesTimeoffAllowancesIdBodyDaysType | Unset = UNSET
    ...
    frequency: PutApi20261001ResourcesTimeoffAllowancesIdBodyFrequency | Unset = UNSET
    ...
    negative_counter_type: (
        PutApi20261001ResourcesTimeoffAllowancesIdBodyNegativeCounterType | Unset
    ) = UNSET
    ...
    proration_type: PutApi20261001ResourcesTimeoffAllowancesIdBodyProrationType | Unset = UNSET
    ...
    range_type: PutApi20261001ResourcesTimeoffAllowancesIdBodyRangeType | Unset = UNSET
    """ Configures how leaves duration is handled. """
    rounding: PutApi20261001ResourcesTimeoffAllowancesIdBodyRounding | Unset = UNSET
    ...
    tenure_period_transition: (
        PutApi20261001ResourcesTimeoffAllowancesIdBodyTenurePeriodTransition | Unset
    ) = UNSET
    ...
    tenure_periods: (
        list[PutApi20261001ResourcesTimeoffAllowancesIdBodyTenurePeriodsItem] | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tenure_periods: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        available_days: PutApi20261001ResourcesTimeoffAllowancesIdBodyAvailableDays | Unset
        if isinstance(_available_days, Unset):
            available_days = UNSET
        else:
            available_days = PutApi20261001ResourcesTimeoffAllowancesIdBodyAvailableDays(
                _available_days
        ...
        days_type: PutApi20261001ResourcesTimeoffAllowancesIdBodyDaysType | Unset
        if isinstance(_days_type, Unset):
            days_type = UNSET
        else:
            days_type = PutApi20261001ResourcesTimeoffAllowancesIdBodyDaysType(_days_type) if _days_type is not None else None

        expire_in_months = d.pop("expire_in_months", UNSET)

        _frequency = d.pop("frequency", UNSET)
        frequency: PutApi20261001ResourcesTimeoffAllowancesIdBodyFrequency | Unset
        if isinstance(_frequency, Unset):
            frequency = UNSET
        else:
            frequency = PutApi20261001ResourcesTimeoffAllowancesIdBodyFrequency(_frequency) if _frequency is not None else None
        ...
        proration_type: PutApi20261001ResourcesTimeoffAllowancesIdBodyProrationType | Unset
        if isinstance(_proration_type, Unset):
            proration_type = UNSET
        else:
            proration_type = PutApi20261001ResourcesTimeoffAllowancesIdBodyProrationType(
                _proration_type
        ...
        range_type: PutApi20261001ResourcesTimeoffAllowancesIdBodyRangeType | Unset
        if isinstance(_range_type, Unset):
            range_type = UNSET
        else:
            range_type = PutApi20261001ResourcesTimeoffAllowancesIdBodyRangeType(_range_type) if _range_type is not None else None

        _rounding = d.pop("rounding", UNSET)
        rounding: PutApi20261001ResourcesTimeoffAllowancesIdBodyRounding | Unset
        if isinstance(_rounding, Unset):
            rounding = UNSET
        else:
            rounding = PutApi20261001ResourcesTimeoffAllowancesIdBodyRounding(_rounding) if _rounding is not None else None
        ...
        _tenure_periods = d.pop("tenure_periods", UNSET)
        tenure_periods: (
            list[PutApi20261001ResourcesTimeoffAllowancesIdBodyTenurePeriodsItem] | Unset
        ) = UNSET
        if _tenure_periods is not UNSET:
            tenure_periods = []
            for tenure_periods_item_data in _tenure_periods:
                tenure_periods_item = (
                    PutApi20261001ResourcesTimeoffAllowancesIdBodyTenurePeriodsItem.from_dict(
        ...
        put_api_20261001_resources_timeoff_allowances_id_body = cls(
            id=id,
        ...
        put_api_20261001_resources_timeoff_allowances_id_body.additional_properties = d
        return put_api_20261001_resources_timeoff_allowances_id_body
