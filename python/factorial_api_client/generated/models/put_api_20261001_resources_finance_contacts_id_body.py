...
if TYPE_CHECKING:
    from ..models.put_api_20261001_resources_finance_contacts_id_body_address import (
        PutApi20261001ResourcesFinanceContactsIdBodyAddress,
    )


T = TypeVar("T", bound="PutApi20261001ResourcesFinanceContactsIdBody")


@_attrs_define
class PutApi20261001ResourcesFinanceContactsIdBody:
    id: str
    """ ID of the Contact to update. """
    address: PutApi20261001ResourcesFinanceContactsIdBodyAddress
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        address = PutApi20261001ResourcesFinanceContactsIdBodyAddress.from_dict(d.pop("address"))
        ...
        put_api_20261001_resources_finance_contacts_id_body = cls(
            id=id,
            address=address,
            tax_id=tax_id,
        ...
        put_api_20261001_resources_finance_contacts_id_body.additional_properties = d
        return put_api_20261001_resources_finance_contacts_id_body
