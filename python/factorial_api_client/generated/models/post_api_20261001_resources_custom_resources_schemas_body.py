...
T = TypeVar("T", bound="PostApi20261001ResourcesCustomResourcesSchemasBody")


@_attrs_define
class PostApi20261001ResourcesCustomResourcesSchemasBody:
    name: str
    """ Schema name """
    company_id: str
    ...
    effective_at_id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_custom_resources_schemas_body = cls(
            name=name,
            company_id=company_id,
            hidden=hidden,
        ...
        post_api_20261001_resources_custom_resources_schemas_body.additional_properties = d
        return post_api_20261001_resources_custom_resources_schemas_body
