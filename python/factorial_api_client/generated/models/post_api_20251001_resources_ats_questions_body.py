...
from ..models.post_api_20251001_resources_ats_questions_body_question_type import (
    PostApi20251001ResourcesAtsQuestionsBodyQuestionType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesAtsQuestionsBody")


@_attrs_define
class PostApi20251001ResourcesAtsQuestionsBody:
    ...
    question_type: PostApi20251001ResourcesAtsQuestionsBodyQuestionType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        question_type = PostApi20251001ResourcesAtsQuestionsBodyQuestionType(d.pop("question_type"))
        ...
        post_api_20251001_resources_ats_questions_body = cls(
            ats_job_posting_id=ats_job_posting_id,
            company_id=company_id,
            label=label,
            position=position,
        ...
        post_api_20251001_resources_ats_questions_body.additional_properties = d
        return post_api_20251001_resources_ats_questions_body
