...
T = TypeVar("T", bound="PutApi20261001ResourcesBookkeepersManagementIncidencesIdBody")


@_attrs_define
class PutApi20261001ResourcesBookkeepersManagementIncidencesIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20261001_resources_bookkeepers_management_incidences_id_body = cls(
            id=id,
            status=status,
        ...
        put_api_20261001_resources_bookkeepers_management_incidences_id_body.additional_properties = d
        return put_api_20261001_resources_bookkeepers_management_incidences_id_body
