...
from ..models.put_api_20261001_resources_ats_job_postings_id_body_category import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyCategory,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_contract_type import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyContractType,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_cover_letter_requirement import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyCoverLetterRequirement,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_cv_requirement import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyCvRequirement,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_personal_url_requirement import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyPersonalUrlRequirement,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_phone_requirement import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyPhoneRequirement,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_photo_requirement import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyPhotoRequirement,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_salary_format import (
    PutApi20261001ResourcesAtsJobPostingsIdBodySalaryFormat,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_salary_period import (
    PutApi20261001ResourcesAtsJobPostingsIdBodySalaryPeriod,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_schedule_type import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyScheduleType,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_status import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyStatus,
)
from ..models.put_api_20261001_resources_ats_job_postings_id_body_workplace_type import (
    PutApi20261001ResourcesAtsJobPostingsIdBodyWorkplaceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesAtsJobPostingsIdBody")


@_attrs_define
class PutApi20261001ResourcesAtsJobPostingsIdBody:
    id: str
    title: str | Unset = UNSET
    description: str | Unset = UNSET
    contract_type: PutApi20261001ResourcesAtsJobPostingsIdBodyContractType | Unset = UNSET
    category: PutApi20261001ResourcesAtsJobPostingsIdBodyCategory | Unset = UNSET
    workplace_type: PutApi20261001ResourcesAtsJobPostingsIdBodyWorkplaceType | Unset = UNSET
    status: PutApi20261001ResourcesAtsJobPostingsIdBodyStatus | Unset = UNSET
    schedule_type: PutApi20261001ResourcesAtsJobPostingsIdBodyScheduleType | Unset = UNSET
    team_id: str | Unset = UNSET
    location_id: str | Unset = UNSET
    salary_format: PutApi20261001ResourcesAtsJobPostingsIdBodySalaryFormat | Unset = UNSET
    salary_from_amount_in_cents: int | Unset = UNSET
    salary_to_amount_in_cents: int | Unset = UNSET
    cv_requirement: PutApi20261001ResourcesAtsJobPostingsIdBodyCvRequirement | Unset = UNSET
    cover_letter_requirement: (
        PutApi20261001ResourcesAtsJobPostingsIdBodyCoverLetterRequirement | Unset
    ) = UNSET
    phone_requirement: PutApi20261001ResourcesAtsJobPostingsIdBodyPhoneRequirement | Unset = UNSET
    photo_requirement: PutApi20261001ResourcesAtsJobPostingsIdBodyPhotoRequirement | Unset = UNSET
    personal_url_requirement: (
        PutApi20261001ResourcesAtsJobPostingsIdBodyPersonalUrlRequirement | Unset
    ) = UNSET
    salary_period: PutApi20261001ResourcesAtsJobPostingsIdBodySalaryPeriod | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contract_type: PutApi20261001ResourcesAtsJobPostingsIdBodyContractType | Unset
        if isinstance(_contract_type, Unset):
            contract_type = UNSET
        else:
            contract_type = PutApi20261001ResourcesAtsJobPostingsIdBodyContractType(_contract_type) if _contract_type is not None else None

        _category = d.pop("category", UNSET)
        category: PutApi20261001ResourcesAtsJobPostingsIdBodyCategory | Unset
        if isinstance(_category, Unset):
            category = UNSET
        else:
            category = PutApi20261001ResourcesAtsJobPostingsIdBodyCategory(_category) if _category is not None else None

        _workplace_type = d.pop("workplace_type", UNSET)
        workplace_type: PutApi20261001ResourcesAtsJobPostingsIdBodyWorkplaceType | Unset
        if isinstance(_workplace_type, Unset):
            workplace_type = UNSET
        else:
            workplace_type = PutApi20261001ResourcesAtsJobPostingsIdBodyWorkplaceType(
                _workplace_type
            ) if _workplace_type is not None else None

        _status = d.pop("status", UNSET)
        status: PutApi20261001ResourcesAtsJobPostingsIdBodyStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PutApi20261001ResourcesAtsJobPostingsIdBodyStatus(_status) if _status is not None else None

        _schedule_type = d.pop("schedule_type", UNSET)
        schedule_type: PutApi20261001ResourcesAtsJobPostingsIdBodyScheduleType | Unset
        if isinstance(_schedule_type, Unset):
            schedule_type = UNSET
        else:
            schedule_type = PutApi20261001ResourcesAtsJobPostingsIdBodyScheduleType(_schedule_type) if _schedule_type is not None else None
        ...
        salary_format: PutApi20261001ResourcesAtsJobPostingsIdBodySalaryFormat | Unset
        if isinstance(_salary_format, Unset):
            salary_format = UNSET
        else:
            salary_format = PutApi20261001ResourcesAtsJobPostingsIdBodySalaryFormat(_salary_format) if _salary_format is not None else None
        ...
        cv_requirement: PutApi20261001ResourcesAtsJobPostingsIdBodyCvRequirement | Unset
        if isinstance(_cv_requirement, Unset):
            cv_requirement = UNSET
        else:
            cv_requirement = PutApi20261001ResourcesAtsJobPostingsIdBodyCvRequirement(
                _cv_requirement
        ...
        phone_requirement: PutApi20261001ResourcesAtsJobPostingsIdBodyPhoneRequirement | Unset
        if isinstance(_phone_requirement, Unset):
            phone_requirement = UNSET
        else:
            phone_requirement = PutApi20261001ResourcesAtsJobPostingsIdBodyPhoneRequirement(
                _phone_requirement
            ) if _phone_requirement is not None else None

        _photo_requirement = d.pop("photo_requirement", UNSET)
        photo_requirement: PutApi20261001ResourcesAtsJobPostingsIdBodyPhotoRequirement | Unset
        if isinstance(_photo_requirement, Unset):
            photo_requirement = UNSET
        else:
            photo_requirement = PutApi20261001ResourcesAtsJobPostingsIdBodyPhotoRequirement(
                _photo_requirement
        ...
        salary_period: PutApi20261001ResourcesAtsJobPostingsIdBodySalaryPeriod | Unset
        if isinstance(_salary_period, Unset):
            salary_period = UNSET
        else:
            salary_period = PutApi20261001ResourcesAtsJobPostingsIdBodySalaryPeriod(_salary_period) if _salary_period is not None else None

        put_api_20261001_resources_ats_job_postings_id_body = cls(
            id=id,
            title=title,
        ...
        put_api_20261001_resources_ats_job_postings_id_body.additional_properties = d
        return put_api_20261001_resources_ats_job_postings_id_body
