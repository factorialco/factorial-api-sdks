...
T = TypeVar("T", bound="PostApi20260701ResourcesAttendanceBreakConfigurationsBody")


@_attrs_define
class PostApi20260701ResourcesAttendanceBreakConfigurationsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_attendance_break_configurations_body = cls(
            time_settings_break_configuration_id=time_settings_break_configuration_id,
            attendance_employees_setting_id=attendance_employees_setting_id,
            enabled=enabled,
        )

        post_api_20260701_resources_attendance_break_configurations_body.additional_properties = d
        return post_api_20260701_resources_attendance_break_configurations_body
