...
T = TypeVar("T", bound="PostApi20251001ResourcesTimeoffLeaveTypesBody")


@_attrs_define
class PostApi20251001ResourcesTimeoffLeaveTypesBody:
    accrues: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_timeoff_leave_types_body = cls(
            accrues=accrues,
            approval_required=approval_required,
            identifier=identifier,
            color=color,
        ...
        post_api_20251001_resources_timeoff_leave_types_body.additional_properties = d
        return post_api_20251001_resources_timeoff_leave_types_body
