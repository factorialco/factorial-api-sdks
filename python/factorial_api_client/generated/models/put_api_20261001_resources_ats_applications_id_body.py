...
from ..models.put_api_20261001_resources_ats_applications_id_body_author_type import (
    PutApi20261001ResourcesAtsApplicationsIdBodyAuthorType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20261001ResourcesAtsApplicationsIdBody")


@_attrs_define
class PutApi20261001ResourcesAtsApplicationsIdBody:
    id: str
    """ Application id """
    author_id: str | Unset = UNSET
    """ Application author id """
    author_type: PutApi20261001ResourcesAtsApplicationsIdBodyAuthorType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author_type: PutApi20261001ResourcesAtsApplicationsIdBodyAuthorType | Unset
        if isinstance(_author_type, Unset):
            author_type = UNSET
        else:
            author_type = PutApi20261001ResourcesAtsApplicationsIdBodyAuthorType(_author_type) if _author_type is not None else None
        ...
        put_api_20261001_resources_ats_applications_id_body = cls(
            id=id,
            author_id=author_id,
        ...
        put_api_20261001_resources_ats_applications_id_body.additional_properties = d
        return put_api_20261001_resources_ats_applications_id_body
