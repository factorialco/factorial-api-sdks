...
T = TypeVar("T", bound="PutApi20260701ResourcesBookkeepersManagementIncidencesIdBody")


@_attrs_define
class PutApi20260701ResourcesBookkeepersManagementIncidencesIdBody:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260701_resources_bookkeepers_management_incidences_id_body = cls(
            id=id,
            status=status,
        ...
        put_api_20260701_resources_bookkeepers_management_incidences_id_body.additional_properties = d
        return put_api_20260701_resources_bookkeepers_management_incidences_id_body
