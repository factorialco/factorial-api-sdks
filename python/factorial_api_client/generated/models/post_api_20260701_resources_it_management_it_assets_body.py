...
T = TypeVar("T", bound="PostApi20260701ResourcesItManagementItAssetsBody")


@_attrs_define
class PostApi20260701ResourcesItManagementItAssetsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_it_management_it_assets_body = cls(
            it_asset_model_id=it_asset_model_id,
            serial_number=serial_number,
            owner_id=owner_id,
        ...
        post_api_20260701_resources_it_management_it_assets_body.additional_properties = d
        return post_api_20260701_resources_it_management_it_assets_body
