...
from ..models.post_api_20260701_resources_employees_employees_create_with_contract_body_contracts_annual_working_time_distribution import (
    PostApi20260701ResourcesEmployeesEmployeesCreateWithContractBodyContractsAnnualWorkingTimeDistribution,
)
from ..models.post_api_20260701_resources_employees_employees_create_with_contract_body_contracts_bank_holiday_treatment import (
    PostApi20260701ResourcesEmployeesEmployeesCreateWithContractBodyContractsBankHolidayTreatment,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesEmployeesEmployeesCreateWithContractBody")


@_attrs_define
class PostApi20260701ResourcesEmployeesEmployeesCreateWithContractBody:
    company_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_contracts_bank_holiday_treatment, Unset):
            ...
            contracts_bank_holiday_treatment = PostApi20260701ResourcesEmployeesEmployeesCreateWithContractBodyContractsBankHolidayTreatment(
        ...
        if isinstance(_contracts_annual_working_time_distribution, Unset):
            ...
            contracts_annual_working_time_distribution = PostApi20260701ResourcesEmployeesEmployeesCreateWithContractBodyContractsAnnualWorkingTimeDistribution(
        ...
        post_api_20260701_resources_employees_employees_create_with_contract_body = cls(
            company_id=company_id,
            first_name=first_name,
            last_name=last_name,
            email=email,
        ...
        post_api_20260701_resources_employees_employees_create_with_contract_body.additional_properties = d
        return post_api_20260701_resources_employees_employees_create_with_contract_body
