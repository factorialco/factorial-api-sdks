...
T = TypeVar("T", bound="PayrollEmployeesGermanEmployeeDatum")


@_attrs_define
class PayrollEmployeesGermanEmployeeDatum:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payroll_employees_german_employee_datum = cls(
            id=id,
            employee_id=employee_id,
        ...
        payroll_employees_german_employee_datum.additional_properties = d
        return payroll_employees_german_employee_datum
