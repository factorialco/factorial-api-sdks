...
from ..models.contracts_contract_flow_annual_working_time_distribution import (
    ContractsContractFlowAnnualWorkingTimeDistribution,
)
from ..models.contracts_contract_flow_bank_holiday_treatment import (
    ContractsContractFlowBankHolidayTreatment,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.contracts_contract_flow_version_data import ContractsContractFlowVersionData


T = TypeVar("T", bound="ContractsContractFlow")


@_attrs_define
class ContractsContractFlow:
    contract_version_id: str
    """ identifier of the contract version created by the change. Refers to the /contracts/contract_versions
    endpoint. """
    employee_id: str
    ...
    bank_holiday_treatment: ContractsContractFlowBankHolidayTreatment
    ...
    """ identifier of the contract opened by the change, under the target legal entity. Refers to the
    ...
    annual_working_time_distribution: ContractsContractFlowAnnualWorkingTimeDistribution | Unset = (
        UNSET
    )
    ...
    version_data: ContractsContractFlowVersionData | Unset = UNSET
    """ Country-specific contract data, resolved against the target legal entity's template rather than the
    employee's current one. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_annual_working_time_distribution, Unset):
            ...
            annual_working_time_distribution = ContractsContractFlowAnnualWorkingTimeDistribution(
        ...
        version_data: ContractsContractFlowVersionData | Unset
        if isinstance(_version_data, Unset):
            version_data = UNSET
        else:
            version_data = ContractsContractFlowVersionData.from_dict(_version_data)
        ...
        contracts_contract_flow.additional_properties = d
        return contracts_contract_flow
