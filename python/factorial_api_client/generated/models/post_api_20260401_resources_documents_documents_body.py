...
from .. import types
from ..models.post_api_20260401_resources_documents_documents_body_space import (
    PostApi20260401ResourcesDocumentsDocumentsBodySpace,
)
from ..types import UNSET, File, Unset

T = TypeVar("T", bound="PostApi20260401ResourcesDocumentsDocumentsBody")


@_attrs_define
class PostApi20260401ResourcesDocumentsDocumentsBody:
    public: bool
    """ flag to indicate if the document is public. """
    space: PostApi20260401ResourcesDocumentsDocumentsBodySpace
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        space = PostApi20260401ResourcesDocumentsDocumentsBodySpace(d.pop("space"))
        ...
        post_api_20260401_resources_documents_documents_body = cls(
            public=public,
            space=space,
            is_pending_assignment=is_pending_assignment,
            file=file,
        ...
        post_api_20260401_resources_documents_documents_body.additional_properties = d
        return post_api_20260401_resources_documents_documents_body
