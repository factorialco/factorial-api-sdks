...
T = TypeVar("T", bound="PostApi20260701ResourcesProjectManagementProjectsBody")


@_attrs_define
class PostApi20260701ResourcesProjectManagementProjectsBody:
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_project_management_projects_body = cls(
            name=name,
            code=code,
        ...
        post_api_20260701_resources_project_management_projects_body.additional_properties = d
        return post_api_20260701_resources_project_management_projects_body
