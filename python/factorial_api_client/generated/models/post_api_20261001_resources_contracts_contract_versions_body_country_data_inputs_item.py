...
T = TypeVar("T", bound="PostApi20261001ResourcesContractsContractVersionsBodyCountryDataInputsItem")


@_attrs_define
class PostApi20261001ResourcesContractsContractVersionsBodyCountryDataInputsItem:
    field_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_contracts_contract_versions_body_country_data_inputs_item = cls(
            field_name=field_name,
            value_id=value_id,
        ...
        post_api_20261001_resources_contracts_contract_versions_body_country_data_inputs_item.additional_properties = d
        return post_api_20261001_resources_contracts_contract_versions_body_country_data_inputs_item
