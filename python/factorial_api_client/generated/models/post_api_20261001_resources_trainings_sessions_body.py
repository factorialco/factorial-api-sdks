...
from ..models.post_api_20261001_resources_trainings_sessions_body_modality import (
    PostApi20261001ResourcesTrainingsSessionsBodyModality,
)
from ..models.post_api_20261001_resources_trainings_sessions_body_schedule import (
    PostApi20261001ResourcesTrainingsSessionsBodySchedule,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_20261001_resources_trainings_sessions_body_reminders_item import (
        PostApi20261001ResourcesTrainingsSessionsBodyRemindersItem,
    )


T = TypeVar("T", bound="PostApi20261001ResourcesTrainingsSessionsBody")


@_attrs_define
class PostApi20261001ResourcesTrainingsSessionsBody:
    name: str
    """ Session name """
    training_id: str
    ...
    modality: PostApi20261001ResourcesTrainingsSessionsBodyModality | Unset = UNSET
    """ Online, In person or mixed """
    schedule: PostApi20261001ResourcesTrainingsSessionsBodySchedule | Unset = UNSET
    ...
    """ - """
    reminders: list[PostApi20261001ResourcesTrainingsSessionsBodyRemindersItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modality: PostApi20261001ResourcesTrainingsSessionsBodyModality | Unset
        if isinstance(_modality, Unset):
            modality = UNSET
        else:
            modality = PostApi20261001ResourcesTrainingsSessionsBodyModality(_modality) if _modality is not None else None

        _schedule = d.pop("schedule", UNSET)
        schedule: PostApi20261001ResourcesTrainingsSessionsBodySchedule | Unset
        if isinstance(_schedule, Unset):
            schedule = UNSET
        else:
            schedule = PostApi20261001ResourcesTrainingsSessionsBodySchedule(_schedule) if _schedule is not None else None
        ...
        reminders: list[PostApi20261001ResourcesTrainingsSessionsBodyRemindersItem] | Unset = UNSET
        if _reminders is not UNSET:
            reminders = []
            for reminders_item_data in _reminders:
                reminders_item = (
                    PostApi20261001ResourcesTrainingsSessionsBodyRemindersItem.from_dict(
                        reminders_item_data
                    )
                )
        ...
        post_api_20261001_resources_trainings_sessions_body = cls(
            name=name,
            training_id=training_id,
        ...
        post_api_20261001_resources_trainings_sessions_body.additional_properties = d
        return post_api_20261001_resources_trainings_sessions_body
