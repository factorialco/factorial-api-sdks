...
from ..models.post_api_20251001_resources_attendance_shifts_clock_in_body_location_type import (
    PostApi20251001ResourcesAttendanceShiftsClockInBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20251001ResourcesAttendanceShiftsClockInBody")


@_attrs_define
class PostApi20251001ResourcesAttendanceShiftsClockInBody:
    now: str
    """ Clock in time """
    ...
    location_type: PostApi20251001ResourcesAttendanceShiftsClockInBodyLocationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PostApi20251001ResourcesAttendanceShiftsClockInBodyLocationType | Unset
        if isinstance(_location_type, Unset):
            location_type = UNSET
        else:
            location_type = PostApi20251001ResourcesAttendanceShiftsClockInBodyLocationType(
                _location_type
            )
        ...
        post_api_20251001_resources_attendance_shifts_clock_in_body = cls(
            now=now,
        ...
        post_api_20251001_resources_attendance_shifts_clock_in_body.additional_properties = d
        return post_api_20251001_resources_attendance_shifts_clock_in_body
