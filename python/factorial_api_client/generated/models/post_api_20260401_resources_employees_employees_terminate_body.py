...
T = TypeVar("T", bound="PostApi20260401ResourcesEmployeesEmployeesTerminateBody")


@_attrs_define
class PostApi20260401ResourcesEmployeesEmployeesTerminateBody:
    id: int
    """ id of the employee. """
    terminated_on: str
    ...
    termination_assigned_manager_id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260401_resources_employees_employees_terminate_body = cls(
            id=id,
            terminated_on=terminated_on,
        ...
        post_api_20260401_resources_employees_employees_terminate_body.additional_properties = d
        return post_api_20260401_resources_employees_employees_terminate_body
