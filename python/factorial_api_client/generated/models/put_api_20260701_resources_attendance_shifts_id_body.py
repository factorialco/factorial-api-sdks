...
from ..models.put_api_20260701_resources_attendance_shifts_id_body_location_type import (
    PutApi20260701ResourcesAttendanceShiftsIdBodyLocationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApi20260701ResourcesAttendanceShiftsIdBody")


@_attrs_define
class PutApi20260701ResourcesAttendanceShiftsIdBody:
    id: str
    """ Id of the shift """
    ...
    location_type: PutApi20260701ResourcesAttendanceShiftsIdBodyLocationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_type: PutApi20260701ResourcesAttendanceShiftsIdBodyLocationType | Unset
        ...
        put_api_20260701_resources_attendance_shifts_id_body = cls(
            id=id,
            clock_in=clock_in,
            clock_out=clock_out,
            date=date,
        ...
        put_api_20260701_resources_attendance_shifts_id_body.additional_properties = d
        return put_api_20260701_resources_attendance_shifts_id_body
