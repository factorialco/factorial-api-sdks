...
T = TypeVar("T", bound="PutApi20260401ResourcesProjectManagementPlannedRecordsIdBody")


@_attrs_define
class PutApi20260401ResourcesProjectManagementPlannedRecordsIdBody:
    id: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_project_management_planned_records_id_body = cls(
            id=id,
            start_date=start_date,
            end_date=end_date,
            daily_minutes=daily_minutes,
        ...
        put_api_20260401_resources_project_management_planned_records_id_body.additional_properties = d
        return put_api_20260401_resources_project_management_planned_records_id_body
