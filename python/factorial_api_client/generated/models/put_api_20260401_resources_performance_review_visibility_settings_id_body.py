...
T = TypeVar("T", bound="PutApi20260401ResourcesPerformanceReviewVisibilitySettingsIdBody")


@_attrs_define
class PutApi20260401ResourcesPerformanceReviewVisibilitySettingsIdBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_20260401_resources_performance_review_visibility_settings_id_body = cls(
            restrict_answers_visibility_to_reportees=restrict_answers_visibility_to_reportees,
            early_access_to_answers_for_managers=early_access_to_answers_for_managers,
            anonymous_peer_evaluation_for_target=anonymous_peer_evaluation_for_target,
            id=id,
        ...
        put_api_20260401_resources_performance_review_visibility_settings_id_body.additional_properties = d
        return put_api_20260401_resources_performance_review_visibility_settings_id_body
