...
T = TypeVar("T", bound="PostApi20251001ResourcesAtsApplicationsApplyBody")


@_attrs_define
class PostApi20251001ResourcesAtsApplicationsApplyBody:
    first_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_ats_applications_apply_body = cls(
            first_name=first_name,
            last_name=last_name,
            ats_job_posting_id=ats_job_posting_id,
            email=email,
        ...
        post_api_20251001_resources_ats_applications_apply_body.additional_properties = d
        return post_api_20251001_resources_ats_applications_apply_body
