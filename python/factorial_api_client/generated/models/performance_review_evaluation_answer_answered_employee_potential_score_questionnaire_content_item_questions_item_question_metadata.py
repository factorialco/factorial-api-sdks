...
T = TypeVar(
    "T",
    bound="PerformanceReviewEvaluationAnswerAnsweredEmployeePotentialScoreQuestionnaireContentItemQuestionsItemQuestionMetadata",
)


@_attrs_define
class PerformanceReviewEvaluationAnswerAnsweredEmployeePotentialScoreQuestionnaireContentItemQuestionsItemQuestionMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_review_evaluation_answer_answered_employee_potential_score_questionnaire_content_item_questions_item_question_metadata = cls(
        ...
        performance_review_evaluation_answer_answered_employee_potential_score_questionnaire_content_item_questions_item_question_metadata.additional_properties = d
        return performance_review_evaluation_answer_answered_employee_potential_score_questionnaire_content_item_questions_item_question_metadata
