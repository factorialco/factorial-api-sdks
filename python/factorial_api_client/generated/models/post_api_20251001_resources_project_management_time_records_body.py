...
T = TypeVar("T", bound="PostApi20251001ResourcesProjectManagementTimeRecordsBody")


@_attrs_define
class PostApi20251001ResourcesProjectManagementTimeRecordsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20251001_resources_project_management_time_records_body = cls(
            project_worker_id=project_worker_id,
            attendance_shift_id=attendance_shift_id,
            subproject_id=subproject_id,
        )

        post_api_20251001_resources_project_management_time_records_body.additional_properties = d
        return post_api_20251001_resources_project_management_time_records_body
