...
T = TypeVar(
    "T",
    bound="PerformanceReviewQuestionnairesByStrategySelfQuestionnaireContentItemQuestionsItemMetadata",
)


@_attrs_define
class PerformanceReviewQuestionnairesByStrategySelfQuestionnaireContentItemQuestionsItemMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_review_questionnaires_by_strategy_self_questionnaire_content_item_questions_item_metadata = cls(
        ...
        performance_review_questionnaires_by_strategy_self_questionnaire_content_item_questions_item_metadata.additional_properties = d
        return performance_review_questionnaires_by_strategy_self_questionnaire_content_item_questions_item_metadata
