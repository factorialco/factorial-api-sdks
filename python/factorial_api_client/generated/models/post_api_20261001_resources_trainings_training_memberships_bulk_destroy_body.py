...
T = TypeVar("T", bound="PostApi20261001ResourcesTrainingsTrainingMembershipsBulkDestroyBody")


@_attrs_define
class PostApi20261001ResourcesTrainingsTrainingMembershipsBulkDestroyBody:
    ids: list[str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20261001_resources_trainings_training_memberships_bulk_destroy_body = cls(
            ids=ids,
            training_id=training_id,
            all_=all_,
        )

        post_api_20261001_resources_trainings_training_memberships_bulk_destroy_body.additional_properties = d
        return post_api_20261001_resources_trainings_training_memberships_bulk_destroy_body
