...
from ..models.post_api_20260701_resources_performance_review_processes_body_reviewer_strategies import (
    PostApi20260701ResourcesPerformanceReviewProcessesBodyReviewerStrategies,
)
from ..models.post_api_20260701_resources_performance_review_processes_body_target_strategy import (
    PostApi20260701ResourcesPerformanceReviewProcessesBodyTargetStrategy,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApi20260701ResourcesPerformanceReviewProcessesBody")


@_attrs_define
class PostApi20260701ResourcesPerformanceReviewProcessesBody:
    ...
    reviewer_strategies: (
        PostApi20260701ResourcesPerformanceReviewProcessesBodyReviewerStrategies | Unset
    ) = UNSET
    """ Review types that will be assigned to the review process. It'll be used to create the evaluations when the
    process starts """
    target_strategy: (
        PostApi20260701ResourcesPerformanceReviewProcessesBodyTargetStrategy | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_20260701_resources_performance_review_processes_body = cls(
            author_access_id=author_access_id,
            name=name,
        ...
        post_api_20260701_resources_performance_review_processes_body.additional_properties = d
        return post_api_20260701_resources_performance_review_processes_body
