...
from ...models.get_api_20260401_resources_performance_review_evaluation_scores_response_200 import (
    GetApi20260401ResourcesPerformanceReviewEvaluationScoresResponse200,
)
from ...models.get_api_20260401_resources_performance_review_evaluation_scores_reviewer_strategies import (
...
def _get_kwargs(
    *,
    ...
    reviewer_strategies: GetApi20260401ResourcesPerformanceReviewEvaluationScoresReviewerStrategies
    | Unset = UNSET,
...
) -> GetApi20260401ResourcesPerformanceReviewEvaluationScoresResponse200 | None:
    if response.status_code == 200:
        response_200 = (
            GetApi20260401ResourcesPerformanceReviewEvaluationScoresResponse200.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesPerformanceReviewEvaluationScoresResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        reviewer_strategies
            (GetApi20260401ResourcesPerformanceReviewEvaluationScoresReviewerStrategies | Unset):
