...
from ...models.get_api_20260701_resources_performance_review_evaluation_scores_response_200 import (
    GetApi20260701ResourcesPerformanceReviewEvaluationScoresResponse200,
)
from ...models.get_api_20260701_resources_performance_review_evaluation_scores_reviewer_strategies import (
...
def _get_kwargs(
    *,
    ...
    reviewer_strategies: GetApi20260701ResourcesPerformanceReviewEvaluationScoresReviewerStrategies
    | Unset = UNSET,
...
) -> GetApi20260701ResourcesPerformanceReviewEvaluationScoresResponse200 | None:
    if response.status_code == 200:
        response_200 = (
            GetApi20260701ResourcesPerformanceReviewEvaluationScoresResponse200.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesPerformanceReviewEvaluationScoresResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        target_access_ids (list[str] | Unset): Filter by employee access IDs Example: ['1', '2',
            '3'].
        reviewer_strategies
            (GetApi20260701ResourcesPerformanceReviewEvaluationScoresReviewerStrategies | Unset):
