...
from ...models.post_api_20260701_resources_attendance_reviews_bulk_destroy_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesAttendanceReviewsBulkDestroyBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesAttendanceReviewsBulkDestroyBody | Unset):
