...
from ...models.post_api_20261001_resources_attendance_reviews_bulk_destroy_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesAttendanceReviewsBulkDestroyBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesAttendanceReviewsBulkDestroyBody | Unset):
