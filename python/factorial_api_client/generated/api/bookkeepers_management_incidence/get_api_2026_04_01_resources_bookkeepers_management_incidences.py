...
from ...models.get_api_20260401_resources_bookkeepers_management_incidences_response_200 import (
...
) -> GetApi20260401ResourcesBookkeepersManagementIncidencesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesBookkeepersManagementIncidencesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesBookkeepersManagementIncidencesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        employee_ids (list[int] | Unset): A list of employee identifiers. Example: [1, 2, 3].
