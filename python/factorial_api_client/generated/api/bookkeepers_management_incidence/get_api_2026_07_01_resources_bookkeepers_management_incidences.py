...
from ...models.get_api_20260701_resources_bookkeepers_management_incidences_response_200 import (
...
) -> GetApi20260701ResourcesBookkeepersManagementIncidencesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesBookkeepersManagementIncidencesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesBookkeepersManagementIncidencesResponse200]:
    return Response(
