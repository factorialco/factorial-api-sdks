...
from ...models.get_api_20251001_resources_bookkeepers_management_incidences_response_200 import (
...
) -> GetApi20251001ResourcesBookkeepersManagementIncidencesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesBookkeepersManagementIncidencesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesBookkeepersManagementIncidencesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): A list of incidence identifiers. Example: [1, 2, 3].
        legal_entities_ids (list[int] | Unset): A list of legal entities identifiers. Example: [1,
            2, 3].
        ...
        type_ (list[str] | Unset): A list of types. It can be any of the following address, bank,
            cost_center, contract, gender, hiring, id, irpf, legal_entity, manual_incidence, name,
            nationality, parental, phone_number, sick, tax_id, termination, workplace Example:
            ['hiring', 'workplace'].
        sort_by (str | Unset):
        direction (str | Unset):
        ...
        custom_leave_name (list[str] | Unset):
