...
from ...models.post_api_20260701_resources_locations_work_areas_unarchive_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesLocationsWorkAreasUnarchiveBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesLocationsWorkAreasUnarchiveBody | Unset):
