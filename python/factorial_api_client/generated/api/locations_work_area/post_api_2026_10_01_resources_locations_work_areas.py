...
from ...models.post_api_20261001_resources_locations_work_areas_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesLocationsWorkAreasBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesLocationsWorkAreasBody | Unset):
