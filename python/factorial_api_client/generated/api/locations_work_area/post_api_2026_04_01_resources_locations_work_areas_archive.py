...
from ...models.post_api_20260401_resources_locations_work_areas_archive_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesLocationsWorkAreasArchiveBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesLocationsWorkAreasArchiveBody | Unset):
