...
from ...models.post_api_20261001_resources_documents_download_urls_bulk_create_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesDocumentsDownloadUrlsBulkCreateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Bulk creates a Download url
     ...
     This endpoint generates temporary urls for a list of between 1 and 100 documents. The urls let you
    download the documents.

    Args:
        body (PostApi20261001ResourcesDocumentsDownloadUrlsBulkCreateBody | Unset):
