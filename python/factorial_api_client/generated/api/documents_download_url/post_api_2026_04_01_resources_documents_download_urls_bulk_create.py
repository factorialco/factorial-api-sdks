...
from ...models.post_api_20260401_resources_documents_download_urls_bulk_create_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesDocumentsDownloadUrlsBulkCreateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesDocumentsDownloadUrlsBulkCreateBody | Unset):
