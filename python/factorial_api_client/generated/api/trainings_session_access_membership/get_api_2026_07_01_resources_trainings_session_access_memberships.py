...
from ...models.get_api_20260701_resources_trainings_session_access_memberships_response_200 import (
...
) -> GetApi20260701ResourcesTrainingsSessionAccessMembershipsResponse200 | None:
    if response.status_code == 200:
        response_200 = (
            GetApi20260701ResourcesTrainingsSessionAccessMembershipsResponse200.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesTrainingsSessionAccessMembershipsResponse200]:
    return Response(
