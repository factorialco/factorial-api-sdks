...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/2026-10-01/resources/contracts/spanish_professional_categories/{id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ContractsSpanishProfessionalCategory.from_dict(response.json())
