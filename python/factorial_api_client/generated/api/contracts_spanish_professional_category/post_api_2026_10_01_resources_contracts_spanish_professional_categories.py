...
from ...models.post_api_20261001_resources_contracts_spanish_professional_categories_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesContractsSpanishProfessionalCategoriesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesContractsSpanishProfessionalCategoriesBody | Unset):
