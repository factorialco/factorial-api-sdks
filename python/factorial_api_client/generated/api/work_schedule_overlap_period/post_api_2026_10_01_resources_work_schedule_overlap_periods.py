...
from ...models.post_api_20261001_resources_work_schedule_overlap_periods_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesWorkScheduleOverlapPeriodsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesWorkScheduleOverlapPeriodsBody | Unset):
