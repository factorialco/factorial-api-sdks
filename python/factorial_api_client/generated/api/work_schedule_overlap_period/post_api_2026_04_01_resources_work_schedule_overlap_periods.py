...
from ...models.post_api_20260401_resources_work_schedule_overlap_periods_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesWorkScheduleOverlapPeriodsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesWorkScheduleOverlapPeriodsBody | Unset):
