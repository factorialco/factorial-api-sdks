...
from ...models.get_api_20261001_resources_trainings_sessions_response_200 import (
...
def _get_kwargs(
    *,
    ...
    training_ids: list[str] | Unset = UNSET,
    ...
    json_training_ids: list[str] | Unset = UNSET
...
) -> GetApi20261001ResourcesTrainingsSessionsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesTrainingsSessionsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesTrainingsSessionsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): This field is used to filter those sessions whose id match with
            the given. Example: ['1'].
        training_ids (list[str] | Unset): This field is used to filter those sessions whose belong
        ...
        access_id (str | Unset): access_id associated to the employee, refers to
            employees/employees endpoint.
        employee_id (str | Unset): employee_id associated to the employee, refers to
