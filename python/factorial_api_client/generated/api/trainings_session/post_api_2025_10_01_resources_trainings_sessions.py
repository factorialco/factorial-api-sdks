...
from ...models.post_api_20251001_resources_trainings_sessions_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesTrainingsSessionsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20251001ResourcesTrainingsSessionsBody | Unset):
