...
from ...models.get_api_20260701_resources_attendance_estimated_times_response_200 import (
...
) -> GetApi20260701ResourcesAttendanceEstimatedTimesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesAttendanceEstimatedTimesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesAttendanceEstimatedTimesResponse200]:
    return Response(
