...
from ...models.put_api_20251001_resources_project_management_projects_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20251001ResourcesProjectManagementProjectsIdBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20251001ResourcesProjectManagementProjectsIdBody | Unset):
