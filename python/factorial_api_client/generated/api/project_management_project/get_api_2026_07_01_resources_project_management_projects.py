...
from ...models.get_api_20260701_resources_project_management_projects_response_200 import (
...
def _get_kwargs(
    *,
    ...
    json_client_ids: list[str] | Unset = UNSET
...
) -> GetApi20260701ResourcesProjectManagementProjectsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesProjectManagementProjectsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesProjectManagementProjectsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Retrieve only the projects that matches the ids provided in the
        ...
        legal_entity_id (str | Unset): Retrieve only the projects that are related to the legal
            entity passed in the request. Example: 123.
        client_ids (list[str] | Unset): Retrieve only the projects that are related to the clients
