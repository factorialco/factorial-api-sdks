...
from ...models.post_api_20260401_resources_project_management_projects_change_assignment_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesProjectManagementProjectsChangeAssignmentBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesProjectManagementProjectsChangeAssignmentBody | Unset):
