...
from ...models.post_api_20261001_resources_performance_review_questionnaire_by_strategies_update_default_rating_scale_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateDefaultRatingScaleBody
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateDefaultRatin
            gScaleBody | Unset):
