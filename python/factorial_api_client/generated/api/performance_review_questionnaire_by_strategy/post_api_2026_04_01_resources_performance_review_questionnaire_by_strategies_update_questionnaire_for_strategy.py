...
from ...models.post_api_20260401_resources_performance_review_questionnaire_by_strategies_update_questionnaire_for_strategy_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateQuestionnaireForStrategyBody
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesPerformanceReviewQuestionnaireByStrategiesUpdateQuestionnair
