...
from ...models.get_api_20260401_resources_employees_employees_response_200 import (
...
) -> GetApi20260401ResourcesEmployeesEmployeesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesEmployeesEmployeesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesEmployeesEmployeesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): filter by employee ids. Example: [1, 2, 3].
        access_ids (list[int] | Unset): filter by employee access ids. Example: [1, 2, 3].
        ...
        updated_at_gteq (str | Unset): Filter employees updated on or after this timestamp
            (greater than or equal). Example: 2024-01-01.
        legal_entity_ids (list[int] | Unset): filter by legal entity id (refereces to
        ...
        team_ids (list[int] | Unset): filter employees by team id (references to core/teams).
            Example: [1, 2].
        location_ids (list[int] | Unset): filter employees by location id (references to
