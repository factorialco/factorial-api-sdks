...
from ...models.post_api_20260401_resources_project_management_flexible_time_record_comments_update_by_flexible_time_record_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesProjectManagementFlexibleTimeRecordCommentsUpdateByFlexibleTimeRecordBody
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesProjectManagementFlexibleTimeRecordCommentsUpdateByFlexibleT
            imeRecordBody | Unset):
