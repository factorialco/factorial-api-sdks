...
from ...models.post_api_20260401_resources_project_management_flexible_time_record_comments_delete_by_flexible_time_record_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesProjectManagementFlexibleTimeRecordCommentsDeleteByFlexibleTimeRecordBody
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesProjectManagementFlexibleTimeRecordCommentsDeleteByFlexibleT
            imeRecordBody | Unset):
