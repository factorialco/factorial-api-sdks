...
from ...models.post_api_20260701_resources_teams_teams_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesTeamsTeamsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesTeamsTeamsBody | Unset):
