...
from ...models.put_api_20261001_resources_project_management_planned_records_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20261001ResourcesProjectManagementPlannedRecordsIdBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/2026-10-01/resources/project_management/planned_records/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20261001ResourcesProjectManagementPlannedRecordsIdBody | Unset):
