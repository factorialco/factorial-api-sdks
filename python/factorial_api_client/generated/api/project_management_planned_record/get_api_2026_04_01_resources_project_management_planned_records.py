...
from ...models.get_api_20260401_resources_project_management_planned_records_response_200 import (
...
) -> GetApi20260401ResourcesProjectManagementPlannedRecordsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesProjectManagementPlannedRecordsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesProjectManagementPlannedRecordsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): Retrieve only the planned records that matches the ids provided
            in the request. Example: [314159].
        project_worker_ids (list[int] | Unset): Retrieve only the planned records that matches the
        ...
        subproject_ids (list[int] | Unset): Retrieve only the planned records that matches the
