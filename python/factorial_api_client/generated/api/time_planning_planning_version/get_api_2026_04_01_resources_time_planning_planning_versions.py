...
from ...models.get_api_20260401_resources_time_planning_planning_versions_planning_tool import (
    GetApi20260401ResourcesTimePlanningPlanningVersionsPlanningTool,
)
from ...models.get_api_20260401_resources_time_planning_planning_versions_response_200 import (
...
def _get_kwargs(
    *,
    ...
    only_active: bool,
    planning_tool: GetApi20260401ResourcesTimePlanningPlanningVersionsPlanningTool | Unset = UNSET,
...
) -> GetApi20260401ResourcesTimePlanningPlanningVersionsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesTimePlanningPlanningVersionsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesTimePlanningPlanningVersionsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        planning_tool (GetApi20260401ResourcesTimePlanningPlanningVersionsPlanningTool | Unset):
