...
from ...models.post_api_20260401_resources_time_planning_planning_versions_bulk_create_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesTimePlanningPlanningVersionsBulkCreateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesTimePlanningPlanningVersionsBulkCreateBody | Unset):
