...
from ...models.post_api_20260701_resources_time_planning_planning_versions_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesTimePlanningPlanningVersionsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesTimePlanningPlanningVersionsBody | Unset):
