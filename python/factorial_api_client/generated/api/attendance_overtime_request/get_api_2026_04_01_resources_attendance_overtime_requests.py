...
from ...models.get_api_20260401_resources_attendance_overtime_requests_response_200 import (
    GetApi20260401ResourcesAttendanceOvertimeRequestsResponse200,
)
from ...models.get_api_20260401_resources_attendance_overtime_requests_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20260401ResourcesAttendanceOvertimeRequestsStatus | Unset = UNSET,
...
) -> GetApi20260401ResourcesAttendanceOvertimeRequestsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesAttendanceOvertimeRequestsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesAttendanceOvertimeRequestsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        start_on (str | Unset):
        end_on (str | Unset):
        status (GetApi20260401ResourcesAttendanceOvertimeRequestsStatus | Unset):
        include_approval_flow (bool):
