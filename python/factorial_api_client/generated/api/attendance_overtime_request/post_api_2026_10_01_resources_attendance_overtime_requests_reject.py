...
from ...models.post_api_20261001_resources_attendance_overtime_requests_reject_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesAttendanceOvertimeRequestsRejectBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesAttendanceOvertimeRequestsRejectBody | Unset):
