...
from ...models.post_api_20261001_resources_tasks_task_files_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesTasksTaskFilesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesTasksTaskFilesBody | Unset):
