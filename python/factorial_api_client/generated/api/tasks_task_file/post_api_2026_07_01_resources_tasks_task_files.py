...
from ...models.post_api_20260701_resources_tasks_task_files_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesTasksTaskFilesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesTasksTaskFilesBody | Unset):
