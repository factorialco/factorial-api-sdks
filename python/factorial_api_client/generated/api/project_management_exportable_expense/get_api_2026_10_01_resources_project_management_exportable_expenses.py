...
from ...models.get_api_20261001_resources_project_management_exportable_expenses_response_200 import (
...
) -> GetApi20261001ResourcesProjectManagementExportableExpensesResponse200 | None:
    if response.status_code == 200:
        response_200 = (
            GetApi20261001ResourcesProjectManagementExportableExpensesResponse200.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesProjectManagementExportableExpensesResponse200]:
    return Response(
