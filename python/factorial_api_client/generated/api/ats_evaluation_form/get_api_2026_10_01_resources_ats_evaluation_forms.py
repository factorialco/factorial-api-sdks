...
from ...models.get_api_20261001_resources_ats_evaluation_forms_response_200 import (
...
def _get_kwargs(
    *,
    ...
    json_ats_job_posting_ids: list[str] | Unset = UNSET
...
) -> GetApi20261001ResourcesAtsEvaluationFormsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesAtsEvaluationFormsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesAtsEvaluationFormsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): List of IDs of the evaluation forms to be fetched. Example: ['1',
            '2', '3'].
        ats_job_posting_ids (list[str] | Unset): List of IDs of the job postings to filter the
