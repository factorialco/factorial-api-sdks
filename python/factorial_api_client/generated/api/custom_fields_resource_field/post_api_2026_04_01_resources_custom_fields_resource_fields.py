...
from ...models.post_api_20260401_resources_custom_fields_resource_fields_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesCustomFieldsResourceFieldsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesCustomFieldsResourceFieldsBody | Unset):
