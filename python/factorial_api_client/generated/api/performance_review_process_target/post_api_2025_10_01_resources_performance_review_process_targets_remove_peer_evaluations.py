...
from ...models.post_api_20251001_resources_performance_review_process_targets_remove_peer_evaluations_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesPerformanceReviewProcessTargetsRemovePeerEvaluationsBody
    | Unset = UNSET,
) -> dict[str, Any]:
