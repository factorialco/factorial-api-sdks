...
from ...models.get_api_20261001_resources_performance_review_process_targets_agreement_completion_status import (
    GetApi20261001ResourcesPerformanceReviewProcessTargetsAgreementCompletionStatus,
)
from ...models.get_api_20261001_resources_performance_review_process_targets_managed_by_filter import (
    GetApi20261001ResourcesPerformanceReviewProcessTargetsManagedByFilter,
)
from ...models.get_api_20261001_resources_performance_review_process_targets_response_200 import (
...
def _get_kwargs(
    *,
    ...
    agreement_completion_status: GetApi20261001ResourcesPerformanceReviewProcessTargetsAgreementCompletionStatus
    | Unset = UNSET,
    pending_peer_evaluations: bool | Unset = UNSET,
    managed_by_filter: GetApi20261001ResourcesPerformanceReviewProcessTargetsManagedByFilter
    | Unset = UNSET,
) -> dict[str, Any]:
...
) -> GetApi20261001ResourcesPerformanceReviewProcessTargetsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesPerformanceReviewProcessTargetsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesPerformanceReviewProcessTargetsResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        agreement_completion_status
            (GetApi20261001ResourcesPerformanceReviewProcessTargetsAgreementCompletionStatus | Unset):
