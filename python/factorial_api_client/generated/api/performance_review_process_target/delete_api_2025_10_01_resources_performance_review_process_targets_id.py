...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/2025-10-01/resources/performance/review_process_targets/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Deletes a Review process target
     ...
     Delete a participant from the active review process. This will also remove all previously submitted
    evaluations about the participant.
