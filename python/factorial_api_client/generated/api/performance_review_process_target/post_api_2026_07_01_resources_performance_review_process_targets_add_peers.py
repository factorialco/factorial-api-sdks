...
from ...models.post_api_20260701_resources_performance_review_process_targets_add_peers_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesPerformanceReviewProcessTargetsAddPeersBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesPerformanceReviewProcessTargetsAddPeersBody | Unset):
