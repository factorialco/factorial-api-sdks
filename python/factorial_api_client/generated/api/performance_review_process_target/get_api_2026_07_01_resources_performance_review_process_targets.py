...
from ...models.get_api_20260701_resources_performance_review_process_targets_agreement_completion_status import (
    GetApi20260701ResourcesPerformanceReviewProcessTargetsAgreementCompletionStatus,
)
from ...models.get_api_20260701_resources_performance_review_process_targets_managed_by_filter import (
    GetApi20260701ResourcesPerformanceReviewProcessTargetsManagedByFilter,
)
from ...models.get_api_20260701_resources_performance_review_process_targets_response_200 import (
...
def _get_kwargs(
    *,
    ...
    agreement_completion_status: GetApi20260701ResourcesPerformanceReviewProcessTargetsAgreementCompletionStatus
    | Unset = UNSET,
    pending_peer_evaluations: bool | Unset = UNSET,
    managed_by_filter: GetApi20260701ResourcesPerformanceReviewProcessTargetsManagedByFilter
    | Unset = UNSET,
) -> dict[str, Any]:
...
) -> GetApi20260701ResourcesPerformanceReviewProcessTargetsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesPerformanceReviewProcessTargetsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesPerformanceReviewProcessTargetsResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        agreement_completion_status
            (GetApi20260701ResourcesPerformanceReviewProcessTargetsAgreementCompletionStatus | Unset):
