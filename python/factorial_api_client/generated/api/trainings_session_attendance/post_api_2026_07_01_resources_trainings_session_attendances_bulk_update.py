...
from ...models.post_api_20260701_resources_trainings_session_attendances_bulk_update_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesTrainingsSessionAttendancesBulkUpdateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesTrainingsSessionAttendancesBulkUpdateBody | Unset):
