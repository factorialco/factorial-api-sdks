...
from ...models.post_api_20261001_resources_ats_job_postings_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesAtsJobPostingsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesAtsJobPostingsBody | Unset):
