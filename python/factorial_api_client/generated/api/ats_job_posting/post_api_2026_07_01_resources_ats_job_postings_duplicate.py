...
from ...models.post_api_20260701_resources_ats_job_postings_duplicate_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesAtsJobPostingsDuplicateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesAtsJobPostingsDuplicateBody | Unset):
