...
from ...models.post_api_20260701_resources_approvals_materialized_approvals_flows_reject_resource_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesApprovalsMaterializedApprovalsFlowsRejectResourceBody
    | Unset = UNSET,
) -> dict[str, Any]:
