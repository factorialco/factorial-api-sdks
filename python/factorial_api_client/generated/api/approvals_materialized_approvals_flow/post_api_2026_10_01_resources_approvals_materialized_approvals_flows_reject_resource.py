...
from ...models.post_api_20261001_resources_approvals_materialized_approvals_flows_reject_resource_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesApprovalsMaterializedApprovalsFlowsRejectResourceBody
    | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Rejects an approval flow by resource
     ...
     Rejects the current pending step of an approval flow identified by resource_id and resource_type,
