...
from ...models.get_api_20251001_resources_performance_review_process_estimated_targets_response_200 import (
...
) -> GetApi20251001ResourcesPerformanceReviewProcessEstimatedTargetsResponse200 | None:
    if response.status_code == 200:
        response_200 = (
            GetApi20251001ResourcesPerformanceReviewProcessEstimatedTargetsResponse200.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesPerformanceReviewProcessEstimatedTargetsResponse200]:
    return Response(
