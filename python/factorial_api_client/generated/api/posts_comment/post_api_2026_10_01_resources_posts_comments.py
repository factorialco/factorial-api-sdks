...
from ...models.post_api_20261001_resources_posts_comments_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPostsCommentsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPostsCommentsBody | Unset):
