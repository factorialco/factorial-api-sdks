...
from ...models.post_api_20261001_resources_it_management_it_asset_models_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesItManagementItAssetModelsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesItManagementItAssetModelsBody | Unset):
