...
from ...models.post_api_20260401_resources_it_management_it_asset_models_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesItManagementItAssetModelsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ItManagementItAssetModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesItManagementItAssetModelsBody | Unset):
