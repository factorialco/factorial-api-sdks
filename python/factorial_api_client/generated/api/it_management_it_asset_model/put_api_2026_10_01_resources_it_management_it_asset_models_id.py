...
from ...models.put_api_20261001_resources_it_management_it_asset_models_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20261001ResourcesItManagementItAssetModelsIdBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/2026-10-01/resources/it_management/it_asset_models/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20261001ResourcesItManagementItAssetModelsIdBody | Unset):
