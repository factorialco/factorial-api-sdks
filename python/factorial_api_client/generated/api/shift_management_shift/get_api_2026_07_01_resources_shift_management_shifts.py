...
from ...models.get_api_20260701_resources_shift_management_shifts_only_states import (
    GetApi20260701ResourcesShiftManagementShiftsOnlyStates,
)
from ...models.get_api_20260701_resources_shift_management_shifts_response_200 import (
...
def _get_kwargs(
    *,
    ...
    only_states: GetApi20260701ResourcesShiftManagementShiftsOnlyStates | Unset = UNSET,
...
) -> GetApi20260701ResourcesShiftManagementShiftsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesShiftManagementShiftsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesShiftManagementShiftsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        only_states (GetApi20260701ResourcesShiftManagementShiftsOnlyStates | Unset): Filter
