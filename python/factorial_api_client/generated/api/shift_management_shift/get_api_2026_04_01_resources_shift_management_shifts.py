...
from ...models.get_api_20260401_resources_shift_management_shifts_only_states import (
    GetApi20260401ResourcesShiftManagementShiftsOnlyStates,
)
from ...models.get_api_20260401_resources_shift_management_shifts_response_200 import (
...
def _get_kwargs(
    *,
    ...
    only_states: GetApi20260401ResourcesShiftManagementShiftsOnlyStates | Unset = UNSET,
...
) -> GetApi20260401ResourcesShiftManagementShiftsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesShiftManagementShiftsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesShiftManagementShiftsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): Filter shifts by their unique identifiers. Returns only shifts
            matching the provided IDs. If an empty array is provided, returns no results Example: [1].
        without_ids (list[int] | Unset): Exclude shifts with these identifiers from the results.
            Useful for filtering out specific shifts while keeping others Example: [3].
        employee_ids (list[int] | Unset): Filter shifts by employee identifiers. Returns only
            shifts assigned to the specified employees. If not provided, returns shifts for all
            accessible employees Example: [1].
        location_ids (list[int] | Unset): Filter shifts by location identifiers. Returns shifts
        ...
        only_states (GetApi20260401ResourcesShiftManagementShiftsOnlyStates | Unset): Filter
