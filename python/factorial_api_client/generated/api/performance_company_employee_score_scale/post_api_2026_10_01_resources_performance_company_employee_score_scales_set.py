...
from ...models.post_api_20261001_resources_performance_company_employee_score_scales_set_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceCompanyEmployeeScoreScalesSetBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPerformanceCompanyEmployeeScoreScalesSetBody | Unset):
