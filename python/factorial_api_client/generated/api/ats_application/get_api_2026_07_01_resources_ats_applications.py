...
from ...models.get_api_20260701_resources_ats_applications_response_200 import (
...
def _get_kwargs(
    *,
    ...
    ats_candidate_ids: list[str] | Unset = UNSET,
    ats_rejection_reason_ids: list[str] | Unset = UNSET,
    search: str | Unset = UNSET,
    ats_tags_ids: list[str] | Unset = UNSET,
) -> dict[str, Any]:
    ...
    json_ats_candidate_ids: list[str] | Unset = UNSET
    ...
    json_ats_rejection_reason_ids: list[str] | Unset = UNSET
    ...
    json_ats_tags_ids: list[str] | Unset = UNSET
...
) -> GetApi20260701ResourcesAtsApplicationsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesAtsApplicationsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesAtsApplicationsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Application ids to retrieve Example: ['1', '2'].
        ats_job_posting_id (str | Unset): Application job posting id to retrieve Example: 1.
        qualified (bool | Unset): Retrieve applications by their qualified status Example: True.
        ats_application_phase_id (str | Unset): Application phase id Example: 1.
        ats_candidate_ids (list[str] | Unset): Application candidates ids Example: ['1'].
        ats_rejection_reason_ids (list[str] | Unset): Application rejection reason ids Example:
            ['1'].
        search (str | Unset): Application search Example: application.
        ats_tags_ids (list[str] | Unset): Application tag ids Example: ['1'].
