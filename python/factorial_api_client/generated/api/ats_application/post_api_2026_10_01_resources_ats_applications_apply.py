...
from ...models.post_api_20261001_resources_ats_applications_apply_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesAtsApplicationsApplyBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesAtsApplicationsApplyBody | Unset):
