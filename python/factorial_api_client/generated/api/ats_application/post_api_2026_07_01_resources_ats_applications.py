...
from ...models.post_api_20260701_resources_ats_applications_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesAtsApplicationsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesAtsApplicationsBody | Unset):
