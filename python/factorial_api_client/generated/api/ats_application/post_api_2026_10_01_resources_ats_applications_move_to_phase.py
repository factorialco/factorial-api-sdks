...
from ...models.post_api_20261001_resources_ats_applications_move_to_phase_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesAtsApplicationsMoveToPhaseBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesAtsApplicationsMoveToPhaseBody | Unset):
