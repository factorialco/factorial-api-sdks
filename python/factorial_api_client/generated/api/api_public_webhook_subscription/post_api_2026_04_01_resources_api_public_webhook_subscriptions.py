...
from ...models.post_api_20260401_resources_api_public_webhook_subscriptions_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesApiPublicWebhookSubscriptionsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesApiPublicWebhookSubscriptionsBody | Unset):
