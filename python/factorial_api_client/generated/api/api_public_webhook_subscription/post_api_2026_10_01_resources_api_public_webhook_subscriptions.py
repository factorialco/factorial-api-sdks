...
from ...models.post_api_20261001_resources_api_public_webhook_subscriptions_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesApiPublicWebhookSubscriptionsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesApiPublicWebhookSubscriptionsBody | Unset):
