...
from ...models.get_api_20251001_resources_finance_accounts_response_200 import (
...
) -> GetApi20251001ResourcesFinanceAccountsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesFinanceAccountsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesFinanceAccountsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): Search ledger accounts by ID Example: [1].
        legal_entity_ids (list[int] | Unset): Search ledger accounts by legal_entity_id Example:
            [11].
