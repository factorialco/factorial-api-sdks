...
from ...models.get_api_20251001_resources_ats_candidates_response_200 import (
...
def _get_kwargs(
    *,
    ...
    job_posting_ids: list[int] | Unset = UNSET,
    ...
    json_job_posting_ids: list[int] | Unset = UNSET
...
) -> GetApi20251001ResourcesAtsCandidatesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesAtsCandidatesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesAtsCandidatesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): list of candidate identifiers. Example: [1, 2, 3].
        emails (list[str] | Unset): list of candidate emails. Example: ['ana@factorial.com',
            'juan@factorial.com'].
        team_ids (list[int] | Unset): list of team identifiers, refers to teams/teams endpoint.
            Example: [1, 2, 3].
        location_ids (list[int] | Unset): list of location identifiers, refers to
        ...
        job_posting_ids (list[int] | Unset): list of job posting identifiers, refers to
