...
from ...models.get_api_20260701_resources_payroll_integrations_base_codes_integrations import (
    GetApi20260701ResourcesPayrollIntegrationsBaseCodesIntegrations,
)
from ...models.get_api_20260701_resources_payroll_integrations_base_codes_response_200 import (
...
def _get_kwargs(
    *,
    ...
    integrations: GetApi20260701ResourcesPayrollIntegrationsBaseCodesIntegrations,
...
) -> GetApi20260701ResourcesPayrollIntegrationsBaseCodesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesPayrollIntegrationsBaseCodesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesPayrollIntegrationsBaseCodesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        integrations (GetApi20260701ResourcesPayrollIntegrationsBaseCodesIntegrations): Payroll
