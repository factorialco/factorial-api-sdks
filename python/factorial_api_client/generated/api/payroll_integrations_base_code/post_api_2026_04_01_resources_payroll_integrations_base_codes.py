...
from ...models.post_api_20260401_resources_payroll_integrations_base_codes_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesPayrollIntegrationsBaseCodesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesPayrollIntegrationsBaseCodesBody | Unset):
