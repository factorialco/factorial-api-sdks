...
from ...models.post_api_20261001_resources_contracts_spanish_working_day_types_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesContractsSpanishWorkingDayTypesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesContractsSpanishWorkingDayTypesBody | Unset):
