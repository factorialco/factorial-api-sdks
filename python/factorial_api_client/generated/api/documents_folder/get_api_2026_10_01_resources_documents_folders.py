...
from ...models.get_api_20261001_resources_documents_folders_response_200 import (
...
) -> GetApi20261001ResourcesDocumentsFoldersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesDocumentsFoldersResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesDocumentsFoldersResponse200]:
    return Response(
