...
from ...models.post_api_20261001_resources_performance_agreements_bulk_initiate_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceAgreementsBulkInitiateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPerformanceAgreementsBulkInitiateBody | Unset):
