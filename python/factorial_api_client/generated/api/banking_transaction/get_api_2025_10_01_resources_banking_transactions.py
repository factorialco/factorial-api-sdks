...
from ...models.get_api_20251001_resources_banking_transactions_response_200 import (
...
) -> GetApi20251001ResourcesBankingTransactionsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesBankingTransactionsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesBankingTransactionsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): An array of transaction IDs to filter by. Example: [135].
        account_ids (list[int] | Unset): An array of Factorial Banking Bank Account IDs to filter
            by. Example: [357].
        card_payment_ids (list[int] | Unset): An array of Factorial Card Payment IDs to filter by.
            Example: [135].
