...
from ...models.put_api_20261001_resources_project_management_subprojects_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20261001ResourcesProjectManagementSubprojectsIdBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20261001ResourcesProjectManagementSubprojectsIdBody | Unset):
