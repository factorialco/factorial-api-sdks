...
from ...models.get_api_20261001_resources_banking_card_payments_response_200 import (
    GetApi20261001ResourcesBankingCardPaymentsResponse200,
)
from ...models.get_api_20261001_resources_banking_card_payments_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20261001ResourcesBankingCardPaymentsStatus | Unset = UNSET,
...
) -> GetApi20261001ResourcesBankingCardPaymentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesBankingCardPaymentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesBankingCardPaymentsResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        account_ids (list[str] | Unset): An array of banking accounts ID to filter Example:
            ['123'].
        status (GetApi20261001ResourcesBankingCardPaymentsStatus | Unset): The status of the card
