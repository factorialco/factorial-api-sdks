...
from ...models.get_api_20260401_resources_banking_card_payments_response_200 import (
    GetApi20260401ResourcesBankingCardPaymentsResponse200,
)
from ...models.get_api_20260401_resources_banking_card_payments_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20260401ResourcesBankingCardPaymentsStatus | Unset = UNSET,
...
) -> GetApi20260401ResourcesBankingCardPaymentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesBankingCardPaymentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesBankingCardPaymentsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (GetApi20260401ResourcesBankingCardPaymentsStatus | Unset): The status of the card
