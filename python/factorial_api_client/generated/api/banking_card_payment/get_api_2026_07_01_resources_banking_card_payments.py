...
from ...models.get_api_20260701_resources_banking_card_payments_response_200 import (
    GetApi20260701ResourcesBankingCardPaymentsResponse200,
)
from ...models.get_api_20260701_resources_banking_card_payments_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20260701ResourcesBankingCardPaymentsStatus | Unset = UNSET,
...
) -> GetApi20260701ResourcesBankingCardPaymentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesBankingCardPaymentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesBankingCardPaymentsResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        account_ids (list[str] | Unset): An array of banking accounts ID to filter Example:
            ['123'].
        status (GetApi20260701ResourcesBankingCardPaymentsStatus | Unset): The status of the card
