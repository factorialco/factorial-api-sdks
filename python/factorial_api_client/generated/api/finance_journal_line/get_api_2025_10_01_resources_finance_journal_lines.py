...
from ...models.get_api_20251001_resources_finance_journal_lines_journal_entry_types import (
    GetApi20251001ResourcesFinanceJournalLinesJournalEntryTypes,
)
from ...models.get_api_20251001_resources_finance_journal_lines_reconciliation_status import (
    GetApi20251001ResourcesFinanceJournalLinesReconciliationStatus,
)
from ...models.get_api_20251001_resources_finance_journal_lines_response_200 import (
...
def _get_kwargs(
    *,
    ...
    journal_entry_ids: list[int] | Unset = UNSET,
    account_ids: list[int] | Unset = UNSET,
    journal_entry_types: GetApi20251001ResourcesFinanceJournalLinesJournalEntryTypes
    | Unset = UNSET,
    reconciliation_status: GetApi20251001ResourcesFinanceJournalLinesReconciliationStatus
    | Unset = UNSET,
    ...
    json_journal_entry_ids: list[int] | Unset = UNSET
...
) -> GetApi20251001ResourcesFinanceJournalLinesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesFinanceJournalLinesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesFinanceJournalLinesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): Filter by specific JournalLine IDs Example: [1234].
        journal_entry_ids (list[int] | Unset): Filter by specific JournalEntry IDs Example:
            [4321].
        account_ids (list[int] | Unset): Filter by specific Account IDs Example: [9876].
        journal_entry_types (GetApi20251001ResourcesFinanceJournalLinesJournalEntryTypes | Unset):
