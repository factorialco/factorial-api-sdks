...
from ...models.get_api_20261001_resources_finance_journal_lines_journal_entry_types import (
    GetApi20261001ResourcesFinanceJournalLinesJournalEntryTypes,
)
from ...models.get_api_20261001_resources_finance_journal_lines_reconciliation_status import (
    GetApi20261001ResourcesFinanceJournalLinesReconciliationStatus,
)
from ...models.get_api_20261001_resources_finance_journal_lines_response_200 import (
...
def _get_kwargs(
    *,
    ...
    journal_entry_types: GetApi20261001ResourcesFinanceJournalLinesJournalEntryTypes
    | Unset = UNSET,
    reconciliation_status: GetApi20261001ResourcesFinanceJournalLinesReconciliationStatus
    | Unset = UNSET,
...
) -> GetApi20261001ResourcesFinanceJournalLinesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceJournalLinesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceJournalLinesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        journal_entry_types (GetApi20261001ResourcesFinanceJournalLinesJournalEntryTypes | Unset):
