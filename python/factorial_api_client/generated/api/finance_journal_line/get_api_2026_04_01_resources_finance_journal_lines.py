...
from ...models.get_api_20260401_resources_finance_journal_lines_journal_entry_types import (
    GetApi20260401ResourcesFinanceJournalLinesJournalEntryTypes,
)
from ...models.get_api_20260401_resources_finance_journal_lines_reconciliation_status import (
    GetApi20260401ResourcesFinanceJournalLinesReconciliationStatus,
)
from ...models.get_api_20260401_resources_finance_journal_lines_response_200 import (
...
def _get_kwargs(
    *,
    ...
    journal_entry_types: GetApi20260401ResourcesFinanceJournalLinesJournalEntryTypes
    | Unset = UNSET,
    reconciliation_status: GetApi20260401ResourcesFinanceJournalLinesReconciliationStatus
    | Unset = UNSET,
...
) -> GetApi20260401ResourcesFinanceJournalLinesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesFinanceJournalLinesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesFinanceJournalLinesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        journal_entry_types (GetApi20260401ResourcesFinanceJournalLinesJournalEntryTypes | Unset):
