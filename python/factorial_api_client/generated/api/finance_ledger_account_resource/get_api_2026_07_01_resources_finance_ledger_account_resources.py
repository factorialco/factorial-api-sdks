...
from ...models.get_api_20260701_resources_finance_ledger_account_resources_resource_type import (
    GetApi20260701ResourcesFinanceLedgerAccountResourcesResourceType,
)
from ...models.get_api_20260701_resources_finance_ledger_account_resources_response_200 import (
...
def _get_kwargs(
    *,
    ...
    resource_type: GetApi20260701ResourcesFinanceLedgerAccountResourcesResourceType | Unset = UNSET,
...
) -> GetApi20260701ResourcesFinanceLedgerAccountResourcesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesFinanceLedgerAccountResourcesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesFinanceLedgerAccountResourcesResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        resource_ids (list[str] | Unset): Filter ledger account resources by resource ID Example:
            ['155'].
        resource_type (GetApi20260701ResourcesFinanceLedgerAccountResourcesResourceType | Unset):
