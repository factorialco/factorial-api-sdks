...
from ...models.post_api_20260401_resources_finance_ledger_account_resources_upsert_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesFinanceLedgerAccountResourcesUpsertBody | Unset):
