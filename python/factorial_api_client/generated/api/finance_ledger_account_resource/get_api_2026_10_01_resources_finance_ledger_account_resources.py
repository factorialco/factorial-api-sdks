...
from ...models.get_api_20261001_resources_finance_ledger_account_resources_resource_type import (
    GetApi20261001ResourcesFinanceLedgerAccountResourcesResourceType,
)
from ...models.get_api_20261001_resources_finance_ledger_account_resources_response_200 import (
...
def _get_kwargs(
    *,
    ...
    resource_type: GetApi20261001ResourcesFinanceLedgerAccountResourcesResourceType | Unset = UNSET,
    legal_entity_ids: list[str] | Unset = UNSET,
    updated_from: str | Unset = UNSET,
    finance_account_ids: list[str] | Unset = UNSET,
) -> dict[str, Any]:
    ...
    json_finance_account_ids: list[str] | Unset = UNSET
...
) -> GetApi20261001ResourcesFinanceLedgerAccountResourcesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceLedgerAccountResourcesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceLedgerAccountResourcesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Search ledger account resources by ID Example: ['135'].
        resource_ids (list[str] | Unset): Filter ledger account resources by resource ID Example:
            ['155'].
        resource_type (GetApi20261001ResourcesFinanceLedgerAccountResourcesResourceType | Unset):
            Filter ledger account resources by resource type Example: taxtype.
        legal_entity_ids (list[str] | Unset): Filter ledger account resources by legal entity ID
            Example: ['13'].
        updated_from (str | Unset): Filter ledger account resources by updated at Example:
            2021-01-01.
        finance_account_ids (list[str] | Unset): Filter ledger account resources by finance
