...
from ...models.get_api_20260401_resources_trainings_training_memberships_response_200 import (
...
) -> GetApi20260401ResourcesTrainingsTrainingMembershipsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesTrainingsTrainingMembershipsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesTrainingsTrainingMembershipsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        training_id (int | Unset): This field is used to filter those trainings memberships that
