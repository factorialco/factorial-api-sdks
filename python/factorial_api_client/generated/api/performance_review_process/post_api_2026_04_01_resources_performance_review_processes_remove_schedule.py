...
from ...models.post_api_20260401_resources_performance_review_processes_remove_schedule_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesPerformanceReviewProcessesRemoveScheduleBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesPerformanceReviewProcessesRemoveScheduleBody | Unset):
