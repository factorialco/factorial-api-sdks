...
from ...models.post_api_20261001_resources_performance_review_processes_update_reviewer_strategies_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceReviewProcessesUpdateReviewerStrategiesBody
    | Unset = UNSET,
) -> dict[str, Any]:
