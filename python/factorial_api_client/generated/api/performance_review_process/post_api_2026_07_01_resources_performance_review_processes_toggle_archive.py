...
from ...models.post_api_20260701_resources_performance_review_processes_toggle_archive_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesPerformanceReviewProcessesToggleArchiveBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesPerformanceReviewProcessesToggleArchiveBody | Unset):
