...
from ...models.post_api_20260401_resources_performance_review_processes_update_agreements_configuration_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesPerformanceReviewProcessesUpdateAgreementsConfigurationBody
    | Unset = UNSET,
) -> dict[str, Any]:
