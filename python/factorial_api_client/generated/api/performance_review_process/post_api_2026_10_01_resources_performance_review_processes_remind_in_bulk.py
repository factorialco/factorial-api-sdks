...
from ...models.post_api_20261001_resources_performance_review_processes_remind_in_bulk_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceReviewProcessesRemindInBulkBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPerformanceReviewProcessesRemindInBulkBody | Unset):
