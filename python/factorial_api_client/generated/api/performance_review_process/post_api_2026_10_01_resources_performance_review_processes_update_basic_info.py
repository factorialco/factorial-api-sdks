...
from ...models.post_api_20261001_resources_performance_review_processes_update_basic_info_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceReviewProcessesUpdateBasicInfoBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPerformanceReviewProcessesUpdateBasicInfoBody | Unset):
