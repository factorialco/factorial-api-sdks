...
from ...models.post_api_20261001_resources_performance_review_processes_update_agreements_configuration_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPerformanceReviewProcessesUpdateAgreementsConfigurationBody
    | Unset = UNSET,
) -> dict[str, Any]:
