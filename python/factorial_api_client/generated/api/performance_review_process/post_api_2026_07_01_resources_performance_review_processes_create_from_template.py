...
from ...models.post_api_20260701_resources_performance_review_processes_create_from_template_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesPerformanceReviewProcessesCreateFromTemplateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesPerformanceReviewProcessesCreateFromTemplateBody | Unset):
