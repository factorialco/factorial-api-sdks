...
from ...models.post_api_20260401_resources_marketplace_installations_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesMarketplaceInstallationsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesMarketplaceInstallationsBody | Unset):
