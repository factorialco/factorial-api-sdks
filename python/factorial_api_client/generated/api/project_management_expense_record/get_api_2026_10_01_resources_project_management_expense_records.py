...
from ...models.get_api_20261001_resources_project_management_expense_records_response_200 import (
...
def _get_kwargs(
    *,
    ...
    expense_ids: list[str] | Unset = UNSET,
    ...
    json_expense_ids: list[str] | Unset = UNSET
...
) -> GetApi20261001ResourcesProjectManagementExpenseRecordsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesProjectManagementExpenseRecordsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesProjectManagementExpenseRecordsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Retrieve only the expense records that matches the project ids
        ...
        expense_ids (list[str] | Unset): Retrieve only the expense records that matches the
            expense ids provided in the request. Example: ['123', '456'].
        project_ids (list[str] | Unset): Retrieve only the expense records that matches the
            project ids provided in the request. Example: ['123', '456'].
        subproject_ids (list[str] | Unset): Retrieve only the expense records that matches the
        ...
        project_worker_ids (list[str] | Unset): Retrieve only the expense records that matches the
