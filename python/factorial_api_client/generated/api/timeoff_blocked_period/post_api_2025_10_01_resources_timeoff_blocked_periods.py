...
from ...models.post_api_20251001_resources_timeoff_blocked_periods_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesTimeoffBlockedPeriodsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20251001ResourcesTimeoffBlockedPeriodsBody | Unset):
