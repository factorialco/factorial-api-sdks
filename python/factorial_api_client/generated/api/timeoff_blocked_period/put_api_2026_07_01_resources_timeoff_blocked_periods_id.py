...
from ...models.put_api_20260701_resources_timeoff_blocked_periods_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20260701ResourcesTimeoffBlockedPeriodsIdBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/2026-07-01/resources/timeoff/blocked_periods/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20260701ResourcesTimeoffBlockedPeriodsIdBody | Unset):
