...
from ...models.get_api_20261001_resources_contracts_contract_version_histories_response_200 import (
...
) -> GetApi20261001ResourcesContractsContractVersionHistoriesResponse200 | None:
    if response.status_code == 200:
        response_200 = (
            GetApi20261001ResourcesContractsContractVersionHistoriesResponse200.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesContractsContractVersionHistoriesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): the ids of the contract versions. Example: 1.
        contract_version_ids (list[str] | Unset): the ids of the contract versions. Example: 1.
        employee_ids (list[str] | Unset): the ids of the employees. Example: 1.
