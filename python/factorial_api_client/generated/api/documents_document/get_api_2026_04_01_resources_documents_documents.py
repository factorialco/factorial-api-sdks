...
from ...models.get_api_20260401_resources_documents_documents_response_200 import (
...
) -> GetApi20260401ResourcesDocumentsDocumentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesDocumentsDocumentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesDocumentsDocumentsResponse200]:
    return Response(
