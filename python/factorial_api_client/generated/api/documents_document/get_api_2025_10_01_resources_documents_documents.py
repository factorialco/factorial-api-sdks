...
from ...models.get_api_20251001_resources_documents_documents_response_200 import (
...
) -> GetApi20251001ResourcesDocumentsDocumentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesDocumentsDocumentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesDocumentsDocumentsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        folder_id (int | Unset): folder identifier. Example: 1.
        ids (list[int] | Unset): list of document identifiers. Example: [1, 2, 3].
        leave_id (int | Unset): leave identifier associated to the document, refers to
