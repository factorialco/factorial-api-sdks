...
from ...models.get_api_20261001_resources_project_management_time_records_response_200 import (
...
def _get_kwargs(
    *,
    ...
    project_task_ids: list[str] | Unset = UNSET,
    attendance_shift_ids: list[str] | Unset = UNSET,
    ...
    json_project_task_ids: list[str] | Unset = UNSET
    if not isinstance(project_task_ids, Unset):
        json_project_task_ids = project_task_ids

    params["project_task_ids[]"] = json_project_task_ids

    json_attendance_shift_ids: list[str] | Unset = UNSET
...
) -> GetApi20261001ResourcesProjectManagementTimeRecordsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesProjectManagementTimeRecordsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesProjectManagementTimeRecordsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Time record ids to retrieve Example: ['1', '2'].
        project_worker_ids (list[str] | Unset): Project worker ids to retrieve Example: ['1',
            '2'].
        subproject_ids (list[str] | Unset): Subproject ids to retrieve Example: ['1', '2'].
        project_task_ids (list[str] | Unset): Project task ids to retrieve Example: ['1', '2'].
        attendance_shift_ids (list[str] | Unset): Attendance shift ids to retrieve Example: ['1',
            '2'].
        employee_ids (list[str] | Unset): Employee ids to retrieve Example: ['1', '2'].
        month (int | Unset): Month to filter Example: 1.
        year (int | Unset): Year to filter Example: 2021.
        updated_after (str | Unset): Retrieve only the time records created or updated after the
            date provided. Example: 2020-01-01.
