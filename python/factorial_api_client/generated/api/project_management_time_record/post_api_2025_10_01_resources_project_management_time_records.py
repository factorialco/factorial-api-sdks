...
from ...models.post_api_20251001_resources_project_management_time_records_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesProjectManagementTimeRecordsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    **assigned**, and the associated `project` must be **active**.\"
    ...
    Args:
        body (PostApi20251001ResourcesProjectManagementTimeRecordsBody | Unset):
