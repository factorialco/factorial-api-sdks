...
from ...models.post_api_20251001_resources_project_management_time_records_update_project_worker_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesProjectManagementTimeRecordsUpdateProjectWorkerBody
    | Unset = UNSET,
) -> dict[str, Any]:
