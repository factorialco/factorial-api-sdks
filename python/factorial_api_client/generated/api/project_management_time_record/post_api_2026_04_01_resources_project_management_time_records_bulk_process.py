...
from ...models.post_api_20260401_resources_project_management_time_records_bulk_process_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesProjectManagementTimeRecordsBulkProcessBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesProjectManagementTimeRecordsBulkProcessBody | Unset):
