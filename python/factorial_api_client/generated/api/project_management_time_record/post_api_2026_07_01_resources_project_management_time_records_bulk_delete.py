...
from ...models.post_api_20260701_resources_project_management_time_records_bulk_delete_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesProjectManagementTimeRecordsBulkDeleteBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesProjectManagementTimeRecordsBulkDeleteBody | Unset):
