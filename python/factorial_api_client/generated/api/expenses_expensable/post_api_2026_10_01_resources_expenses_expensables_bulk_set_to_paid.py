...
from ...models.post_api_20261001_resources_expenses_expensables_bulk_set_to_paid_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesExpensesExpensablesBulkSetToPaidBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesExpensesExpensablesBulkSetToPaidBody | Unset):
