...
from ...models.get_api_20260701_resources_expenses_expensables_response_200 import (
    GetApi20260701ResourcesExpensesExpensablesResponse200,
)
from ...models.get_api_20260701_resources_expenses_expensables_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20260701ResourcesExpensesExpensablesStatus | Unset = UNSET,
...
) -> GetApi20260701ResourcesExpensesExpensablesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesExpensesExpensablesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesExpensesExpensablesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (GetApi20260701ResourcesExpensesExpensablesStatus | Unset):
