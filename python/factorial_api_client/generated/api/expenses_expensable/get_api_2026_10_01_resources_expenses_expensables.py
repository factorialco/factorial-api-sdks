...
from ...models.get_api_20261001_resources_expenses_expensables_by_resources_item import (
    GetApi20261001ResourcesExpensesExpensablesByResourcesItem,
)
from ...models.get_api_20261001_resources_expenses_expensables_response_200 import (
    GetApi20261001ResourcesExpensesExpensablesResponse200,
)
from ...models.get_api_20261001_resources_expenses_expensables_status import (
...
def _get_kwargs(
    *,
    ...
    by_resources: list[GetApi20261001ResourcesExpensesExpensablesByResourcesItem] | Unset = UNSET,
    employee_ids: list[str] | Unset = UNSET,
    reporter_ids: list[str] | Unset = UNSET,
    status: GetApi20261001ResourcesExpensesExpensablesStatus | Unset = UNSET,
...
) -> GetApi20261001ResourcesExpensesExpensablesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesExpensesExpensablesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesExpensesExpensablesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        by_resources (list[GetApi20261001ResourcesExpensesExpensablesByResourcesItem] | Unset):
        employee_ids (list[str] | Unset):
        reporter_ids (list[str] | Unset):
        status (GetApi20261001ResourcesExpensesExpensablesStatus | Unset):
