...
from ...models.get_api_20260701_resources_performance_review_evaluations_response_200 import (
    GetApi20260701ResourcesPerformanceReviewEvaluationsResponse200,
)
from ...models.get_api_20260701_resources_performance_review_evaluations_reviewer_strategies import (
    GetApi20260701ResourcesPerformanceReviewEvaluationsReviewerStrategies,
)
from ...models.get_api_20260701_resources_performance_review_evaluations_with_targets_managed_by_filter import (
...
def _get_kwargs(
    *,
    ...
    reviewer_strategies: GetApi20260701ResourcesPerformanceReviewEvaluationsReviewerStrategies
    | Unset = UNSET,
    target_access_ids: list[str] | Unset = UNSET,
    review_process_target_ids: list[str] | Unset = UNSET,
    with_targets_managed_by_filter: GetApi20260701ResourcesPerformanceReviewEvaluationsWithTargetsManagedByFilter
    | Unset = UNSET,
...
) -> GetApi20260701ResourcesPerformanceReviewEvaluationsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesPerformanceReviewEvaluationsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesPerformanceReviewEvaluationsResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        with_targets_managed_by_filter
            (GetApi20260701ResourcesPerformanceReviewEvaluationsWithTargetsManagedByFilter | Unset):
