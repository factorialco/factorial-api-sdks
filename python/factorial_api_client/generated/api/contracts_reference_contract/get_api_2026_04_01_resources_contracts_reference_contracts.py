...
from ...models.get_api_20260401_resources_contracts_reference_contracts_response_200 import (
...
) -> GetApi20260401ResourcesContractsReferenceContractsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesContractsReferenceContractsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesContractsReferenceContractsResponse200]:
    return Response(
