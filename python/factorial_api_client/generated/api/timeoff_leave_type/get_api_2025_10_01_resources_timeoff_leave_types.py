...
from ...models.get_api_20251001_resources_timeoff_leave_types_response_200 import (
...
) -> GetApi20251001ResourcesTimeoffLeaveTypesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesTimeoffLeaveTypesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesTimeoffLeaveTypesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): Identifiers of the leave types Example: [1, 2].
        company_ids (list[int] | Unset): Identifiers of the companies Example: [1, 2].
        ...
        identifier (str | Unset): A unique identifier for the leave type, or an array of
            identifiers Example: annual_leave.
        employee_id (int | Unset): Identifier of the employee Example: 1.
        reference_date (str | Unset): A reference date for the leave type Example: 2024-08-22.
        leave_type_id (int | Unset): Identifier of a specific leave type Example: 1.
