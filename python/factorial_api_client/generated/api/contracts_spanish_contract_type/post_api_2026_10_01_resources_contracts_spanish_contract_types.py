...
from ...models.post_api_20261001_resources_contracts_spanish_contract_types_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesContractsSpanishContractTypesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesContractsSpanishContractTypesBody | Unset):
