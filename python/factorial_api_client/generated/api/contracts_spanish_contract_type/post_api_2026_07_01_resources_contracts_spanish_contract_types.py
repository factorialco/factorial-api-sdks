...
from ...models.post_api_20260701_resources_contracts_spanish_contract_types_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesContractsSpanishContractTypesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesContractsSpanishContractTypesBody | Unset):
