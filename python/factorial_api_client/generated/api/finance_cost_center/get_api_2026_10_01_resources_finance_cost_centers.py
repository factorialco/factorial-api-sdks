...
from ...models.get_api_20261001_resources_finance_cost_centers_response_200 import (
...
) -> GetApi20261001ResourcesFinanceCostCentersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceCostCentersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceCostCentersResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset):
        company_id (str | Unset): Company id to filter cost centers by. Example: 1.
