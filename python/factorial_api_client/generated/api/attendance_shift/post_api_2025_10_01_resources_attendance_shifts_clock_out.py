...
from ...models.post_api_20251001_resources_attendance_shifts_clock_out_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesAttendanceShiftsClockOutBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20251001ResourcesAttendanceShiftsClockOutBody | Unset):
