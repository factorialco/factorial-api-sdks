...
from ...models.post_api_20260401_resources_attendance_shifts_toggle_clock_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesAttendanceShiftsToggleClockBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesAttendanceShiftsToggleClockBody | Unset):
