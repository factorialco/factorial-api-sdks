...
from ...models.post_api_20260701_resources_attendance_shifts_break_start_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesAttendanceShiftsBreakStartBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesAttendanceShiftsBreakStartBody | Unset):
