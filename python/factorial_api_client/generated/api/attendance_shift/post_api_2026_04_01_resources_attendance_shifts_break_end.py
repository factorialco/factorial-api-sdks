...
from ...models.post_api_20260401_resources_attendance_shifts_break_end_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesAttendanceShiftsBreakEndBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesAttendanceShiftsBreakEndBody | Unset):
