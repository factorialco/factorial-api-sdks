...
from ...models.post_api_20260701_resources_attendance_shifts_break_end_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesAttendanceShiftsBreakEndBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesAttendanceShiftsBreakEndBody | Unset):
