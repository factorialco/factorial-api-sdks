...
from ...models.post_api_20251001_resources_attendance_shifts_clock_in_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesAttendanceShiftsClockInBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20251001ResourcesAttendanceShiftsClockInBody | Unset):
