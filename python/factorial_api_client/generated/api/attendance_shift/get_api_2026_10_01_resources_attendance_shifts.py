...
from ...models.get_api_20261001_resources_attendance_shifts_response_200 import (
...
) -> GetApi20261001ResourcesAttendanceShiftsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesAttendanceShiftsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesAttendanceShiftsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        employee_ids (list[str] | Unset): Return only the shifts of these employees. Example:
            ['1', '2', '3'].
        start_on (str | Unset): Return only the shifts whose reference date (the day the shift
            counts towards, which for an overnight shift is the day it started) is on or after this
            date. Can be given on its own, as an open-ended lower bound. Example: 2023-09-30.
        end_on (str | Unset): Return only the shifts whose reference date is on or before this
            date. Can be given on its own, as an open-ended upper bound. Example: 2023-10-01.
        ids (list[str] | Unset): Return only the shifts with these ids. Example: ['1', '2', '3'].
        half_day (bool): Set to true to return only the shifts marked as covering half a day.
            Passing false has no effect: it does not exclude them.
        workable (bool | Unset): Set to true for worked time only, false for the non-workable
            entries (breaks). Leave it unset to get both. Example: True.
