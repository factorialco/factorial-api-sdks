...
from ...models.get_api_20260701_resources_attendance_edit_timesheet_requests_response_200 import (
...
) -> GetApi20260701ResourcesAttendanceEditTimesheetRequestsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesAttendanceEditTimesheetRequestsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesAttendanceEditTimesheetRequestsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        shift_id (str | Unset): filter by shift id. Example: 1.
