...
from ...models.get_api_20260401_resources_project_management_project_tasks_due_status import (
    GetApi20260401ResourcesProjectManagementProjectTasksDueStatus,
)
from ...models.get_api_20260401_resources_project_management_project_tasks_response_200 import (
...
def _get_kwargs(
    *,
    ...
    overdue: bool,
    search: str,
    due_status: GetApi20260401ResourcesProjectManagementProjectTasksDueStatus,
    client_ids: list[int],
) -> dict[str, Any]:
...
) -> GetApi20260401ResourcesProjectManagementProjectTasksResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesProjectManagementProjectTasksResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesProjectManagementProjectTasksResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        due_status (GetApi20260401ResourcesProjectManagementProjectTasksDueStatus): Retrieve only
