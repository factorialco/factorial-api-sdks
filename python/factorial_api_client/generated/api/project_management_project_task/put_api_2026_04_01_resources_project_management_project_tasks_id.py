...
from ...models.put_api_20260401_resources_project_management_project_tasks_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20260401ResourcesProjectManagementProjectTasksIdBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20260401ResourcesProjectManagementProjectTasksIdBody | Unset):
