...
from ...models.post_api_20260401_resources_project_management_project_tasks_bulk_duplicate_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesProjectManagementProjectTasksBulkDuplicateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesProjectManagementProjectTasksBulkDuplicateBody | Unset):
