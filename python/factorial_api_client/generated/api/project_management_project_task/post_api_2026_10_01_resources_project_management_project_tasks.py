...
from ...models.post_api_20261001_resources_project_management_project_tasks_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesProjectManagementProjectTasksBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesProjectManagementProjectTasksBody | Unset):
