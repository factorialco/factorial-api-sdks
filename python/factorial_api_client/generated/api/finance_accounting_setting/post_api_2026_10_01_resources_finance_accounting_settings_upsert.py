...
from ...models.post_api_20261001_resources_finance_accounting_settings_upsert_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesFinanceAccountingSettingsUpsertBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesFinanceAccountingSettingsUpsertBody | Unset):
