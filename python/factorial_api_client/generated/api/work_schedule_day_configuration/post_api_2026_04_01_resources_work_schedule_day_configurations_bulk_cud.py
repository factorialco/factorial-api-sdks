...
from ...models.post_api_20260401_resources_work_schedule_day_configurations_bulk_cud_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesWorkScheduleDayConfigurationsBulkCudBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesWorkScheduleDayConfigurationsBulkCudBody | Unset):
