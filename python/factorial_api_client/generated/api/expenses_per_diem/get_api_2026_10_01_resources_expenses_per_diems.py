...
from ...models.get_api_20261001_resources_expenses_per_diems_response_200 import (
...
) -> GetApi20261001ResourcesExpensesPerDiemsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesExpensesPerDiemsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesExpensesPerDiemsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): The IDs of the per diem to read. Example: ['1', '2'].
        expenses_expensable_ids (list[str] | Unset): The IDs of the expensables to read per diems
            for. Example: ['1', '2'].
