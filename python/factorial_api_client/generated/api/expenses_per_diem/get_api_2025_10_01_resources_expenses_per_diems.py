...
from ...models.get_api_20251001_resources_expenses_per_diems_response_200 import (
...
) -> GetApi20251001ResourcesExpensesPerDiemsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesExpensesPerDiemsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesExpensesPerDiemsResponse200]:
    return Response(
