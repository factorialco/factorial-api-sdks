...
from ...models.get_api_20260701_resources_banking_bank_accounts_response_200 import (
...
) -> GetApi20260701ResourcesBankingBankAccountsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesBankingBankAccountsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesBankingBankAccountsResponse200]:
    return Response(
