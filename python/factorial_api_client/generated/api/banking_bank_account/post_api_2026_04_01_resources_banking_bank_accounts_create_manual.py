...
from ...models.post_api_20260401_resources_banking_bank_accounts_create_manual_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesBankingBankAccountsCreateManualBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesBankingBankAccountsCreateManualBody | Unset):
