...
from ...models.get_api_20261001_resources_banking_bank_accounts_response_200 import (
...
) -> GetApi20261001ResourcesBankingBankAccountsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesBankingBankAccountsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesBankingBankAccountsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): An array of bank account IDs to filter by. Example: ['1'].
        currency (str | Unset): A currency to filter by. Example: EUR.
        legal_entity_ids (list[str] | Unset): An array of legal entity IDs to filter by. Example:
            ['11'].
