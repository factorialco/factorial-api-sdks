...
from ...models.get_api_20251001_resources_tasks_tasks_response_200 import (
    GetApi20251001ResourcesTasksTasksResponse200,
)
from ...models.get_api_20251001_resources_tasks_tasks_task_status import (
...
def _get_kwargs(
    *,
    ...
    task_status: GetApi20251001ResourcesTasksTasksTaskStatus | Unset = UNSET,
...
) -> GetApi20251001ResourcesTasksTasksResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesTasksTasksResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesTasksTasksResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        already_due (bool | Unset): filter by tasks that have expired or are still due. Example:
            True.
        task_status (GetApi20251001ResourcesTasksTasksTaskStatus | Unset): filter by tasks that
