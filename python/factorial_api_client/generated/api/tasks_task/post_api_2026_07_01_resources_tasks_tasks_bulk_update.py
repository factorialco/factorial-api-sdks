...
from ...models.post_api_20260701_resources_tasks_tasks_bulk_update_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesTasksTasksBulkUpdateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesTasksTasksBulkUpdateBody | Unset):
