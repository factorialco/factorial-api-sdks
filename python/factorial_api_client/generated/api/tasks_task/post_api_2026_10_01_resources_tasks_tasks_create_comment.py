...
from ...models.post_api_20261001_resources_tasks_tasks_create_comment_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesTasksTasksCreateCommentBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesTasksTasksCreateCommentBody | Unset):
