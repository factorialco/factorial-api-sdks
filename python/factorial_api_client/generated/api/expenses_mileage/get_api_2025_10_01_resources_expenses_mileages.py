...
from ...models.get_api_20251001_resources_expenses_mileages_response_200 import (
...
) -> GetApi20251001ResourcesExpensesMileagesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesExpensesMileagesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesExpensesMileagesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset):
        expenses_expensable_ids (list[int] | Unset):
        include_manual_drafts (bool):
        employee_ids (list[int] | Unset):
        external_authorization_ids (list[str] | Unset):
        card_ids (list[int] | Unset):
        card_payment_ids (list[int] | Unset):
        include_attachments (bool):
        from_ (str | Unset):
        to (str | Unset):
        dispute_ids (list[int] | Unset):
