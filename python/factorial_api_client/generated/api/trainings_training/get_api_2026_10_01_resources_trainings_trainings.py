...
from ...models.get_api_20261001_resources_trainings_trainings_response_200 import (
...
) -> GetApi20261001ResourcesTrainingsTrainingsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesTrainingsTrainingsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesTrainingsTrainingsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        id (str | Unset): This field is used to get a specific training.
        ids (list[str] | Unset): This field is used to filter those trainings whose id match with
            the given.
        access_id (str | Unset): @deprecated
