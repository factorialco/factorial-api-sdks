...
from ...models.post_api_20260401_resources_trainings_trainings_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260401ResourcesTrainingsTrainingsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260401ResourcesTrainingsTrainingsBody | Unset):
