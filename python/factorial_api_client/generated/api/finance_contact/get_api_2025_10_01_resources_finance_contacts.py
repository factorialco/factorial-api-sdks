...
from ...models.get_api_20251001_resources_finance_contacts_contact_type import (
    GetApi20251001ResourcesFinanceContactsContactType,
)
from ...models.get_api_20251001_resources_finance_contacts_response_200 import (
...
def _get_kwargs(
    *,
    ...
    contact_type: GetApi20251001ResourcesFinanceContactsContactType | Unset = UNSET,
...
) -> GetApi20251001ResourcesFinanceContactsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesFinanceContactsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesFinanceContactsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): List of Contact IDs to filter by. Example: [123, 456].
        ...
        contact_type (GetApi20251001ResourcesFinanceContactsContactType | Unset): Type of the
