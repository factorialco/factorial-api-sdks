...
from ...models.get_api_20261001_resources_finance_contacts_contact_type import (
    GetApi20261001ResourcesFinanceContactsContactType,
)
from ...models.get_api_20261001_resources_finance_contacts_response_200 import (
...
def _get_kwargs(
    *,
    ...
    contact_type: GetApi20261001ResourcesFinanceContactsContactType | Unset = UNSET,
...
) -> GetApi20261001ResourcesFinanceContactsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceContactsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceContactsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        contact_type (GetApi20261001ResourcesFinanceContactsContactType | Unset): Type of the
