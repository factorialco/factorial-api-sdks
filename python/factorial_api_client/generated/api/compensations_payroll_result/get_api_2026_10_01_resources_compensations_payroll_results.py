...
from ...models.get_api_20261001_resources_compensations_payroll_results_response_200 import (
...
) -> GetApi20261001ResourcesCompensationsPayrollResultsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesCompensationsPayrollResultsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesCompensationsPayrollResultsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Payroll result ids Example: ['1'].
