...
from ...models.get_api_20260701_resources_attendance_open_shifts_response_200 import (
...
) -> GetApi20260701ResourcesAttendanceOpenShiftsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesAttendanceOpenShiftsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesAttendanceOpenShiftsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        employee_ids (list[str] | Unset): Employee ids to filter the open shifts by. Example:
            ['1', '2', '3'].
