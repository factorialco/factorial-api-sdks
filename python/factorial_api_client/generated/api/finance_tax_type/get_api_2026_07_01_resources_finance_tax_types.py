...
from ...models.get_api_20260701_resources_finance_tax_types_response_200 import (
    GetApi20260701ResourcesFinanceTaxTypesResponse200,
)
from ...models.get_api_20260701_resources_finance_tax_types_type import (
...
def _get_kwargs(
    *,
    ...
    type_: GetApi20260701ResourcesFinanceTaxTypesType | Unset = UNSET,
...
) -> GetApi20260701ResourcesFinanceTaxTypesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesFinanceTaxTypesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesFinanceTaxTypesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        type_ (GetApi20260701ResourcesFinanceTaxTypesType | Unset): Filters TaxTypes by a type
