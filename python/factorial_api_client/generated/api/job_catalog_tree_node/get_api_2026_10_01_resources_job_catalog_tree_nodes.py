...
from ...models.get_api_20261001_resources_job_catalog_tree_nodes_node_type import (
    GetApi20261001ResourcesJobCatalogTreeNodesNodeType,
)
from ...models.get_api_20261001_resources_job_catalog_tree_nodes_response_200 import (
...
def _get_kwargs(
    *,
    ...
    node_type: GetApi20261001ResourcesJobCatalogTreeNodesNodeType,
...
) -> GetApi20261001ResourcesJobCatalogTreeNodesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesJobCatalogTreeNodesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesJobCatalogTreeNodesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        node_type (GetApi20261001ResourcesJobCatalogTreeNodesNodeType): Node type scope for the
