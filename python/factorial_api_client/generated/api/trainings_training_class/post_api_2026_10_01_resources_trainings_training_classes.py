...
from ...models.post_api_20261001_resources_trainings_training_classes_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesTrainingsTrainingClassesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesTrainingsTrainingClassesBody | Unset):
