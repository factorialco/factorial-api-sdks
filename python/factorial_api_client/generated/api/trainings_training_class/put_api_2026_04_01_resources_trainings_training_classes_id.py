...
from ...models.put_api_20260401_resources_trainings_training_classes_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20260401ResourcesTrainingsTrainingClassesIdBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/2026-04-01/resources/trainings/training_classes/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20260401ResourcesTrainingsTrainingClassesIdBody | Unset):
