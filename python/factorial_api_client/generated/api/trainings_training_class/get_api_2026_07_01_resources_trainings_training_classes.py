...
from ...models.get_api_20260701_resources_trainings_training_classes_response_200 import (
...
) -> GetApi20260701ResourcesTrainingsTrainingClassesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesTrainingsTrainingClassesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesTrainingsTrainingClassesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Filter those training classes whose id match with the given.
        id (str | Unset): Get a specific training class.
        training_id (str | Unset): Get training classes for the specified training.
