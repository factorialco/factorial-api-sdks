...
from ...models.get_api_20261001_resources_contracts_materialized_templates_response_200 import (
    GetApi20261001ResourcesContractsMaterializedTemplatesResponse200,
)
from ...models.get_api_20261001_resources_contracts_materialized_templates_template_type import (
...
def _get_kwargs(
    *,
    ...
    template_type: GetApi20261001ResourcesContractsMaterializedTemplatesTemplateType,
...
) -> GetApi20261001ResourcesContractsMaterializedTemplatesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesContractsMaterializedTemplatesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesContractsMaterializedTemplatesResponse200]:
    return Response(
    ...
    Args:
        ...
        countries (list[str] | Unset): Optional list of ISO 3166-1 alpha-2 country codes to filter
            ...
            operating in those countries.
             Example: ['es'].
        template_type (GetApi20261001ResourcesContractsMaterializedTemplatesTemplateType): The
