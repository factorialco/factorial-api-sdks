...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): The ids of the expenses to filter by
        expenses_expensable_ids (list[str] | Unset): The ids of the expensables to filter by
        include_manual_drafts (bool): Whether to include manual drafts Example: True.
        employee_ids (list[str] | Unset): The ids of the employees to filter by
        external_authorization_ids (list[str] | Unset): The ids of the external authorizations to
            filter by
        card_ids (list[str] | Unset): The ids of the cards to filter by
        card_payment_ids (list[str] | Unset): The ids of the card payments to filter by
        ...
        dispute_ids (list[str] | Unset): The ids of the disputes to filter by
