...
from ...models.get_api_20261001_resources_finance_categories_category_level import (
    GetApi20261001ResourcesFinanceCategoriesCategoryLevel,
)
from ...models.get_api_20261001_resources_finance_categories_response_200 import (
    GetApi20261001ResourcesFinanceCategoriesResponse200,
)
from ...models.get_api_20261001_resources_finance_categories_statuses import (
    GetApi20261001ResourcesFinanceCategoriesStatuses,
)
from ...models.get_api_20261001_resources_finance_categories_type import (
...
def _get_kwargs(
    *,
    ...
    category_level: GetApi20261001ResourcesFinanceCategoriesCategoryLevel,
    type_: GetApi20261001ResourcesFinanceCategoriesType,
    statuses: GetApi20261001ResourcesFinanceCategoriesStatuses,
...
) -> GetApi20261001ResourcesFinanceCategoriesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceCategoriesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceCategoriesResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        parent_category_ids (list[str] | Unset): Search subcategories by parent category ID
            Example: ['2'].
        category_level (GetApi20261001ResourcesFinanceCategoriesCategoryLevel): Filter by category
            level Example: all.
        type_ (GetApi20261001ResourcesFinanceCategoriesType): Filter by category type Example:
            expense.
        statuses (GetApi20261001ResourcesFinanceCategoriesStatuses): Filter by category status
            Example: ['enabled'].
