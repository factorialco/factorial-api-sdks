...
from ...models.post_api_20261001_resources_payroll_family_situations_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesPayrollFamilySituationsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesPayrollFamilySituationsBody | Unset):
