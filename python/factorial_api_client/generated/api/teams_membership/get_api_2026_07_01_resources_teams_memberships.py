...
from ...models.get_api_20260701_resources_teams_memberships_response_200 import (
...
) -> GetApi20260701ResourcesTeamsMembershipsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesTeamsMembershipsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesTeamsMembershipsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Membership ids. Example: ['1', '2', '3'].
        lead (bool | Unset): Whether the employee is a lead of the team or not Example: True.
        team_ids (list[str] | Unset): Team ids. Example: ['3', '5', '7'].
        employee_ids (list[str] | Unset): Employee ids. Example: ['10', '12', '13'].
