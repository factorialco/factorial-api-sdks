...
from ...models.get_api_20251001_resources_posts_posts_response_200 import (
...
def _get_kwargs(
    *,
    ...
    json_groups: list[int] | Unset = UNSET
...
) -> GetApi20251001ResourcesPostsPostsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesPostsPostsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesPostsPostsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        groups (list[int] | Unset): group identifiers of the posts Example: [1, 2, 3].
        ...
        ids (list[int] | Unset): identifiers of the post Example: [1, 2, 3].
