...
from ...models.get_api_20251001_resources_finance_financial_documents_document_types import (
    GetApi20251001ResourcesFinanceFinancialDocumentsDocumentTypes,
)
from ...models.get_api_20251001_resources_finance_financial_documents_response_200 import (
    GetApi20251001ResourcesFinanceFinancialDocumentsResponse200,
)
from ...models.get_api_20251001_resources_finance_financial_documents_statuses import (
...
def _get_kwargs(
    *,
    ...
    statuses: GetApi20251001ResourcesFinanceFinancialDocumentsStatuses | Unset = UNSET,
    legal_entity_ids: list[int] | Unset = UNSET,
    document_types: GetApi20251001ResourcesFinanceFinancialDocumentsDocumentTypes | Unset = UNSET,
...
) -> GetApi20251001ResourcesFinanceFinancialDocumentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesFinanceFinancialDocumentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesFinanceFinancialDocumentsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        statuses (GetApi20251001ResourcesFinanceFinancialDocumentsStatuses | Unset): Search
        ...
        legal_entity_ids (list[int] | Unset): Search financial documents by legal_entity_id
            Example: [13].
        document_types (GetApi20251001ResourcesFinanceFinancialDocumentsDocumentTypes | Unset):
