...
from ...models.get_api_20261001_resources_finance_financial_documents_document_types import (
    GetApi20261001ResourcesFinanceFinancialDocumentsDocumentTypes,
)
from ...models.get_api_20261001_resources_finance_financial_documents_response_200 import (
    GetApi20261001ResourcesFinanceFinancialDocumentsResponse200,
)
from ...models.get_api_20261001_resources_finance_financial_documents_statuses import (
...
def _get_kwargs(
    *,
    ...
    statuses: GetApi20261001ResourcesFinanceFinancialDocumentsStatuses | Unset = UNSET,
    legal_entity_ids: list[str] | Unset = UNSET,
    document_types: GetApi20261001ResourcesFinanceFinancialDocumentsDocumentTypes | Unset = UNSET,
...
) -> GetApi20261001ResourcesFinanceFinancialDocumentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceFinancialDocumentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceFinancialDocumentsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        company_id (str | Unset): Search financial documents by company_id Example: 1.
        ids (list[str] | Unset): Search financial documents by ID Example: ['135'].
        vendor_id (str | Unset): Search financial documents by vendor_id Example: 33.
        currency (str | Unset): Search financial documents by currency Example: USD.
        statuses (GetApi20261001ResourcesFinanceFinancialDocumentsStatuses | Unset): Search
            financial documents by status Example: ['review'].
        legal_entity_ids (list[str] | Unset): Search financial documents by legal_entity_id
            Example: ['13'].
        document_types (GetApi20261001ResourcesFinanceFinancialDocumentsDocumentTypes | Unset):
