...
from ...models.get_api_20260701_resources_finance_financial_documents_document_types import (
    GetApi20260701ResourcesFinanceFinancialDocumentsDocumentTypes,
)
from ...models.get_api_20260701_resources_finance_financial_documents_response_200 import (
    GetApi20260701ResourcesFinanceFinancialDocumentsResponse200,
)
from ...models.get_api_20260701_resources_finance_financial_documents_statuses import (
...
def _get_kwargs(
    *,
    ...
    statuses: GetApi20260701ResourcesFinanceFinancialDocumentsStatuses | Unset = UNSET,
    legal_entity_ids: list[str] | Unset = UNSET,
    document_types: GetApi20260701ResourcesFinanceFinancialDocumentsDocumentTypes | Unset = UNSET,
...
) -> GetApi20260701ResourcesFinanceFinancialDocumentsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesFinanceFinancialDocumentsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesFinanceFinancialDocumentsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        statuses (GetApi20260701ResourcesFinanceFinancialDocumentsStatuses | Unset): Search
        ...
        legal_entity_ids (list[str] | Unset): Search financial documents by legal_entity_id
            Example: ['13'].
        document_types (GetApi20260701ResourcesFinanceFinancialDocumentsDocumentTypes | Unset):
