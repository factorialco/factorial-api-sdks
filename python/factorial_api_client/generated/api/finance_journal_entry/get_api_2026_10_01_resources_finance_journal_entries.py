...
from ...models.get_api_20261001_resources_finance_journal_entries_response_200 import (
    GetApi20261001ResourcesFinanceJournalEntriesResponse200,
)
from ...models.get_api_20261001_resources_finance_journal_entries_source_type import (
    GetApi20261001ResourcesFinanceJournalEntriesSourceType,
)
from ...models.get_api_20261001_resources_finance_journal_entries_status import (
    GetApi20261001ResourcesFinanceJournalEntriesStatus,
)
from ...models.get_api_20261001_resources_finance_journal_entries_types import (
...
def _get_kwargs(
    *,
    ...
    source_type: GetApi20261001ResourcesFinanceJournalEntriesSourceType | Unset = UNSET,
    types: GetApi20261001ResourcesFinanceJournalEntriesTypes | Unset = UNSET,
    status: GetApi20261001ResourcesFinanceJournalEntriesStatus | Unset = UNSET,
...
) -> GetApi20261001ResourcesFinanceJournalEntriesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceJournalEntriesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceJournalEntriesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        source_type (GetApi20261001ResourcesFinanceJournalEntriesSourceType | Unset): Filter by
            related source type Example: bank_transaction.
        types (GetApi20261001ResourcesFinanceJournalEntriesTypes | Unset): Filter by entry type
            Example: ['bank', 'invoice', 'credit_note', 'receipt'].
        status (GetApi20261001ResourcesFinanceJournalEntriesStatus | Unset): Filter by Journal
