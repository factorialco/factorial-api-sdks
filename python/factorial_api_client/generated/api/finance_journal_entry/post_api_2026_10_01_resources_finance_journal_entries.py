...
from ...models.post_api_20261001_resources_finance_journal_entries_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesFinanceJournalEntriesBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesFinanceJournalEntriesBody | Unset):
