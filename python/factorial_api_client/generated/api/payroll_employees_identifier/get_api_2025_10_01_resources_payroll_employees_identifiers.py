...
from ...models.get_api_20251001_resources_payroll_employees_identifiers_country import (
    GetApi20251001ResourcesPayrollEmployeesIdentifiersCountry,
)
from ...models.get_api_20251001_resources_payroll_employees_identifiers_response_200 import (
...
def _get_kwargs(
    *,
    ...
    country: GetApi20251001ResourcesPayrollEmployeesIdentifiersCountry,
) -> dict[str, Any]:
...
) -> GetApi20251001ResourcesPayrollEmployeesIdentifiersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesPayrollEmployeesIdentifiersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesPayrollEmployeesIdentifiersResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        country (GetApi20251001ResourcesPayrollEmployeesIdentifiersCountry): filters by country
