...
from ...models.get_api_20260701_resources_payroll_employees_identifiers_country import (
    GetApi20260701ResourcesPayrollEmployeesIdentifiersCountry,
)
from ...models.get_api_20260701_resources_payroll_employees_identifiers_response_200 import (
...
def _get_kwargs(
    *,
    ...
    country: GetApi20260701ResourcesPayrollEmployeesIdentifiersCountry,
) -> dict[str, Any]:
...
) -> GetApi20260701ResourcesPayrollEmployeesIdentifiersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesPayrollEmployeesIdentifiersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesPayrollEmployeesIdentifiersResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        country (GetApi20260701ResourcesPayrollEmployeesIdentifiersCountry): filters by country
