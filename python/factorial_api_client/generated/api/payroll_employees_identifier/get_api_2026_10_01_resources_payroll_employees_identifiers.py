...
from ...models.get_api_20261001_resources_payroll_employees_identifiers_country import (
    GetApi20261001ResourcesPayrollEmployeesIdentifiersCountry,
)
from ...models.get_api_20261001_resources_payroll_employees_identifiers_response_200 import (
...
def _get_kwargs(
    *,
    ...
    employees_ids: list[str] | Unset = UNSET,
    legal_entities_ids: list[str] | Unset = UNSET,
    country: GetApi20261001ResourcesPayrollEmployeesIdentifiersCountry,
) -> dict[str, Any]:
    ...
    json_employees_ids: list[str] | Unset = UNSET
...
) -> GetApi20261001ResourcesPayrollEmployeesIdentifiersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesPayrollEmployeesIdentifiersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesPayrollEmployeesIdentifiersResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset):
        employees_ids (list[str] | Unset): filters by employee identifiers Example: ['1', '2',
            '3'].
        legal_entities_ids (list[str] | Unset):
        country (GetApi20261001ResourcesPayrollEmployeesIdentifiersCountry): filters by country
