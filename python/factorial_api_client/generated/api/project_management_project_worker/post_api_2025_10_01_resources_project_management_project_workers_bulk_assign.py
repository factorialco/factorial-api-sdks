...
from ...models.post_api_20251001_resources_project_management_project_workers_bulk_assign_body import (
...
def _get_kwargs(
    *,
    body: PostApi20251001ResourcesProjectManagementProjectWorkersBulkAssignBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20251001ResourcesProjectManagementProjectWorkersBulkAssignBody | Unset):
