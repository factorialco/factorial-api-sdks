...
from ...models.get_api_20251001_resources_project_management_project_workers_response_200 import (
...
) -> GetApi20251001ResourcesProjectManagementProjectWorkersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20251001ResourcesProjectManagementProjectWorkersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20251001ResourcesProjectManagementProjectWorkersResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): Retrieve only the project workers that matches the ids provided
            in the request. Example: [92732, 2].
        project_ids (list[int] | Unset): Retrieve only the project workers that matches the
            project_ids provided in the request. Example: [314159, 33].
        subproject_ids (list[int] | Unset): Retrieve only the project workers that matches the
        ...
        employee_ids (list[int] | Unset): Retrieve only the project workers that are related to
