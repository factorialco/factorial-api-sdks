...
from ...models.post_api_20260701_resources_project_management_project_workers_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesProjectManagementProjectWorkersBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesProjectManagementProjectWorkersBody | Unset):
