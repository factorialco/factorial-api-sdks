...
from ...models.post_api_20261001_resources_integrations_sync_run_outputs_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesIntegrationsSyncRunOutputsBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesIntegrationsSyncRunOutputsBody | Unset):
