...
from ...models.get_api_20261001_resources_procurement_purchase_orders_response_200 import (
    GetApi20261001ResourcesProcurementPurchaseOrdersResponse200,
)
from ...models.get_api_20261001_resources_procurement_purchase_orders_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20261001ResourcesProcurementPurchaseOrdersStatus | Unset = UNSET,
...
) -> GetApi20261001ResourcesProcurementPurchaseOrdersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesProcurementPurchaseOrdersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesProcurementPurchaseOrdersResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        purchase_request_ids (list[str] | Unset): An array of purchase request IDs to filter by.
            Example: ['5678'].
        status (GetApi20261001ResourcesProcurementPurchaseOrdersStatus | Unset): Status to filter
            by. Example: pending.
