...
from ...models.get_api_20260701_resources_procurement_purchase_orders_response_200 import (
    GetApi20260701ResourcesProcurementPurchaseOrdersResponse200,
)
from ...models.get_api_20260701_resources_procurement_purchase_orders_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20260701ResourcesProcurementPurchaseOrdersStatus | Unset = UNSET,
...
) -> GetApi20260701ResourcesProcurementPurchaseOrdersResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesProcurementPurchaseOrdersResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesProcurementPurchaseOrdersResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        purchase_request_ids (list[str] | Unset): An array of purchase request IDs to filter by.
            Example: ['5678'].
        status (GetApi20260701ResourcesProcurementPurchaseOrdersStatus | Unset): Status to filter
            by. Example: pending.
