...
from ...models.get_api_20261001_resources_finance_budget_options_response_200 import (
...
) -> GetApi20261001ResourcesFinanceBudgetOptionsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20261001ResourcesFinanceBudgetOptionsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20261001ResourcesFinanceBudgetOptionsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[str] | Unset): Search budget options by ID Example: ['1'].
        employee_ids (list[str] | Unset): Search budget options by employee IDs Example: ['1'].
