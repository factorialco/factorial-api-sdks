...
from ...models.get_api_20260701_resources_procurement_purchase_requests_response_200 import (
    GetApi20260701ResourcesProcurementPurchaseRequestsResponse200,
)
from ...models.get_api_20260701_resources_procurement_purchase_requests_status import (
...
def _get_kwargs(
    *,
    ...
    status: GetApi20260701ResourcesProcurementPurchaseRequestsStatus | Unset = UNSET,
) -> dict[str, Any]:
...
) -> GetApi20260701ResourcesProcurementPurchaseRequestsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260701ResourcesProcurementPurchaseRequestsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260701ResourcesProcurementPurchaseRequestsResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        type_ids (list[str] | Unset): An array of purchase type IDs to filter by. Example:
            ['12353'].
        status (GetApi20260701ResourcesProcurementPurchaseRequestsStatus | Unset): Status to
