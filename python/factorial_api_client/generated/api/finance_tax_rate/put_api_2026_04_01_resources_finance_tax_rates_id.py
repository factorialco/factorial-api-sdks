...
from ...models.put_api_20260401_resources_finance_tax_rates_id_body import (
...
def _get_kwargs(
    id: str,
    *,
    body: PutApi20260401ResourcesFinanceTaxRatesIdBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PutApi20260401ResourcesFinanceTaxRatesIdBody | Unset):
