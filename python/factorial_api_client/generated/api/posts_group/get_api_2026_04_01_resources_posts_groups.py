...
from ...models.get_api_20260401_resources_posts_groups_response_200 import (
...
) -> GetApi20260401ResourcesPostsGroupsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesPostsGroupsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesPostsGroupsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ids (list[int] | Unset): identifier of the group. Example: [1, 2, 3].
