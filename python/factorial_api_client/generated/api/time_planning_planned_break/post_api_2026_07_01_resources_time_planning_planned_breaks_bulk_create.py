...
from ...models.post_api_20260701_resources_time_planning_planned_breaks_bulk_create_body import (
...
def _get_kwargs(
    *,
    body: PostApi20260701ResourcesTimePlanningPlannedBreaksBulkCreateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20260701ResourcesTimePlanningPlannedBreaksBulkCreateBody | Unset):
