...
from ...models.post_api_20261001_resources_time_planning_planned_breaks_bulk_create_body import (
...
def _get_kwargs(
    *,
    body: PostApi20261001ResourcesTimePlanningPlannedBreaksBulkCreateBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostApi20261001ResourcesTimePlanningPlannedBreaksBulkCreateBody | Unset):
