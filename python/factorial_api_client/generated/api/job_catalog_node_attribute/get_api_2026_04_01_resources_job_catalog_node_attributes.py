...
from ...models.get_api_20260401_resources_job_catalog_node_attributes_attribute_types import (
    GetApi20260401ResourcesJobCatalogNodeAttributesAttributeTypes,
)
from ...models.get_api_20260401_resources_job_catalog_node_attributes_response_200 import (
...
def _get_kwargs(
    *,
    node_uuid: str,
    attribute_types: GetApi20260401ResourcesJobCatalogNodeAttributesAttributeTypes,
) -> dict[str, Any]:
...
) -> GetApi20260401ResourcesJobCatalogNodeAttributesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApi20260401ResourcesJobCatalogNodeAttributesResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApi20260401ResourcesJobCatalogNodeAttributesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        attribute_types (GetApi20260401ResourcesJobCatalogNodeAttributesAttributeTypes): Restrict
