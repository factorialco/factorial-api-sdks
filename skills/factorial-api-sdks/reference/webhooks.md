...
Auto-generated from the OpenAPI spec. 127 events across 22 namespaces, 33 distinct payload schemas.
...
| --- | --- | --- | --- |
| `id` | integer | yes | Identifier of the webhook subscription |
| `target_url` | string | yes | URL where the webhook payload will be sent |
| `type` | string | yes | Type of the webhook subscription |
| `company_id` | integer | yes | Company identifier of the webhook subscription |
...
| `company_id` | integer | yes | Company id of the application |
| `ats_job_posting_id` | integer | yes | Job posting id of the application |
| `ats_candidate_id` | integer | yes | Candidate id of the application |
| `employee_id` | integer | no | Employee id of the application |
| `phone` | string | no | Candidate phone of the application |
| `qualified` | boolean | no | Qualified of the application |
| `ats_application_phase_id` | integer | no | Application phase id |
| `created_at` | string | yes | Application created at date |
| `cover_letter` | string | no | Application cover letter |
| `ats_conversation_id` | integer | no | Application conversation id |
| `medium` | string | no | Application medium |
| `rating_average` | integer | no | Application average rating |
| `ats_rejection_reason_id` | integer | no | Application rejection reason id |
| `source_id` | integer | no | Application source id |

### ats_candidate

| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | identifier of the candidate. |
| `company_id` | integer | no | company identifier. |
...
| `ats_job_posting_ids` | array<integer> | no | list of job posting identifiers. |
...
| `source_id` | integer | no | candidate source identifier, refers to ats/candidate_sources endpoint. |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Id of the evaluation form. |
| `company_id` | integer | yes | Id of the company that the evaluation form belongs to. |
| `ats_job_posting_id` | integer | no | Id of the job posting that the evaluation form is associated with. |
| `name` | string | yes | Name of the evaluation form. |
| `based_on_id` | integer | no | Id of the evaluation form that this evaluation form is related. |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Unique identifier for the job posting |
| `company_id` | integer | yes | Identifier of the company associated with the job posting |
| `ats_company_id` | integer | yes | Identifier of the ATS company associated with the job posting |
...
| `team_id` | integer | no | Identifier of the team associated with the job posting |
| `location_id` | integer | no | Identifier of the location associated with the job posting |
| `legal_entity_id` | integer | no | Identifier of the legal entity associated with the job posting |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Unique identifier for the shift |
| `employee_id` | integer | yes | Identifier for the employee assigned to the shift |
...
| `workplace_id` | integer | no | Identifier for the location |
| `time_settings_break_configuration_id` | integer | no | Identifier for the break configuration |
| `company_id` | integer | yes | Identifier for the company |
...
| `company_id` | integer | yes | Company identifier |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | identifier of the incidence (aka employee update). |
| `employee_id` | integer | no | identifier of employee related. |
| `legal_entity_id` | integer | yes | identifier of legal entity related. |
...
| `target_id` | integer | yes | The incidence (aka employee update) is also related to a another resource, for example for a leave target, the target identifier will be the leave id. |
...
| `status` | string | yes |  |
| `company_id` | integer | yes | identifier of company related. |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | identifier of the legal entity |
| `company_id` | integer | yes | company identifier |
| `country` | string | yes | country code of the legal entity |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | no | identifier for the contract version. |
| `company_id` | integer | yes | identifier for company. |
| `employee_id` | integer | yes | employee identifier, refers to /employees/employees endpoint. |
...
| `job_catalog_level_id` | integer | no | job catalog level identifier, refers to /job_catalog/levels endpoint. |
...
| `contracts_es_tariff_group_id` | integer | no | the group of cotization of the employee. |
...
| `es_contract_type_id` | integer | no | contract type identifier. |
| `es_working_day_type_id` | integer | no | working day type identifier. |
| `es_education_level_id` | integer | no | education level identifier. |
| `es_professional_category_id` | integer | no | professional category identifier. |
...
| `fr_contract_type_id` | integer | no | contract type identifier. |
| `fr_level_id` | integer | no | level identifier. |
| `fr_step_id` | integer | no | step identifier. |
| `fr_mutual_id` | integer | no | mutual identifier. |
| `fr_professional_category_id` | integer | no | professional category identifier. |
| `fr_work_type_id` | integer | no | work type identifier. |
| `de_contract_type_id` | integer | no | contract type identifier. |
| `de_base_salary_type_id` | integer | no | Identifier for the German base salary type. References a payroll concept available via the /payroll/concepts endpoint. |
| `pt_contract_type_id` | integer | no | contract type identifier. |
...
| `approvers_ids` | array<integer> | no |  |
| `status` | string | yes |  |
| `approval_author_id` | integer | no |  |
...
| `es_contract_type_id` | integer | no |  |
| `es_contract_type_name` | string | no |  |
| `es_working_day_type_id` | integer | no |  |
| `es_working_day_type_name` | string | no |  |
| `es_education_level_id` | integer | no |  |
| `es_education_level_name` | string | no |  |
| `es_professional_category_id` | integer | no |  |
| `es_professional_category_name` | string | no |  |
| `es_contribution_type_id` | integer | no |  |
| `es_contribution_type_name` | string | no |  |
| `es_agreement_code_id` | integer | no |  |
| `es_agreement_code_name` | string | no |  |
| `es_cno_occupation_id` | integer | no |  |
| `es_cno_occupation_name` | string | no |  |
| `es_regime_id` | integer | no |  |
| `es_regime_name` | string | no |  |
| `es_tariff_group_id` | integer | no |  |
| `es_tariff_group_name` | string | no |  |
| `es_occupation_code_id` | integer | no |  |
| `es_occupation_code_name` | string | no |  |
| `es_classification_id` | integer | no |  |
| `es_classification_name` | string | no |  |
| `es_a3innuva_job_position_id` | integer | no |  |
...
| `fr_contract_type_id` | integer | no |  |
| `fr_level_id` | integer | no |  |
| `fr_step_id` | integer | no |  |
| `fr_mutual_id` | integer | no |  |
| `fr_professional_category_id` | integer | no |  |
| `fr_work_type_id` | integer | no |  |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Schema identifier |
| `name` | string | yes | Schema name |
| `company_id` | integer | yes | Company identifier where this schema belongs |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `author_id` | integer | no | access identifier of the author, refers to /employees/employees endpoint. |
| `company_id` | integer | no | company identifier, refers to /api/me endpoint. |
| `content_type` | string | no | document content type. |
| `created_at` | string | yes | creation date of the document. |
| `employee_id` | integer | no | employee identifier associated to the document. |
...
| `folder_id` | integer | no | folder identifier, references to documents/folders endpoint. |
| `id` | integer | yes | document identifier. |
...
| `leave_id` | integer | no | leave identifier associated to the document, refers to /timeoff/leaves endpoint. |
| `public` | boolean | yes | flag to indicate if the document is public. |
| `signature_status` | string | no | document signature status. |
| `signees` | array<integer> | no | list of signee access identifiers associated to the document, refers to /employees/employees endpoint. |
...
| `company_id` | integer | no | Company ID of the folder |
| `id` | integer | yes | Folder ID |
| `name` | string | yes | Folder name |
| `parent_folder_id` | integer | no | Id of the parent folder |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | id of the employee. |
| `access_id` | integer | yes | access_id associated to the employee. |
...
| `company_id` | integer | yes | id of the company to which the employee belongs (not editable). |
| `legal_entity_id` | integer | no | legal entity of the employee, references to companies/legal_entities. |
| `location_id` | integer | yes | location id of the employee, references to locations/locations. |
| `default_work_area_id` | integer | no | Default work area ID for the employee at the default workplace. References locations/work_areas. |
...
| `manager_id` | integer | no | manager id of the employee, you can get the manager id from employees endpoint. |
| `timeoff_manager_id` | integer | no | Timeoff manager id of the employee. |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Unique identifier for the expensable |
| `type` | string | yes | Type of the expensable. Can be either "expense" or "mileage" or "perdiem" |
| `company_id` | integer | yes | The ID of the company that owns the expensable |
| `employee_id` | integer | yes | The ID of the employee that owns the expensable |
| `group_id` | integer | no | The optional ID of the group that the expensable belongs to |
| `legal_entity_id` | integer | no | The optional ID of the legal entity that the expensable belongs to |
| `created_at` | string | yes | The date and time when the expensable was created |
| `amount` | integer | no | The optional amount in cents |
| `currency` | string | yes | The currency code in ISO 4217 format |
| `status` | string | yes | The status of the expensable. Can be pending, approved, paid, archived, in_review, rejected, reversed, draft, or in_payroll |
| `description` | string | no | The optional description of the expensable |
| `reporter_id` | integer | no | The optional ID of the employee that reported the expensable |
...
| `expense_id` | integer | no | The optional ID of the expense that the expensable belongs to |
| `mileage_id` | integer | no | The optional ID of the mileage that the expensable belongs to |
| `per_diem_id` | integer | no | The optional ID of the per_diem that the expensable belongs to |
| `budget_id` | integer | no | The id of the budget |
| `project_id` | integer | no | The id of the project |
| `cost_center_ids` | array<integer> | yes | The ids of the cost centers |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Code identifier |
| `company_id` | integer | yes | Company ID where the code belongs to |
| `code` | string | yes | Code value |
| `codeable_id` | integer | yes | Related object ID. Used together with codeable_type |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Policy period id |
| `name` | string | no | Policy name with start and end date |
| `starts_on` | string | yes | The start date of the policy period |
| `policy_id` | integer | yes | The id of the policy associated with the policy period |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | The identifier of the supplement |
| `employee_id` | integer | yes | The identifier of the employee associated with the supplement |
| `company_id` | integer | yes | The identifier of the company associated with the supplement |
| `contracts_compensation_id` | integer | no | The contract compensation identifier associated with the supplement |
| `contracts_taxonomy_id` | integer | no | The taxonomy identifier associated with the supplement |
...
| `payroll_policy_period_id` | integer | no | The payroll policy period identifier associated with the supplement |
...
| `legal_entity_id` | integer | no | The legal entity identifier associated with the supplement |

### performance_review_process

| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Review process ID |
...
| --- | --- | --- | --- |
| `id` | integer | yes | Unique identifier for the shift |
| `company_id` | integer | yes | Identifier of the company that owns this shift |
...
| `location_id` | integer | no | Identifier of the location where the shift takes place. Can be null if the shift uses the employee's default location |
| `locations_work_area_id` | integer | no | Identifier of the specific work area within the location where the shift occurs. Work areas allow further subdivision of locations |
| `employee_id` | integer | yes | Identifier of the employee assigned to this shift |
...
| `company_id` | integer | yes | Company identifier of the author of the task |
| `content` | string | no | Content of the task |
| `due_on` | string | no | Due on date of the task |
| `assignee_ids` | array<integer> | yes | Employees assigned to the task, assignee_id references to access_id |
| `author_employee_id` | integer | no | Employee id of the author of the task |
| `completed_at` | string | no | Completed at date of the task |
| `completed_by_id` | integer | no | Completed by identifier |
| `created_at` | string | yes |  |
...
| `company_id` | integer | no | Company ID of the membership |
| `employee_id` | integer | yes | Employee ID of the membership |
| `team_id` | integer | yes | Team ID of the membership |
...
| `description` | string | no |  |
| `avatar` | string | no |  |
| `employee_ids` | array<integer> | no |  |
| `lead_ids` | array<integer> | no |  |
| `company_id` | integer | yes |  |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Unique identifier of the blocked period |
| `company_id` | integer | yes | Company id of the blocked period |
| `name` | string | yes | Name of the blocked period. |
| `leave_type_ids` | array<integer> | yes | Leave types for which absence request has been blocked |
| `time_periods` | array<object> | yes | The tenure periods associated with the allowance. |
| `strategy` | string | yes | Type of access group |
| `members` | array<integer> | yes | Employees whose timeoff will be affected |
| `location_ids` | array<integer> | no | List of locations workplace identifiers where the employees are located |
| `team_ids` | array<integer> | no | List of team identifiers which the selected employees belong to |
| `legal_entity_ids` | array<integer> | no | List of legal entity identifiers which the selected employees belong to |

### timeoff_leave

| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Identifier of the Leave |
| `company_id` | integer | yes | Company identifier of the employee of the leave |
| `employee_id` | integer | yes | Employee identifier of the leave |
...
| `leave_type_id` | integer | no | The identifier for the type of leave |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Identifier of the leave type |
...
| `company_id` | integer | yes | Identifier of the company associated with this leave type |
| `is_attachment_mandatory` | boolean | no | Whether the attachment is mandatory |
| `allowance_ids` | array<integer> | yes | List of allowance identifiers associated with this leave type |
...
| field | type | required | description |
| --- | --- | --- | --- |
| `id` | integer | yes | Identifier of the course |
| `company_id` | integer | yes | Company identifier |
| `author_id` | integer | yes | The person that creates the training |
...
| `category_ids` | array<integer> | no | List of ids of training categories |
...
| `competency_ids` | array<integer> | yes | List of ids of training competencies |
...
| `created_at` | string | yes |  |
| `updated_at` | string | yes |  |
| `employee_ids` | array<integer> | yes |  |
