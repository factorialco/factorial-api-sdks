...
| `client.apiPublic.webhookSubscriptions.delete(id)` | DELETE | `/api/2026-07-01/resources/api_public/webhook_subscriptions/{id}` | Deletes a Webhook subscription |
| `client.apiPublic.webhookSubscriptions.get(id)` | GET | `/api/2026-07-01/resources/api_public/webhook_subscriptions/{id}` | Reads a single Webhook subscription |
| `client.apiPublic.webhookSubscriptions.update(id, body)` | PUT | `/api/2026-07-01/resources/api_public/webhook_subscriptions/{id}` | Updates a Webhook subscription |
...
| `client.ats.answers.get(id)` | GET | `/api/2026-07-01/resources/ats/answers/{id}` | Reads a single Answer |
| `client.ats.applicationPhases.list()` | GET | `/api/2026-07-01/resources/ats/application_phases` | Reads all Application phases |
| `client.ats.applicationPhases.get(id)` | GET | `/api/2026-07-01/resources/ats/application_phases/{id}` | Reads a single Application phase |
...
| `client.ats.applications.delete(id)` | DELETE | `/api/2026-07-01/resources/ats/applications/{id}` | Deletes an Application |
| `client.ats.applications.get(id)` | GET | `/api/2026-07-01/resources/ats/applications/{id}` | Reads a single Application |
| `client.ats.applications.update(id, body)` | PUT | `/api/2026-07-01/resources/ats/applications/{id}` | Updates an Application |
| `client.ats.candidateSources.list()` | GET | `/api/2026-07-01/resources/ats/candidate_sources` | Reads all Candidate sources |
| `client.ats.candidateSources.get(id)` | GET | `/api/2026-07-01/resources/ats/candidate_sources/{id}` | Reads a single Candidate source |
...
| `client.ats.candidates.delete(id)` | DELETE | `/api/2026-07-01/resources/ats/candidates/{id}` | Deletes a Candidate |
| `client.ats.candidates.get(id)` | GET | `/api/2026-07-01/resources/ats/candidates/{id}` | Reads a single Candidate |
| `client.ats.candidates.update(id, body)` | PUT | `/api/2026-07-01/resources/ats/candidates/{id}` | Updates a Candidate |
...
| `client.ats.evaluationForms.get(id)` | GET | `/api/2026-07-01/resources/ats/evaluation_forms/{id}` | Reads a single Evaluation form |
...
| `client.ats.feedbacks.delete(id)` | DELETE | `/api/2026-07-01/resources/ats/feedbacks/{id}` | Deletes a Feedback |
| `client.ats.feedbacks.get(id)` | GET | `/api/2026-07-01/resources/ats/feedbacks/{id}` | Reads a single Feedback |
| `client.ats.feedbacks.update(id, body)` | PUT | `/api/2026-07-01/resources/ats/feedbacks/{id}` | Updates a Feedback |
| `client.ats.hiringStages.list()` | GET | `/api/2026-07-01/resources/ats/hiring_stages` | Reads all Hiring stages |
| `client.ats.hiringStages.get(id)` | GET | `/api/2026-07-01/resources/ats/hiring_stages/{id}` | Reads a single Hiring stage |
...
| `client.ats.jobPostings.delete(id)` | DELETE | `/api/2026-07-01/resources/ats/job_postings/{id}` | Deletes a Job posting |
| `client.ats.jobPostings.get(id)` | GET | `/api/2026-07-01/resources/ats/job_postings/{id}` | Reads a single Job posting |
| `client.ats.jobPostings.update(id, body)` | PUT | `/api/2026-07-01/resources/ats/job_postings/{id}` | Updates a Job posting |
...
| `client.ats.messages.get(id)` | GET | `/api/2026-07-01/resources/ats/messages/{id}` | Reads a single Message |
...
| `client.ats.questions.delete(id)` | DELETE | `/api/2026-07-01/resources/ats/questions/{id}` | Deletes a Question |
| `client.ats.questions.get(id)` | GET | `/api/2026-07-01/resources/ats/questions/{id}` | Reads a single Question |
| `client.ats.questions.update(id, body)` | PUT | `/api/2026-07-01/resources/ats/questions/{id}` | Updates a Question |
| `client.ats.rejectionReasons.list()` | GET | `/api/2026-07-01/resources/ats/rejection_reasons` | Reads all Rejection reasons |
| `client.ats.rejectionReasons.get(id)` | GET | `/api/2026-07-01/resources/ats/rejection_reasons/{id}` | Reads a single Rejection reason |
...
| `client.attendance.breakConfigurations.get(id)` | GET | `/api/2026-07-01/resources/attendance/break_configurations/{id}` | Reads a single Break configuration |
| `client.attendance.breakConfigurations.update(id, body)` | PUT | `/api/2026-07-01/resources/attendance/break_configurations/{id}` | Updates a Break configuration |
...
| `client.attendance.editTimesheetRequests.delete(id)` | DELETE | `/api/2026-07-01/resources/attendance/edit_timesheet_requests/{id}` | Deletes an Edit timesheet request |
| `client.attendance.editTimesheetRequests.get(id)` | GET | `/api/2026-07-01/resources/attendance/edit_timesheet_requests/{id}` | Reads all Edit timesheet requests |
| `client.attendance.editTimesheetRequests.update(id, body)` | PUT | `/api/2026-07-01/resources/attendance/edit_timesheet_requests/{id}` | Updates an Edit timesheet request |
...
| `client.attendance.overtimeRequests.delete(id)` | DELETE | `/api/2026-07-01/resources/attendance/overtime_requests/{id}` | Deletes an Overtime request |
| `client.attendance.overtimeRequests.get(id)` | GET | `/api/2026-07-01/resources/attendance/overtime_requests/{id}` | Reads a single Overtime request |
| `client.attendance.overtimeRequests.update(id, body)` | PUT | `/api/2026-07-01/resources/attendance/overtime_requests/{id}` | Updates an Overtime request |
...
| `client.attendance.shifts.delete(id)` | DELETE | `/api/2026-07-01/resources/attendance/shifts/{id}` | Deletes a Shift |
| `client.attendance.shifts.get(id)` | GET | `/api/2026-07-01/resources/attendance/shifts/{id}` | Reads a single Shift |
| `client.attendance.shifts.update(id, body)` | PUT | `/api/2026-07-01/resources/attendance/shifts/{id}` | Updates a Shift |
...
| `client.banking.bankAccounts.get(id)` | GET | `/api/2026-07-01/resources/banking/bank_accounts/{id}` | Reads a single Bank account |
| `client.banking.cardPayments.list()` | GET | `/api/2026-07-01/resources/banking/card_payments` | Reads all Card payments |
| `client.banking.cardPayments.get(id)` | GET | `/api/2026-07-01/resources/banking/card_payments/{id}` | Reads a single Card payment |
| `client.banking.transactions.list()` | GET | `/api/2026-07-01/resources/banking/transactions` | Reads all Transactions |
| `client.banking.transactions.get(id)` | GET | `/api/2026-07-01/resources/banking/transactions/{id}` | Reads a single Transaction |
...
| `client.bookkeepersManagement.incidences.get(id)` | GET | `/api/2026-07-01/resources/bookkeepers_management/incidences/{id}` | Reads a single Incidence |
| `client.bookkeepersManagement.incidences.update(id, body)` | PUT | `/api/2026-07-01/resources/bookkeepers_management/incidences/{id}` | Updates an Incidence |
...
| `client.companies.legalEntities.get(id)` | GET | `/api/2026-07-01/resources/companies/legal_entities/{id}` | Reads a single Legal entity |
...
| `client.compensations.concepts.get(id)` | GET | `/api/2026-07-01/resources/compensations/concepts/{id}` | Reads a single Concept |
...
| `client.contracts.compensations.delete(id)` | DELETE | `/api/2026-07-01/resources/contracts/compensations/{id}` | Deletes a Compensation |
| `client.contracts.compensations.get(id)` | GET | `/api/2026-07-01/resources/contracts/compensations/{id}` | Reads a single Compensation |
| `client.contracts.compensations.update(id, body)` | PUT | `/api/2026-07-01/resources/contracts/compensations/{id}` | Updates a Compensation |
...
| `client.contracts.contractTemplates.get(id)` | GET | `/api/2026-07-01/resources/contracts/contract_templates/{id}` | Reads a single Contract template |
...
| `client.contracts.contractVersionHistories.get(id)` | GET | `/api/2026-07-01/resources/contracts/contract_version_histories/{id}` | Reads a single Contract version history |
...
| `client.contracts.contractVersions.delete(id)` | DELETE | `/api/2026-07-01/resources/contracts/contract_versions/{id}` | Deletes a Contract version |
| `client.contracts.contractVersions.get(id)` | GET | `/api/2026-07-01/resources/contracts/contract_versions/{id}` | Reads a single Contract version |
| `client.contracts.contractVersions.update(id, body)` | PUT | `/api/2026-07-01/resources/contracts/contract_versions/{id}` | Updates a Contract version |
...
| `client.contracts.frenchContractTypes.get(id)` | GET | `/api/2026-07-01/resources/contracts/french_contract_types/{id}` | Reads a single French contract type |
...
| `client.contracts.germanContractTypes.get(id)` | GET | `/api/2026-07-01/resources/contracts/german_contract_types/{id}` | Reads a single German contract type |
...
| `client.contracts.portugueseContractTypes.get(id)` | GET | `/api/2026-07-01/resources/contracts/portuguese_contract_types/{id}` | Reads a single Portuguese contract type |
...
| `client.contracts.spanishContractTypes.get(id)` | GET | `/api/2026-07-01/resources/contracts/spanish_contract_types/{id}` | Reads a single Spanish contract type |
...
| `client.contracts.spanishEducationLevels.get(id)` | GET | `/api/2026-07-01/resources/contracts/spanish_education_levels/{id}` | Reads a single Spanish education level |
...
| `client.contracts.spanishProfessionalCategories.get(id)` | GET | `/api/2026-07-01/resources/contracts/spanish_professional_categories/{id}` | Reads a single Spanish professional category |
...
| `client.contracts.spanishWorkingDayTypes.get(id)` | GET | `/api/2026-07-01/resources/contracts/spanish_working_day_types/{id}` | Reads a single Spanish working day type |
| `client.contracts.taxonomies.list()` | GET | `/api/2026-07-01/resources/contracts/taxonomies` | Reads all Taxonomies |
| `client.contracts.taxonomies.get(id)` | GET | `/api/2026-07-01/resources/contracts/taxonomies/{id}` | Reads a single Taxonomy |
...
| `client.customFields.fields.delete(id)` | DELETE | `/api/2026-07-01/resources/custom_fields/fields/{id}` | Deletes a Field |
| `client.customFields.fields.get(id)` | GET | `/api/2026-07-01/resources/custom_fields/fields/{id}` | Reads a single Field |
...
| `client.customFields.options.get(id)` | GET | `/api/2026-07-01/resources/custom_fields/options/{id}` | Reads a single Option |
...
| `client.customFields.resourceFields.get(id)` | GET | `/api/2026-07-01/resources/custom_fields/resource_fields/{id}` | Reads a single Resource field |
...
| `client.customFields.values.get(id)` | GET | `/api/2026-07-01/resources/custom_fields/values/{id}` | Reads a single Value |
| `client.customFields.values.update(id, body)` | PUT | `/api/2026-07-01/resources/custom_fields/values/{id}` | Updates a Value |
...
| `client.customResources.resources.get(id)` | GET | `/api/2026-07-01/resources/custom_resources/resources/{id}` | Reads a single Resource |
...
| `client.customResources.schemas.get(id)` | GET | `/api/2026-07-01/resources/custom_resources/schemas/{id}` | Reads a single Schema |
...
| `client.customResources.values.get(id)` | GET | `/api/2026-07-01/resources/custom_resources/values/{id}` | Reads a single Value |
...
| `client.documents.documents.delete(id)` | DELETE | `/api/2026-07-01/resources/documents/documents/{id}` | Deletes a Document |
| `client.documents.documents.get(id)` | GET | `/api/2026-07-01/resources/documents/documents/{id}` | Reads a single Document |
| `client.documents.documents.update(id, body)` | PUT | `/api/2026-07-01/resources/documents/documents/{id}` | Updates a Document |
...
| `client.documents.folders.get(id)` | GET | `/api/2026-07-01/resources/documents/folders/{id}` | Reads a single Folder |
| `client.documents.folders.update(id, body)` | PUT | `/api/2026-07-01/resources/documents/folders/{id}` | Updates a Folder |
...
| `client.employeeUpdates.absences.get(id)` | GET | `/api/2026-07-01/resources/employee_updates/absences/{id}` | Reads a single Absence |
...
| `client.employeeUpdates.contractChanges.get(id)` | GET | `/api/2026-07-01/resources/employee_updates/contract_changes/{id}` | Reads a single Contract change |
| `client.employeeUpdates.newHires.list()` | GET | `/api/2026-07-01/resources/employee_updates/new_hires` | Reads all New hires |
| `client.employeeUpdates.newHires.get(id)` | GET | `/api/2026-07-01/resources/employee_updates/new_hires/{id}` | Reads a single New hire |
...
| `client.employeeUpdates.personalChanges.get(id)` | GET | `/api/2026-07-01/resources/employee_updates/personal_changes/{id}` | Reads a single Personal change |
| `client.employeeUpdates.summaries.list()` | GET | `/api/2026-07-01/resources/employee_updates/summaries` | Reads all Summaries |
| `client.employeeUpdates.summaries.get(id)` | GET | `/api/2026-07-01/resources/employee_updates/summaries/{id}` | Reads a single Summary |
...
| `client.employeeUpdates.terminations.get(id)` | GET | `/api/2026-07-01/resources/employee_updates/terminations/{id}` | Reads a single Termination |
...
| `client.employees.employees.get(id)` | GET | `/api/2026-07-01/resources/employees/employees/{id}` | Reads a single Employee |
| `client.employees.employees.update(id, body)` | PUT | `/api/2026-07-01/resources/employees/employees/{id}` | Updates an Employee |
...
| `client.expenses.expensables.get(id)` | GET | `/api/2026-07-01/resources/expenses/expensables/{id}` | Reads a single Expensable |
| `client.expenses.expenses.list()` | GET | `/api/2026-07-01/resources/expenses/expenses` | Reads all Expenses |
| `client.expenses.expenses.get(id)` | GET | `/api/2026-07-01/resources/expenses/expenses/{id}` | Reads a single Expense |
| `client.expenses.mileages.list()` | GET | `/api/2026-07-01/resources/expenses/mileages` | Reads all Mileages |
| `client.expenses.mileages.get(id)` | GET | `/api/2026-07-01/resources/expenses/mileages/{id}` | Reads a single Mileage |
| `client.expenses.perDiems.list()` | GET | `/api/2026-07-01/resources/expenses/per_diems` | Reads all Per diems |
| `client.expenses.perDiems.get(id)` | GET | `/api/2026-07-01/resources/expenses/per_diems/{id}` | Reads a single Per diem |
...
| `client.finance.accountingSettings.get(id)` | GET | `/api/2026-07-01/resources/finance/accounting_settings/{id}` | Reads a single Accounting setting |
...
| `client.finance.accounts.get(id)` | GET | `/api/2026-07-01/resources/finance/accounts/{id}` | Reads a single Account |
| `client.finance.accounts.update(id, body)` | PUT | `/api/2026-07-01/resources/finance/accounts/{id}` | Updates an Account |
| `client.finance.budgetOptions.list()` | GET | `/api/2026-07-01/resources/finance/budget_options` | Reads all Budget options |
| `client.finance.budgetOptions.get(id)` | GET | `/api/2026-07-01/resources/finance/budget_options/{id}` | Reads a single Budget option |
| `client.finance.categories.list()` | GET | `/api/2026-07-01/resources/finance/categories` | Reads all Categories |
| `client.finance.categories.get(id)` | GET | `/api/2026-07-01/resources/finance/categories/{id}` | Reads a single Category |
...
| `client.finance.contacts.get(id)` | GET | `/api/2026-07-01/resources/finance/contacts/{id}` | Reads a single Contact |
| `client.finance.contacts.update(id, body)` | PUT | `/api/2026-07-01/resources/finance/contacts/{id}` | Updates a Contact |
...
| `client.finance.costCenters.delete(id)` | DELETE | `/api/2026-07-01/resources/finance/cost_centers/{id}` | Deletes a Cost center |
| `client.finance.costCenters.get(id)` | GET | `/api/2026-07-01/resources/finance/cost_centers/{id}` | Reads a single Cost center |
...
| `client.finance.financialDocuments.get(id)` | GET | `/api/2026-07-01/resources/finance/financial_documents/{id}` | Reads a single Financial document |
...
| `client.finance.journalEntries.get(id)` | GET | `/api/2026-07-01/resources/finance/journal_entries/{id}` | Reads a single Journal entry |
| `client.finance.journalLines.list()` | GET | `/api/2026-07-01/resources/finance/journal_lines` | Reads all Journal lines |
| `client.finance.journalLines.get(id)` | GET | `/api/2026-07-01/resources/finance/journal_lines/{id}` | Reads a single Journal line |
...
| `client.finance.ledgerAccountResources.get(id)` | GET | `/api/2026-07-01/resources/finance/ledger_account_resources/{id}` | Reads a single Ledger account resource |
...
| `client.finance.taxRates.get(id)` | GET | `/api/2026-07-01/resources/finance/tax_rates/{id}` | Reads a single Tax rate |
| `client.finance.taxRates.update(id, body)` | PUT | `/api/2026-07-01/resources/finance/tax_rates/{id}` | Updates a Tax rate |
...
| `client.finance.taxTypes.get(id)` | GET | `/api/2026-07-01/resources/finance/tax_types/{id}` | Reads a single Tax type |
| `client.finance.taxTypes.update(id, body)` | PUT | `/api/2026-07-01/resources/finance/tax_types/{id}` | Updates a Tax type |
...
| `client.holidays.companyHolidays.get(id)` | GET | `/api/2026-07-01/resources/holidays/company_holidays/{id}` | Reads a single Company holiday |
...
| `client.integrations.syncableSyncRuns.update(id, body)` | PUT | `/api/2026-07-01/resources/integrations/syncable_sync_runs/{id}` | Updates a Syncable sync run |
...
| `client.itManagement.itAssetModels.get(id)` | GET | `/api/2026-07-01/resources/it_management/it_asset_models/{id}` | Reads a single It asset model |
| `client.itManagement.itAssetModels.update(id, body)` | PUT | `/api/2026-07-01/resources/it_management/it_asset_models/{id}` | Updates an It asset model |
...
| `client.itManagement.itAssets.delete(id)` | DELETE | `/api/2026-07-01/resources/it_management/it_assets/{id}` | Deletes an It asset |
| `client.itManagement.itAssets.get(id)` | GET | `/api/2026-07-01/resources/it_management/it_assets/{id}` | Reads a single It asset |
| `client.itManagement.itAssets.update(id, body)` | PUT | `/api/2026-07-01/resources/it_management/it_assets/{id}` | Updates an It asset |
...
| `client.jobCatalog.levels.get(id)` | GET | `/api/2026-07-01/resources/job_catalog/levels/{id}` | Reads a single Level |
...
| `client.jobCatalog.roles.get(id)` | GET | `/api/2026-07-01/resources/job_catalog/roles/{id}` | Reads a single Role |
...
| `client.locations.locations.delete(id)` | DELETE | `/api/2026-07-01/resources/locations/locations/{id}` | Deletes a Location |
| `client.locations.locations.get(id)` | GET | `/api/2026-07-01/resources/locations/locations/{id}` | Reads a single Location |
| `client.locations.locations.update(id, body)` | PUT | `/api/2026-07-01/resources/locations/locations/{id}` | Updates a Location |
...
| `client.locations.workAreas.get(id)` | GET | `/api/2026-07-01/resources/locations/work_areas/{id}` | Reads a single Work area |
| `client.locations.workAreas.update(id, body)` | PUT | `/api/2026-07-01/resources/locations/work_areas/{id}` | Updates a Work area |
...
| `client.payroll.familySituations.update(id, body)` | PUT | `/api/2026-07-01/resources/payroll/family_situations/{id}` | Updates a Family situation |
...
| `client.payroll.supplements.delete(id)` | DELETE | `/api/2026-07-01/resources/payroll/supplements/{id}` | Deletes a Supplement |
| `client.payroll.supplements.get(id)` | GET | `/api/2026-07-01/resources/payroll/supplements/{id}` | Reads a single Supplement |
| `client.payroll.supplements.update(id, body)` | PUT | `/api/2026-07-01/resources/payroll/supplements/{id}` | Updates a Supplement |
...
| `client.payrollEmployees.identifiers.delete(id)` | DELETE | `/api/2026-07-01/resources/payroll_employees/identifiers/{id}` | Deletes an Identifier |
| `client.payrollEmployees.identifiers.get(id)` | GET | `/api/2026-07-01/resources/payroll_employees/identifiers/{id}` | Reads a single Identifier |
| `client.payrollEmployees.identifiers.update(id, body)` | PUT | `/api/2026-07-01/resources/payroll_employees/identifiers/{id}` | Updates an Identifier |
...
| `client.payrollIntegrationsBase.codes.delete(id)` | DELETE | `/api/2026-07-01/resources/payroll_integrations_base/codes/{id}` | Deletes a Code |
| `client.payrollIntegrationsBase.codes.update(id, body)` | PUT | `/api/2026-07-01/resources/payroll_integrations_base/codes/{id}` | Updates a Code |
...
| `client.performance.agreements.get(id)` | GET | `/api/2026-07-01/resources/performance/agreements/{id}` | Reads a single Agreement |
...
| `client.performance.companyEmployeeScoreScales.get(id)` | GET | `/api/2026-07-01/resources/performance/company_employee_score_scales/{id}` | Reads a single Company employee score scale |
...
| `client.performance.employeeScoreScales.get(id)` | GET | `/api/2026-07-01/resources/performance/employee_score_scales/{id}` | Reads a single Employee score scale |
...
| `client.performance.reviewEvaluationScores.get(id)` | GET | `/api/2026-07-01/resources/performance/review_evaluation_scores/{id}` | Reads a single Review evaluation score |
...
| `client.performance.reviewEvaluations.get(id)` | GET | `/api/2026-07-01/resources/performance/review_evaluations/{id}` | Reads a single Review evaluation |
...
| `client.performance.reviewOwners.delete(id)` | DELETE | `/api/2026-07-01/resources/performance/review_owners/{id}` | Deletes a Review owner |
...
| `client.performance.reviewProcessCustomTemplates.get(id)` | GET | `/api/2026-07-01/resources/performance/review_process_custom_templates/{id}` | Reads a single Review process custom template |
...
| `client.performance.reviewProcessTargets.delete(id)` | DELETE | `/api/2026-07-01/resources/performance/review_process_targets/{id}` | Deletes a Review process target |
| `client.performance.reviewProcessTargets.get(id)` | GET | `/api/2026-07-01/resources/performance/review_process_targets/{id}` | Reads a single Review process target |
...
| `client.performance.reviewProcesses.delete(id)` | DELETE | `/api/2026-07-01/resources/performance/review_processes/{id}` | Deletes a Review process |
| `client.performance.reviewProcesses.get(id)` | GET | `/api/2026-07-01/resources/performance/review_processes/{id}` | Reads a single Review process |
...
| `client.performance.reviewQuestionnaireByStrategies.get(id)` | GET | `/api/2026-07-01/resources/performance/review_questionnaire_by_strategies/{id}` | Reads a single Review questionnaire by strategy |
...
| `client.performance.reviewVisibilitySettings.update(id, body)` | PUT | `/api/2026-07-01/resources/performance/review_visibility_settings/{id}` | Updates a Review visibility setting |
...
| `client.performance.targetManagers.get(id)` | GET | `/api/2026-07-01/resources/performance/target_managers/{id}` | Reads a single Target manager |
...
| `client.posts.comments.delete(id)` | DELETE | `/api/2026-07-01/resources/posts/comments/{id}` | Deletes a Comment |
| `client.posts.comments.get(id)` | GET | `/api/2026-07-01/resources/posts/comments/{id}` | Reads a single Comment |
| `client.posts.comments.update(id, body)` | PUT | `/api/2026-07-01/resources/posts/comments/{id}` | Updates a Comment |
...
| `client.posts.groups.delete(id)` | DELETE | `/api/2026-07-01/resources/posts/groups/{id}` | Deletes a Group |
| `client.posts.groups.get(id)` | GET | `/api/2026-07-01/resources/posts/groups/{id}` | Reads a single Group |
| `client.posts.groups.update(id, body)` | PUT | `/api/2026-07-01/resources/posts/groups/{id}` | Updates a Group |
...
| `client.posts.posts.delete(id)` | DELETE | `/api/2026-07-01/resources/posts/posts/{id}` | Deletes a Post |
| `client.posts.posts.get(id)` | GET | `/api/2026-07-01/resources/posts/posts/{id}` | Reads a single Post |
| `client.posts.posts.update(id, body)` | PUT | `/api/2026-07-01/resources/posts/posts/{id}` | Updates a Post |
...
| `client.procurement.purchaseOrders.get(id)` | GET | `/api/2026-07-01/resources/procurement/purchase_orders/{id}` | Reads a single Purchase order |
...
| `client.procurement.purchaseRequests.get(id)` | GET | `/api/2026-07-01/resources/procurement/purchase_requests/{id}` | Reads a single Purchase request |
| `client.procurement.types.list()` | GET | `/api/2026-07-01/resources/procurement/types` | Reads all Types |
| `client.procurement.types.get(id)` | GET | `/api/2026-07-01/resources/procurement/types/{id}` | Reads a single Type |
...
| `client.projectManagement.budgetStrategies.delete(id)` | DELETE | `/api/2026-07-01/resources/project_management/budget_strategies/{id}` | Deletes a Budget strategy |
| `client.projectManagement.budgetStrategies.get(id)` | GET | `/api/2026-07-01/resources/project_management/budget_strategies/{id}` | Reads a single Budget strategy |
| `client.projectManagement.budgetStrategies.update(id, body)` | PUT | `/api/2026-07-01/resources/project_management/budget_strategies/{id}` | Updates a Budget strategy |
...
| `client.projectManagement.expenseRecords.get(id)` | GET | `/api/2026-07-01/resources/project_management/expense_records/{id}` | Reads a single Expense record |
...
| `client.projectManagement.imputableProjects.get(id)` | GET | `/api/2026-07-01/resources/project_management/imputable_projects/{id}` | Reads a single Imputable project |
...
| `client.projectManagement.plannedRecords.delete(id)` | DELETE | `/api/2026-07-01/resources/project_management/planned_records/{id}` | Deletes a Planned record |
| `client.projectManagement.plannedRecords.get(id)` | GET | `/api/2026-07-01/resources/project_management/planned_records/{id}` | Reads a single Planned record |
| `client.projectManagement.plannedRecords.update(id, body)` | PUT | `/api/2026-07-01/resources/project_management/planned_records/{id}` | Updates a Planned record |
...
| `client.projectManagement.projectTasks.get(id)` | GET | `/api/2026-07-01/resources/project_management/project_tasks/{id}` | Reads a single Project task |
| `client.projectManagement.projectTasks.update(id, body)` | PUT | `/api/2026-07-01/resources/project_management/project_tasks/{id}` | Updates a Project task |
...
| `client.projectManagement.projectWorkers.get(id)` | GET | `/api/2026-07-01/resources/project_management/project_workers/{id}` | Reads a single Project worker |
...
| `client.projectManagement.projects.get(id)` | GET | `/api/2026-07-01/resources/project_management/projects/{id}` | Reads a single Project |
| `client.projectManagement.projects.update(id, body)` | PUT | `/api/2026-07-01/resources/project_management/projects/{id}` | Updates a Project |
...
| `client.projectManagement.subprojects.delete(id)` | DELETE | `/api/2026-07-01/resources/project_management/subprojects/{id}` | Deletes a Subproject |
| `client.projectManagement.subprojects.get(id)` | GET | `/api/2026-07-01/resources/project_management/subprojects/{id}` | Reads a single Subproject |
| `client.projectManagement.subprojects.update(id, body)` | PUT | `/api/2026-07-01/resources/project_management/subprojects/{id}` | Updates a Subproject |
...
| `client.projectManagement.timeRecords.delete(id)` | DELETE | `/api/2026-07-01/resources/project_management/time_records/{id}` | Deletes a Time record |
| `client.projectManagement.timeRecords.get(id)` | GET | `/api/2026-07-01/resources/project_management/time_records/{id}` | Reads a single Time record |
...
| `client.shiftManagement.shifts.delete(id)` | DELETE | `/api/2026-07-01/resources/shift_management/shifts/{id}` | Deletes a Shift |
| `client.shiftManagement.shifts.get(id)` | GET | `/api/2026-07-01/resources/shift_management/shifts/{id}` | Reads a single Shift |
...
| `client.tasks.taskFiles.delete(id)` | DELETE | `/api/2026-07-01/resources/tasks/task_files/{id}` | Deletes a Task file |
| `client.tasks.taskFiles.get(id)` | GET | `/api/2026-07-01/resources/tasks/task_files/{id}` | Reads a single Task file |
...
| `client.tasks.tasks.delete(id)` | DELETE | `/api/2026-07-01/resources/tasks/tasks/{id}` | Deletes a Task |
| `client.tasks.tasks.get(id)` | GET | `/api/2026-07-01/resources/tasks/tasks/{id}` | Reads a single Task |
| `client.tasks.tasks.update(id, body)` | PUT | `/api/2026-07-01/resources/tasks/tasks/{id}` | Updates a Task |
...
| `client.teams.memberships.delete(id)` | DELETE | `/api/2026-07-01/resources/teams/memberships/{id}` | Deletes a Membership |
| `client.teams.memberships.get(id)` | GET | `/api/2026-07-01/resources/teams/memberships/{id}` | Reads a single Membership |
| `client.teams.memberships.update(id, body)` | PUT | `/api/2026-07-01/resources/teams/memberships/{id}` | Updates a Membership |
...
| `client.teams.teams.delete(id)` | DELETE | `/api/2026-07-01/resources/teams/teams/{id}` | Deletes a Team |
| `client.teams.teams.get(id)` | GET | `/api/2026-07-01/resources/teams/teams/{id}` | Reads a single Team |
| `client.teams.teams.update(id, body)` | PUT | `/api/2026-07-01/resources/teams/teams/{id}` | Updates a Team |
...
| `client.timePlanning.plannedBreaks.get(id)` | GET | `/api/2026-07-01/resources/time_planning/planned_breaks/{id}` | Reads a single Planned break |
...
| `client.timePlanning.planningVersions.delete(id)` | DELETE | `/api/2026-07-01/resources/time_planning/planning_versions/{id}` | Deletes a Planning version |
| `client.timePlanning.planningVersions.update(id, body)` | PUT | `/api/2026-07-01/resources/time_planning/planning_versions/{id}` | Updates a Planning version |
...
| `client.timeSettings.breakConfigurations.get(id)` | GET | `/api/2026-07-01/resources/time_settings/break_configurations/{id}` | Reads a single Break configuration |
| `client.timeSettings.breakConfigurations.update(id, body)` | PUT | `/api/2026-07-01/resources/time_settings/break_configurations/{id}` | Updates a Break configuration |
...
| `client.timeoff.allowanceIncidences.delete(id)` | DELETE | `/api/2026-07-01/resources/timeoff/allowance_incidences/{id}` | Deletes an Allowance incidence |
| `client.timeoff.allowanceIncidences.get(id)` | GET | `/api/2026-07-01/resources/timeoff/allowance_incidences/{id}` | Reads a single Allowance incidence |
| `client.timeoff.allowanceIncidences.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/allowance_incidences/{id}` | Updates an Allowance incidence |
| `client.timeoff.allowanceStats.list()` | GET | `/api/2026-07-01/resources/timeoff/allowance_stats` | Reads all Allowance stats |
| `client.timeoff.allowanceStats.get(id)` | GET | `/api/2026-07-01/resources/timeoff/allowance_stats/{id}` | Reads a single Allowance stat |
...
| `client.timeoff.allowances.delete(id)` | DELETE | `/api/2026-07-01/resources/timeoff/allowances/{id}` | Deletes an Allowance |
| `client.timeoff.allowances.get(id)` | GET | `/api/2026-07-01/resources/timeoff/allowances/{id}` | Reads a single Allowance |
| `client.timeoff.allowances.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/allowances/{id}` | Updates an Allowance |
...
| `client.timeoff.blockedPeriods.delete(id)` | DELETE | `/api/2026-07-01/resources/timeoff/blocked_periods/{id}` | Deletes a Blocked period |
| `client.timeoff.blockedPeriods.get(id)` | GET | `/api/2026-07-01/resources/timeoff/blocked_periods/{id}` | Reads a single Blocked period |
| `client.timeoff.blockedPeriods.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/blocked_periods/{id}` | Updates a Blocked period |
...
| `client.timeoff.leaveTypes.get(id)` | GET | `/api/2026-07-01/resources/timeoff/leave_types/{id}` | Reads a single Leave type |
| `client.timeoff.leaveTypes.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/leave_types/{id}` | Updates a Leave type |
...
| `client.timeoff.leaves.delete(id)` | DELETE | `/api/2026-07-01/resources/timeoff/leaves/{id}` | Deletes a Leave |
| `client.timeoff.leaves.get(id)` | GET | `/api/2026-07-01/resources/timeoff/leaves/{id}` | Reads a single Leave |
| `client.timeoff.leaves.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/leaves/{id}` | Updates a Leave |
...
| `client.timeoff.policies.delete(id)` | DELETE | `/api/2026-07-01/resources/timeoff/policies/{id}` | Deletes a Policy |
| `client.timeoff.policies.get(id)` | GET | `/api/2026-07-01/resources/timeoff/policies/{id}` | Reads a single Policy |
| `client.timeoff.policies.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/policies/{id}` | Updates a Policy |
...
| `client.timeoff.policyAssignments.delete(id)` | DELETE | `/api/2026-07-01/resources/timeoff/policy_assignments/{id}` | Deletes a Policy assignment |
| `client.timeoff.policyAssignments.get(id)` | GET | `/api/2026-07-01/resources/timeoff/policy_assignments/{id}` | Reads a single Policy assignment |
| `client.timeoff.policyAssignments.update(id, body)` | PUT | `/api/2026-07-01/resources/timeoff/policy_assignments/{id}` | Updates a Policy assignment |
...
| `client.trainings.categories.delete(id)` | DELETE | `/api/2026-07-01/resources/trainings/categories/{id}` | Deletes a Category |
| `client.trainings.categories.get(id)` | GET | `/api/2026-07-01/resources/trainings/categories/{id}` | Reads a single Category |
...
| `client.trainings.sessionAccessMemberships.get(id)` | GET | `/api/2026-07-01/resources/trainings/session_access_memberships/{id}` | Reads a single Session access membership |
...
| `client.trainings.sessionAttendances.get(id)` | GET | `/api/2026-07-01/resources/trainings/session_attendances/{id}` | Reads a single Session attendance |
...
| `client.trainings.sessions.delete(id)` | DELETE | `/api/2026-07-01/resources/trainings/sessions/{id}` | Deletes a Session |
| `client.trainings.sessions.get(id)` | GET | `/api/2026-07-01/resources/trainings/sessions/{id}` | Reads a single Session |
| `client.trainings.sessions.update(id, body)` | PUT | `/api/2026-07-01/resources/trainings/sessions/{id}` | Update training session |
...
| `client.trainings.trainingClasses.delete(id)` | DELETE | `/api/2026-07-01/resources/trainings/training_classes/{id}` | Deletes a Training class |
| `client.trainings.trainingClasses.get(id)` | GET | `/api/2026-07-01/resources/trainings/training_classes/{id}` | Reads a single Training class |
| `client.trainings.trainingClasses.update(id, body)` | PUT | `/api/2026-07-01/resources/trainings/training_classes/{id}` | Updates a Training class |
...
| `client.trainings.trainingMemberships.get(id)` | GET | `/api/2026-07-01/resources/trainings/training_memberships/{id}` | Reads a single Training membership |
| `client.trainings.trainingMemberships.update(id, body)` | PUT | `/api/2026-07-01/resources/trainings/training_memberships/{id}` | Updates a Training membership |
...
| `client.trainings.trainings.delete(id)` | DELETE | `/api/2026-07-01/resources/trainings/trainings/{id}` | Deletes a Training |
| `client.trainings.trainings.get(id)` | GET | `/api/2026-07-01/resources/trainings/trainings/{id}` | Reads a single Training |
| `client.trainings.trainings.update(id, body)` | PUT | `/api/2026-07-01/resources/trainings/trainings/{id}` | Updates a Training |
...
| `client.workSchedule.dayConfigurations.get(id)` | GET | `/api/2026-07-01/resources/work_schedule/day_configurations/{id}` | Reads a single Day configuration |
...
| `client.workSchedule.overlapPeriods.delete(id)` | DELETE | `/api/2026-07-01/resources/work_schedule/overlap_periods/{id}` | Deletes an Overlap period |
| `client.workSchedule.overlapPeriods.get(id)` | GET | `/api/2026-07-01/resources/work_schedule/overlap_periods/{id}` | Reads a single Overlap period |
| `client.workSchedule.overlapPeriods.update(id, body)` | PUT | `/api/2026-07-01/resources/work_schedule/overlap_periods/{id}` | Updates an Overlap period |
...
| `client.workSchedule.schedules.get(id)` | GET | `/api/2026-07-01/resources/work_schedule/schedules/{id}` | Reads a single Schedule |
| `client.workSchedule.schedules.update(id, body)` | PUT | `/api/2026-07-01/resources/work_schedule/schedules/{id}` | Updates a Schedule |
